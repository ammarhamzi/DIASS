...
$can_delete = '<a href="/driver/delete/' . fixzy_encoder($r['driver_id']) . '" onclick="javasciprt:return confirm(\'' .$this->lang->line('delete_alert'). '\')"><button type="button" class="btn btn-danger"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></button></a>';
            ...
            array_push($data, [
                $i,
                '<a href="/driver/show/' . fixzy_encoder($r['driver_id']) . '">' . $r['driver_name'] . '</a>',
                /*$r['driver_dob'],*/
                $r['driver_ic'],
...
$r['driver_blacklistedremark'],*/
               /* $r['driver_drivertype'],*/
                ...
                '<a href="/driver/update/' . fixzy_encoder($r['driver_id']) . '"><button type="button" class="btn btn-default"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></button></a> '.$can_delete,
/*                $rud */
