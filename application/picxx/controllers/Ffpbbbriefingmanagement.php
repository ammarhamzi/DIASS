...
exit;*/
        ...
        $count_slottaken = $this->ffpbbbriefingmanagement_model->get_slottaken($value->ffpbb_briefingmanagement_date,$value->ffpbb_briefingmanagement_location,$value->ffpbb_briefingmanagement_category);
...
$title = $value->ffpbb_briefingmanagement_location.'-(' .$value->ffpbb_briefingmanagement_category. ')-'.$count_slottaken.'/'. $value->ffpbb_briefingmanagement_slot;
