...
$title = $value->tepinspectionmanagement_location.'-'.(!empty($value->tepinspectionmanagement_slottaken)?$value->tepinspectionmanagement_slottaken:'0').'/'. $value->tepinspectionmanagement_slot;
