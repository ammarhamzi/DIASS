...
?></div>
    <div class="col-md-3"><p>Briefing Date: <b><?php echo datelocal($gpupermit_course_date);?></b></p></div>
    <div class="col-md-3"><p>Location: <b><?php echo ($gpupermit_course_location?$gpupermit_course_location:"KLIA");?></b></p></div>
    <div class="col-md-3"><p>Session: <b><?php echo ($gpupermit_course_session?$gpupermit_course_session:"All Day");?></b></p></div>
</div>
                <!-- Nav tabs -->
...
<iframe frameBorder="0" width="100%" height="250px" src="/Uploadfilespermitid/gpu_requireddoc/<?php echo $driver_id;?>/<?php echo $raw_permit_id;?>"></iframe>
<?php
}else{
?>
                                <table class="table">
...
<!--                <br>
                <div class="panel panel-default">
                    <div class="panel-body">
                        <form autocomplete="off" id="submitform" name="submitform" action="/permitall/gpu_submit/" method="POST">
                            <div class="row">
                                <h3>Your Action</h3>
