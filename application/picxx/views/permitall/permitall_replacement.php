                        ...
                        <form autocomplete="off" id="submitform" name="submitform" action="/permitall/replacement_action/" method="POST">
                            <div class="row">
                                ...
                                <table class="table">
                                    ...
                                    <tr>
                                       <td>
                                        <h4>Upload suppported document(s)<sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('permit_replacement') ?></h4>
                                        <iframe frameBorder="0" width="100%" height="250px" src="/Uploadfiles/permit_replacement/<?php echo fixzy_decoder($permit_id); ?>"></iframe>
                                       </td>
                                    </tr>
...
<script>
    ...
    function getuploadfiles(processtype, data) {
        //alert(data);
        if (processtype == 'permit_replacement') {
            $("#permit_replacement").val(data);
        }
    }
</script>