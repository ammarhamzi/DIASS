...
?></div>
    <div class="col-md-3"><p>Briefing Date: <b><?php echo datelocal($wipbriefingpermit_course_date);?></b></p></div>
                            ...
                            <div class="col-md-4">
                                ...
                                <table class="table table-condensed table-responsive">
                                    <tr>
                                        ...
                                        <td class="col-md-6">
                                            <?php echo $wipbriefingpermit_policyno;?>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-md-6">
                                            <?php echo datelocal($wipbriefingpermit_policyexpirydate); ?>
                                        </td>
                                    </tr>
...
?>
                                ...
                                <table class="table table-condensed table-responsive">
                                    <tr>
                                        ...
                                        <td class="col-md-6">
                                            <?php echo $wipbriefingpermit_location; ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th class="col-md-6">
                                        ...
                                        <td class="col-md-6">
                                            <?php echo $wipbriefingpermit_entrypurpose; ?>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-md-6">
                                            <?php echo $wipbriefingpermit_entrypost; ?>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-md-6">
                                            <?php echo $wipbriefingpermit_exitpost; ?>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-md-6">
                                            <?php echo $wipbriefingpermit_steerman_name; ?>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-md-6">
                                            <?php echo $wipbriefingpermit_steerman_icno; ?>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-md-6">
                                            <?php echo datelocal($wipbriefingpermit_steerman_adpno);?>
                                        </td>
                                    </tr>
                                    <?php
                                    if($wipbriefingpermit_needescort == 'y'){
                                    ?>
                                    <tr>
                                        <th class="col-md-6">
                                            Escorter Name
                                        ...
                                        <td class="col-md-6">
                                            <?php echo $wipbriefingpermit_escortname; ?>
                                        </td>
                                    </tr>
                                    <?php
                                    }
...
<iframe frameBorder="0" width="100%" height="250px" src="/Uploadfilespermitid/wipbriefing_requireddoc/<?php echo $vehicle_id;?>/<?php echo $raw_permit_id;?>"></iframe>
<?php
}else{
?>
                                <table class="table">
...
<!--                <br>
                <div class="panel panel-default">
                    <div class="panel-body">
                        <form autocomplete="off" id="submitform" name="submitform" action="/permitall/sh_submit/" method="POST">
                            <div class="row">
                                <h3>Your Action</h3>
