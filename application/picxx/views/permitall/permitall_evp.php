...
?></div>
    <div class="col-md-3"><p>Date: <b><?php echo datelocal($evppermit_inspection_date);?></b></p></div>
                            ...
                            <div class="col-md-4">
                                ...
                                <table class="table table-condensed table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-md-6">
                                            <?php echo datelocal($evppermit_policyexpirydate); ?>
                                        </td>
                                    </tr>
...
<iframe frameBorder="0" width="100%" height="250px" src="/Uploadfilespermitid/evp_requireddoc/<?php echo $vehicle_id;?>/<?php echo $raw_permit_id;?>"></iframe>
<?php
}else{
?>
                                <table class="table">
