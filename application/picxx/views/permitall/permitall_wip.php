...
?></div>
    <div class="col-md-3"><p>Date: <b><?php echo datelocal($wippermit_inspection_date);?></b></p></div>
    <div class="col-md-3"><p>Location: <b><?php echo ($wippermit_inspection_location?$wippermit_inspection_location:"KLIA");?></b></p></div>
                            ...
                            <div class="col-md-4">
                                ...
                                <table class="table table-condensed table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-md-6">
                                            <?php echo datelocal($wippermit_policyexpirydate); ?>
                                        </td>
                                    </tr>
...
?>
                                ...
                                <table class="table table-condensed table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-md-6">
                                            <?php echo $wippermit_entrypurpose; ?>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-md-6">
                                            <?php echo $wippermit_steerman_name; ?>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-md-6">
                                            <?php echo $wippermit_steerman_icno; ?>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-md-6">
                                            <?php echo datelocal($wippermit_steerman_adpno);?>
                                        </td>
                                    </tr>
									<?php
...
<iframe frameBorder="0" width="100%" height="250px" src="/Uploadfilespermitid/wip_requireddoc/<?php echo $vehicle_id;?>/<?php echo $raw_permit_id;?>"></iframe>
<?php
}else{
?>
                                <table class="table">
                    ...
                    <div role="tabpanel" class="tab-pane" id="inspectionresult">
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <p>Date: <b><?php echo datelocal($wippermit_inspection_date); ?></b> </p>
                                    </div>
                                    <div class="col-md-12">
                                        <p>Inspector: <b><?php echo $wippermit_result_inspector_id; ?></b> </p>
                                    </div>
                                    <div class="col-md-12">
...
<h4>Mechanical Engineer :</h4>
                                <div class="row">
                                    <div class="col-md-12">
                                        <p>Date: <b><?php echo datelocal($wippermit_managerverified_date); ?></b> </p>
                                    </div>
                                    <div class="col-md-12">
                  ...
                  <tr>
                     ...
                     <td><?php echo $mtwchecklist->mtwchecklist_name ?></td>
                                ...
                                <td style="text-align:left; white-space: nowrap;">
                                    ...
                                    <?php
                                        //echo '<input type="checkbox" value="' .$mtwchecklist->mtwchecklist_id. '" ' .(in_array($mtwchecklist->mtwchecklist_id, $wip_mtwchecked_selected)?"checked":""). ' disabled>';
                                    ?>
                                            <input type="radio" name="mtwinspect_<?php echo $mtwchecklist->mtwchecklist_id;?>"  value="y" <?php echo (in_array($mtwchecklist->mtwchecklist_id, $wip_mtwchecked_y_selected)?"checked":"");?> disabled
                                            /> <span style="color: #00CC00">PASS</span>
                                            <br>
                                            <input type="radio" name="mtwinspect_<?php echo $mtwchecklist->mtwchecklist_id;?>" value="n" <?php echo (in_array($mtwchecklist->mtwchecklist_id, $wip_mtwchecked_n_selected)?"checked":"");?> disabled
                                            /> <span style="color: #CC0000">FAIL</span>
                                            <br>
                                            <input type="radio" name="mtwinspect_<?php echo $mtwchecklist->mtwchecklist_id;?>" value="n/a" <?php echo (in_array($mtwchecklist->mtwchecklist_id, $wip_mtwchecked_na_selected)?"checked":"");?> disabled
  ...
  <div class="col-md-12">
                                <table class="table table-bordered" style="width: 100% !important">
                                   ...
                                   <?php echo $wippermit_smokecondition;?>
                                    ...
                                    <td><input type="checkbox" name="smokecondition_checked" value="y" <?php echo ($wippermit_smokecondition_checked=='y'?'checked':'');?> disabled></td>
                                    </tr>
                                    <tr>
                                   ...
                                   <td><input type="checkbox" name="fireext_serialno_checked" value="y" <?php echo ($wippermit_fireext_serialno_checked=='y'?'checked':'');?> disabled></td>
                                    </tr>
                                    <tr>
                                   <td>Expiry Date: </td>
                                   <td><?php echo datelocal($wippermit_fireext_expirydate);?> </td>
                                   <td><input type="checkbox" name="fireext_expirydate_checked" value="y" <?php echo ($wippermit_fireext_expirydate_checked=='y'?'checked':'');?> disabled></td>
                                    </tr>
                                   ...
                                   <td><input type="checkbox" name="tyre_manufacturingdate_checked" value="y" <?php echo ($wippermit_tyre_manufacturingdate_checked=='y'?'checked':'');?> disabled></td>
                                    </tr>
                                </table>
  </div>
</div>
