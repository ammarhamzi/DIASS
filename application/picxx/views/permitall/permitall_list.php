            ...
            <table id="mytable" class="table table-bordered table-hover" style="width: 100% !important">
                ...
                <thead>
                    <tr>
                        ...
                        <th>
                            Exam / Briefing / Assessment / Inspection Date
                        </th>
                        <th>
                            Expiry Date
                        </th>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        "lengthMenu": [ [10, 25, 50, 100, -1], [10, 25, 50, 100, "All"] ],
            "processing": true,
            "serverSide": true,
            "ajax": "<?php echo site_url() ?>/Permitall/get_json/<?php echo $controller;?>",
            responsive: true,
            dom: 'lrBtip',
...
select.append('<option value="Stakeholder (Inspection required)">Stakeholder (Inspection required)</option>');*/
                                        ...
                                        if (i == 9) {
                                            select.append('<option value="">All</option>');
                                            select.append('<option value="KLIA">KLIA</option>');
                                            select.append('<option value="KLIA2">KLIA2</option>');
                                            select.append('<option value="MTW">MTW</option>');
                                        }
                                    }
                                });
                            },
