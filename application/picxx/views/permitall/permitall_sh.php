...
?></div>
    <div class="col-md-3"><p>Briefing Date: <b><?php echo datelocal($shpermit_course_date);?></b></p></div>
...
?>
    ...
    <div class="col-md-6"><p>TEP date range: <b><?php echo datelocal(datelocal($permit_issuance_startdate));?></b> to <b><?php echo datelocal(datelocal($permit_issuance_expirydate));?></b> (<?php echo $days+1;?> days)</p></div>
</div>
<br>
                <!-- Nav tabs -->
                            ...
                            <div class="col-md-4">
                                ...
                                <table class="table table-condensed table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-md-6">
                                            <?php echo datelocal($shpermit_policyexpirydate); ?>
                                        </td>
                                    </tr>
...
<!--                                    <tr>
                                        ...
                                        <td class="col-md-6">
                                            <?php echo $shpermit_entrypurpose; ?>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-md-6">
                                            <?php echo $shpermit_steerman_name; ?>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-md-6">
                                            <?php echo $shpermit_steerman_icno; ?>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-md-6">
                                            <?php echo datelocal($shpermit_steerman_adpno);?>
                                        </td>
                                    </tr>
                                    <?php
...
<iframe frameBorder="0" width="100%" height="250px" src="/Uploadfilespermitid/sh_requireddoc/<?php echo $vehicle_id;?>/<?php echo $raw_permit_id;?>"></iframe>
<?php
}else{
?>
                                <table class="table">
