...
<div class="container-fluid">
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo site_url('permitrenew'); ?>"><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span> <?php echo $this->lang->line('permitrenew'); ?> <?php echo $this->lang->line('list'); ?></a></li>
        <li class="active"><span class="glyphicon glyphicon-file" aria-hidden="true"></span>
            <?php echo $this->lang->line('permitrenew'); ?>
...
?>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <form autocomplete="off" id="submitform" name="submitform" action="/permitrenew/adp_submit/" method="POST">
                            <div class="row">
                                <h3>Your Action</h3>
