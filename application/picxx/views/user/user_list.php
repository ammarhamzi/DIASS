...
<div class="container-fluid">
    <ol class="breadcrumb">
        ...
        <li class="active"><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span> <?php echo $this->lang->line('user'); ?> <?php echo $this->lang->line('list'); ?></li>
    </ol>
    <div class="row">
...
?>
    ...
    <div class="panel panel-info">
        <div class="panel-heading">
            <h4><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span> <?php echo $this->lang->line('user'); ?> <?php echo $this->lang->line('list'); ?></h4>
        </div>
    ...
    foreach ($user_data as $user) {
        ?>
                            <tr>
                                ...
                                <td><?php echo $user->usergroup_name_user_groupid; ?></td>
...
$id = fixzy_encoder($user->user_id);
        ...
        if ($permission->cp_delete == true) {
            ...
            echo anchor(site_url('user/delete/' . $id),
