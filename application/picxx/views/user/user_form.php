...
<div class="container-fluid">
    ...
    <div class="panel panel-info">
        <div class="panel-heading">
            <h4><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> <?php echo $this->lang->line('user'); ?> <?php echo $button; ?></h4>
        </div>
                    ...
                    <form autocomplete="off" action="<?php echo $action; ?>" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9"><input type="text" class="form-control" name="user_password" id="user_password" placeholder="<?php echo $this->lang->line('user_password'); ?>"value="" maxlength="250" />
                                <p class="bg-info">Left empty if you dont want to change password.</p>
                                         </div></div>
...
; ?>" readonly>
                        ...
                        <div class="row">
                            <label class="col-md-3 text-right">
<?php echo $this->lang->line('user_groupid'); ?> <sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('user_groupid'); ?>
                            </label>

                            <div class="col-md-9"><select class="form-control select2" name="user_groupid" id="user_groupid">
                                    <option value="">-SELECT-</option>
                                            <?php
foreach ($usergroup as $value) {
    ?>
                                        <option value="<?php echo $value->usergroup_id; ?>" <?php echo ($value->usergroup_id
        === $user_groupid ? 'selected="selected"'
        : "");
