<div class="container-fluid">
    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            ...
            <?php echo $this->lang->line('company_name');?> <sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('company_name') ?>
          </label>
                            <div class="col-md-9"><input type="text" class="form-control" name="company_name" id="company_name" placeholder="<?php echo $this->lang->line('company_name');?>" value="<?php echo $company_name; ?>" maxlength="255" />
                            </div>
                        </div>

                        <div class="row">
                            <label class="col-md-3 text-right">
            <?php echo $this->lang->line('company_address');?> <?php echo form_error('company_address') ?>
          </label>
                            <div class="col-md-9"><textarea class="form-control" name="company_address" id="company_address" placeholder="<?php echo $this->lang->line('company_address');?>" rows="5" cols="50"><?php echo $company_address; ?></textarea>
                            </div>
                        </div>

                        <div class="row">
                            <label class="col-md-3 text-right">
            <?php echo $this->lang->line('company_userdepartment');?> <?php echo form_error('company_userdepartment') ?>
          </label>
                            <div class="col-md-9"><input type="text" class="form-control" name="company_userdepartment" id="company_userdepartment" placeholder="<?php echo $this->lang->line('company_userdepartment');?>" value="<?php echo $company_userdepartment; ?>" maxlength="255"
                                />
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <label class="col-md-3 text-right">
            <?php echo $this->lang->line('company_registerednumber');?> <?php echo form_error('company_registerednumber') ?>
          </label>
                            <div class="col-md-9"><input type="text" class="form-control" name="company_registerednumber" id="company_registerednumber" placeholder="<?php echo $this->lang->line('company_registerednumber');?>" value="<?php echo $company_registerednumber; ?>"
                                    maxlength="50" />
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <label class="col-md-3 text-right">
            <?php echo $this->lang->line('company_contact_person');?> <?php echo form_error('company_contact_person') ?>
          </label>
                            <div class="col-md-9"><input type="text" class="form-control" name="company_contact_person" id="company_contact_person" placeholder="<?php echo $this->lang->line('company_contact_person');?>" value="<?php echo $company_contact_person; ?>" maxlength="255"
                                />
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <label class="col-md-3 text-right">
            <?php echo $this->lang->line('company_contact_email');?> <?php echo form_error('company_contact_email') ?>
          </label>
                            <div class="col-md-9"><input type="text" class="form-control" name="company_contact_email" id="company_contact_email" placeholder="<?php echo $this->lang->line('company_contact_email');?>" value="<?php echo $company_contact_email; ?>" maxlength="150"
                                />
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <label class="col-md-3 text-right">
            <?php echo $this->lang->line('company_contact_phone');?> <?php echo form_error('company_contact_phone') ?>
          </label>
                            <div class="col-md-9"><input type="text" class="form-control" name="company_contact_phone" id="company_contact_phone" placeholder="<?php echo $this->lang->line('company_contact_phone');?>" value="<?php echo $company_contact_phone; ?>" maxlength="50"
                                />
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <label class="col-md-3 text-right">
            <?php echo $this->lang->line('company_contact_fax');?> <?php echo form_error('company_contact_fax') ?>
          </label>
                            <div class="col-md-9"><input type="text" class="form-control" name="company_contact_fax" id="company_contact_fax" placeholder="<?php echo $this->lang->line('company_contact_fax');?>" value="<?php echo $company_contact_fax; ?>" maxlength="50" />
                            </div>
                        </div>
