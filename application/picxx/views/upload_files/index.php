...
<form autocomplete="off" method="post" action="" enctype="multipart/form-data">
    ...
    <div class="form-group">
        <label>Airside work permit * </label>
        <input class="form-control input-sm" type="file" name="files[]" accept="<?=_ACCEPT_FILE_TYPE?>"/>
        <input type="hidden" name="files_name[]" value="Airside work permit" />
    </div>
    <div class="form-group">
        <label>Airside safety briefing attendance * </label>
        <input class="form-control input-sm" type="file" name="files[]" accept="<?=_ACCEPT_FILE_TYPE?>"/>
        <input type="hidden" name="files_name[]" value="Airside safety briefing attendance" />
    </div>
    <div class="form-group">
        <label>Previous Vehicle Service Sheet or PUSPAKOM Cert *</label>
        <input class="form-control input-sm" type="file" name="files[]" accept="<?=_ACCEPT_FILE_TYPE?>"/>
...
<!--    <div class="form-group">
    ...
    <div class="form-group">
        <label>Offer letter (Proof of having job at KLIA/KLIA2) *</label>
        <input class="form-control input-sm" type="file" name="files[]" accept="<?=_ACCEPT_FILE_TYPE?>"/>
        <input type="hidden" name="files_name[]" value="Offer letter (Proof of having job at KLIA/KLIA2)" />
    </div>
<!--    <div class="form-group">
        <label>Previous Vehicle Service Sheet or PUSPAKOM Cert *</label>
        <input class="form-control input-sm" type="file" name="files[]" accept="<?=_ACCEPT_FILE_TYPE?>"/>
    ...
    else if($processtype == 'pbb_requireddoc')
    {
    ?>
    <div class="form-group">
        <label>Copy of MA Sepang Permanent Pass * </label>
        <input class="form-control input-sm" type="file" name="files[]" accept="<?=_ACCEPT_FILE_TYPE?>"/>
        <input type="hidden" name="files_name[]" value="Copy of MA Sepang Permanent Pass" />
    </div>
    <div class="form-group">
        <label>On Job Training (OJT) Sheet *</label>
        <input class="form-control input-sm" type="file" name="files[]" accept="<?=_ACCEPT_FILE_TYPE?>"/>
        <input type="hidden" name="files_name[]" value="On Job Training (OJT) Sheet" />
    </div>
    <?php
    }
    else if($processtype == 'vdgs_requireddoc')
    {
    ?>
    <div class="form-group">
        <label>IC/Passport/Working Permit/Employment Pass *</label>
        <input class="form-control input-sm" type="file" name="files[]" accept="<?=_ACCEPT_FILE_TYPE?>"/>
        <input type="hidden" name="files_name[]" value="Copy of IC/Passport" />
    </div>
    <div class="form-group">
        <label>KLIA/KLIA2 Airport Pass *</label>
        <input class="form-control input-sm" type="file" name="files[]" accept="<?=_ACCEPT_FILE_TYPE?>"/>
        <input type="hidden" name="files_name[]" value="KLIA/KLIA2 Airport Pass" />
    </div>
    <div class="form-group">
    ...
    <?php
    }else if($processtype == 'sh_requireddoc')
    {
    ?>
    <div class="form-group">
        <label>Letter of employer/owner * </label>
    ...
    <div class="form-group">
        <label>Supporting letter from company (stated reason for TEP application) *</label>
        <input class="form-control input-sm" type="file" name="files[]" accept="<?=_ACCEPT_FILE_TYPE?>"/>
        <input type="hidden" name="files_name[]" value="Supporting letter from company (stated reason for TEP application)" />
    </div>
    <?php
    }else if($processtype == 'pca_requireddoc'){
?>
    <div class="form-group">
        <label>IC/Passport/Working Permit/Employment Pass *</label>
        <input class="form-control input-sm" type="file" name="files[]" accept="<?=_ACCEPT_FILE_TYPE?>"/>
...
<?php
    }else if($processtype == 'gpu_requireddoc'){
?>
    <div class="form-group">
        <label>IC/Passport/Working Permit/Employment Pass *</label>
        <input class="form-control input-sm" type="file" name="files[]" accept="<?=_ACCEPT_FILE_TYPE?>"/>
...
<?php
    ...
    <div class="form-group">
        ...
        <input class="form-control" type="file" name="files[]" accept="<?=_ACCEPT_FILE_TYPE?>" multiple/>
    </div>
    <?php 
    }
    ?>
    <div class="form-group">
        <p class="help-block alert alert-warning">
            ...
            &nbsp;- Document files (.pdf, *.ppt, *.pptx, *.doc, & *.docx)<br />
        </p>
        
        <!-- <ol>
            <li><span style="font-size: small">Maximum file size is 3Mb</span></li>
            <li><span style="font-size: small">Supported file format: .pdf, .doc, .docx, .ppt, .pptx, .jpg, .jpeg, .png,</span></li>
        </ol> -->
         ...
         ?>
                    <tr>
                        ...
                        <td>
                            ...
                            ?>
                              <?php echo $file['uploadfiles_docname']; ?>
                            <?php echo $file['uploadfiles_filesize']; ?>
                            <?php 
                            }
                            else if($processtype == 'evp_requireddoc')
                            {
                            ...
                            else if($processtype == 'wip_requireddoc' || $processtype == 'wipbriefing_requireddoc' || $processtype == 'cs_requireddoc' || $processtype == 'pbb_requireddoc' || $processtype == 'vdgs_requireddoc' || $processtype == 'sh_requireddoc' || $processtype == 'gpu_requireddoc' || $processtype == 'pca_requireddoc')
                            {
                            ?>
                              <?php echo $file['uploadfiles_docname']; ?>
                            <?php 
