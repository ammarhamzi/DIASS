...
<div class="container-fluid">
    <ol class="breadcrumb">
        ...
        <li class="active"><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span> <?php echo $this->lang->line('usergroup'); ?> <?php echo $this->lang->line('list'); ?></li>
    </ol>
    <div class="row">
    ...
    ?>
        <div class="panel panel-info">
            <div class="panel-heading">
                <h4><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> <?php echo $this->lang->line('usergroup'); ?> <?php echo $button; ?></h4>
            </div>
...
?>
    ...
    <div class="panel panel-info">
        <div class="panel-heading">
            <h4><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span> <?php echo $this->lang->line('usergroup'); ?> <?php echo $this->lang->line('list'); ?></h4>
        </div>
        <div class="panel-body">
