            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="tab_3">
                        <div class="row">
                            <div class="col-md-12">
                                <h3>Application : Airside Driving Permit (ADP) <!--WITH BRIEFING--></h3>
...
<!--                            <div class="col-md-12">
                                ...
                                <p>Condition :
                                    <?php echo ($condition=='renew'?'Renewal':'New');?>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <p><b>ADP Briefing Date :<sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('examtaker_date') ?><span class="text-danger" id="examtaker_date_error"></span></b></p>
<p><span style="font-size: 10pt"><i>Schedule based on your permit request:</i></span><br>
<p>Permit Condition: <?php echo ($condition=='renew'?'Renewal':'New');?></p>
<p>ADP Category: <?php echo $driverclass;?></p>
</p>
                                                    <p>Please choose any available date for ADP Briefing. </p>

                                                    <div id="calendar"></div>
                                                    <p>
<h3>Selected Date/Location: <span class="label label-warning" id="examtaker_date_display"></span></h3>
                                                    </p>
                                                </div>
                                            </div>
...
<ul>
    ...
    <li>Working Permit (Foreigner)</li>
                                                    ...
                                                    <iframe frameBorder="0" width="100%" height="250px" src="/Uploadfiles/adp_requireddoc/<?php echo $driver_id; ?>"></iframe>
                                                </div>
                                                <!--         <div class="col-md-12">
    ...
    $(document).ready(function() {
        $(function() {
            ...
            $('#calendar').fullCalendar({
                ...
                defaultView: 'month',
                events: {
                    url: '/Adpbriefingmanagement/get_availableslot/<?php echo $condition;?>/<?php echo $driverclass;?>',
                    type: 'POST',
                    data: {},
                    error: function() {
                ...
                eventClick: function(calEvent, jsEvent, view) {
                    ...
                    var location = exam_title[0];
                        ...
                        $("#examtaker_date_display").html(moment(calEvent.start).format('DD-MM-YYYY')+"/"+location);
