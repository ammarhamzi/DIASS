            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="tab_3">
                        <div class="row">
                            <div class="col-md-12">
                                <h3>Application : Passenger Boarding Bridge Driving Permit (PBB)</h3>
                            </div>
                        </div>
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-6 form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <p><b>Pbb assessment Date:<sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('pbbbriefing_date') ?><span class="text-danger" id="pbbbriefing_date_error"></span></b></p>
                                                    <p>Please choose any available date to book for PBB assessment. Permit application can only proceed after driver has attend the assessment.</p>

                                                    <div id="calendar"></div>
                                                    <p>
<h3>Selected assessment Date/Location/Session: <span class="label label-warning" id="pbbbriefing_date_display"></span></h3>
                                                    </p>
                                                </div>
                                            </div>
     ...
     <div class="row">
      ...
      <div class="row">
         ...
         <div class="col-md-8"><input type="text" id="expirydate" name="expirydate" class="datepicker"></div>
                                            ...
                                            <h4>Other Documents <sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('pbb_requireddoc') ?><span class="text-danger" id="pbb_requireddoc_error"></span></h4>
                                            <div class="row">
                                                <div class="col-md-12">
...
<ul>
    ...
    <li>Copy of MA Sepang Permanent Pass</li>
    <li>On Job Training (OJT) Sheet</li>
</ul>
                                                    <iframe frameBorder="0" width="100%" height="250px" src="/Uploadfiles/pbb_requireddoc/<?php echo $driver_id;?>"></iframe>
                                                </div>
                                                <!--         <div class="col-md-12">
...
<!--                                            <?php
                    if($condition=='renew'){   ?>
                                                ...
                                                <h3>Detail of Recent PBB Permit</h3>
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <p>Permit Serial No :
                                                            <?php echo $serialno; ?>
     ...
     <div class="row">
      ...
      <iframe frameBorder="0" src="/Uploadfiles/adp_trainercert/<?php echo $driver_id;?>"></iframe>
                                    ...
                                    <input id="permittype" type="hidden" name="permittype" value="pbb">
                                    ...
                                    <input id="pbbbriefing_date" type="hidden" name="pbbbriefing_date" value="">
<input id="pbbbriefing_session" type="hidden" name="pbbbriefing_session" value="">
<input id="pbbbriefing_title" type="hidden" name="pbbbriefing_title" value="">
                                    <input id="pbb_requireddoc" type="hidden" name="pbb_requireddoc" value="">
...
<script>
    ...
    function getuploadfiles(processtype, data) {
        //alert(data);
        if (processtype == 'pbb_requireddoc') {
            $("#pbb_requireddoc").val(data);
        }
    ...
    $(document).ready(function() {
        $(function() {
            ...
            $('#calendar').fullCalendar({
                ...
                defaultView: 'month',
                events: {
                    url: '/Ffpbbbriefingmanagement/get_availableslot',
                    type: 'POST',
                    data: {},
                    error: function() {
                ...
                eventClick: function(calEvent, jsEvent, view) {
                    ...
                    var location = exam_title[0];
                        $("#pbbbriefing_date").val(moment(calEvent.start).format('YYYY-MM-DD'));
                        $("#pbbbriefing_date_display").html(moment(calEvent.start).format('DD-MM-YYYY')+"/"+location+"/"+calEvent.className);
                        $("#pbbbriefing_session").val(calEvent.className);
                        $("#pbbbriefing_title").val(calEvent.title);
...
var status = 0;
if($("#pbbbriefing_date").val() == "") {
   $("#pbbbriefing_date_error").html('<span class="alert_custom">Required</span>') ;
   status = 1;
}else{
$("#pbbbriefing_date_error").html('') ;
}
if($("#driver_photo").val() == "") {
...
if($("#pbb_requireddoc").val() == "") {
   $("#pbb_requireddoc_error").html('<span class="alert_custom">Required</span>') ;
   status = 1;
}else{
    var words = $('#pbb_requireddoc').val().split(',');
    //alert(words.length);
    if(words.length < 2){
     $("#pbb_requireddoc_error").html('<span class="alert_custom">Some required file(s) missing</span>') ;
     status = 1;
    }else{
$("#pbb_requireddoc_error").html('') ;
}
}
