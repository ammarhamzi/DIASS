            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="nav-tabs-custom">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <p><b>Application :</b> Visual Docking Guidance System Driving Permit (VDGS)</p>
                            </div>
                        </div>
            <form autocomplete="off" id="step_submit" name="step_submit" action="/Permit/submit" method="POST"  onsubmit="return validateForm()">
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <p><b>Vdgs Briefing Date:</b></p>
                                <p>
                                    <span class="label label-warning"><?php echo datelocal($vdgsbriefing_date);?> </span>
                                </p>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <p><b>Session:</b></p>
                                <p>
                                    <span class="label label-warning"><?php echo $vdgsbriefing_session;?> </span>
                                </p>
                            </div>
                        </div>
                    </div>
...
<p><?php echo $countryname;?></p>
     ...
     <div class="row">
      ...
      <div class="row">
        ...
        if(!empty($vdgs_requireddoc_filename)){ foreach($vdgs_requireddoc_filename as $file){
    ...
    <table class="table">
        ...
        <?php }
         ...
         ?>
                ...
                <input id="vdgsbriefing_date" type="hidden" name="vdgsbriefing_date" value="<?php echo $vdgsbriefing_date;?>">
<input id="vdgsbriefing_session" type="hidden" name="vdgsbriefing_session" value="<?php echo $vdgsbriefing_session;?>">
    <input id="location" type="hidden" name="location" value="<?php echo $location;?>">
                <input id="vdgs_requireddoc" type="hidden" name="vdgs_requireddoc" value="<?php echo $vdgs_requireddoc;?>">
