...
<div class="container-fluid">
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo site_url('permit');?>"><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span> <?php echo $this->lang->line('permit');?> <?php echo $this->lang->line('list');?></a></li>
    ...
    <div class="panel panel-info">
        <div class="panel-heading">
            <h4><span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
                <?php echo $this->lang->line('permit');?>
                <?php echo $button ?>
            </h4>
        </div>
...
?>
<option value="<?php echo $value->permit_condition_id;?>" <?php echo ($value->permit_condition_id===$permit_conditionid?'selected="selected"':"");?>><?php echo $value->permit_condition_name;?></option>
<?php
}
?>
</select>
                        ...
                        <div class="row">
                            <label class="col-md-3 text-right">
            <?php echo $this->lang->line('permit_bookingid');?> <sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('permit_bookingid') ?>
          </label>
...
?>
            ...
            <?php echo $this->lang->line('permit_payment_total');?> <?php echo form_error('permit_payment_total') ?>
                            ...
                            <div class="col-md-9"><input type="text" class="form-control isCurrency" name="permit_payment_total" id="permit_payment_total" placeholder="<?php echo $this->lang->line('permit_payment_total');?>" value="<?php echo 'RM '.$permit_payment_total; ?>" />
                            </div>
                        </div>
...
?>
                        ...
                        <div class="row">
                            <label class="col-md-3 text-right">
            <?php echo $this->lang->line('permit_status');?> <sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('permit_status') ?>
          </label>
...
?>
<option value="<?php echo $value->permit_status_name;?>" <?php echo ($value->permit_status_name===$permit_status?'selected="selected"':"");?>><?php echo $value->permit_status_desc;?></option>
<?php
}
?>
</select>
            ...
            <?php echo $this->lang->line('permit_remark');?> <?php echo form_error('permit_remark') ?>
                        ...
                        <div class="row">
                            <div class="col-md-offset-3 col-md-9">
                                ...
                                <a href="<?php echo site_url('permit') ?>" class="btn btn-default"><span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span> <?php echo $this->lang->line('back');?></a>
                            </div>
                        </div>
                    </form>
                </div>
...
?>
    <script>
        $(document).ready(function() {
            var arr = ['permit_groupid', 'permit_typeid', 'permit_condition'];
