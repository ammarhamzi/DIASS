...
?>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <p><b>Stokeholder Briefing Date:</b></p>
                                <p>
                                    <span class="label label-warning"><?php echo datelocal($shbriefing_date);?> </span>
                                </p>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <p>
                                   <span class="label label-warning"> <?php echo $shbriefing_location;?> </span>
                                </p>
                            </div>
                        </div>
...
<!--                                        <td>Size</td>
        ...
        if(!empty($sh_insurancedoc_filename)){ foreach($sh_insurancedoc_filename as $file){
...
<!--                                        <td>Type</td> -->
        ...
        if(!empty($sh_requireddoc_filename)){ foreach($sh_requireddoc_filename as $file){
          $filename = explode("--", $file['uploadfiles_filename']);
         ?>
                                        <tr>
                                            <td>
...
<!--                        <?php
                    if($condition=='renew'){   ?>
                            ...
                            <h3>Detail of Recent SH Permit</h3>
                            <div class="row">
                                <div class="col-md-12">
                                    <p>Permit Serial No :
                                        <?php echo $serialno; ?>
    ...
    <table class="table">
        ...
        <?php }
         ...
         ?>
                ...
                <input id="shbriefing_date" type="hidden" name="shbriefing_date" value="<?php echo $shbriefing_date;?>">
                <input id="sh_requireddoc" type="hidden" name="sh_requireddoc" value="<?php echo $sh_requireddoc;?>">

                <input id="sh_insurancedoc" type="hidden" name="sh_insurancedoc" value="<?php echo $sh_insurancedoc;?>">
