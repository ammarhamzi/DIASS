...
<p><input type="radio" name="courseinformation_notexist" value="y"> <span style="color: #CC0000">The driver Have not yet attend any course/briefing for this application</span> </p>
<p><input type="radio" name="courseinformation_notexist" value="n"> <span style="color: #009900">The driver has attend course/briefing for this application (detail as below)</span></p>
</div>
</div>
...
<!--                                    <?php
                    if($condition=='renew'){   ?>
                            ...
                            <input id="verify_status" type="text" name="verify_status" value="">
