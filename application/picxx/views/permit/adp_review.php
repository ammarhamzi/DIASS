            ...
            <div class="row">
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <?php
                        if(empty($adp_trainercert_filename)){
?>
                        <div class="row">
                            <div class="col-md-12">
                                <p><b>Briefing Date:</b></p>
                                <p>
                                    <span class="label label-warning"><?php echo datelocal($examtaker_date);?></span>
                                </p>
                            </div>
                        </div>
<?php
...
?>
                        <div class="row">
                            <div class="col-md-12">
                                <p><b>Session:</b></p>
                                <p>
                                    <span class="label label-warning"><?php echo $exam_session;?> </span>
                                </p>
                            </div>
                        </div>
<?php
         ...
         <div class="col-md-12">
                    ...
                    ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <p>
                                    <?php echo (!empty($trainingdate)?datelocal($trainingdate):"");?>
                                </p>
                            </div>
                        </div>
                        <div class="row">
...
<input id="recent_permitid" type="hidden" name="recent_permitid" value="<?php echo $recent_permitid;?>">
                ...
                <input id="exam_session" type="hidden" name="exam_session" value="<?php echo $exam_session;?>">
