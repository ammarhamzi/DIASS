...
<!--                                        <td>Size</td>
        ...
        if(!empty($shins_insurancedoc_filename)){ foreach($shins_insurancedoc_filename as $file){
...
<!--                                        <td>Type</td> -->
        ...
        if(!empty($shins_requireddoc_filename)){ foreach($shins_requireddoc_filename as $file){
          $filename = explode("--", $file['uploadfiles_filename']);
         ?>
                                        <tr>
                                            <td>
                  ...
                  <tr>
                     ...
                     <td><?php echo $mtwchecklist->mtwchecklist_name ?></td>
                                ...
                                <td style="text-align:center; white-space: nowrap;">
                                    ...
                                    <?php
                                        echo '<input id="mtwchecklist_selected" name="mtwchecklist_selected[]" type="checkbox" value="' .$mtwchecklist->mtwchecklist_id. '" ' .(in_array($mtwchecklist->mtwchecklist_id, $shins_mtwchecked_selected)?"checked":""). ' disabled>';
                                    ?>
                                    </div>
                                </td>
                  </tr>
...
<th>Declared</th>
                  ...
                  <?php
                     ...
                     ?>
                                ...
                                <table class="table">
                                   ...
                                   <td>Serial No: </td>
                                   <td>
                                   <?php echo $shinspermit_fireext_serialno;?>
                                   ...
                                   <td>Expiry Date: </td>
                                   <td>
                                   <?php echo datelocal($shinspermit_fireext_expirydate);?>
                                   ...
                                   <td>
                                   <?php echo nl2br($shinspermit_tyre_manufacturingdate);?>
 ...
 <p><b>Note For admin:</b> </p><textarea id="apply_remark" name="apply_remark" class="form-control"></textarea>
                ...
                <input id="shins_requireddoc" type="hidden" name="shins_requireddoc" value="<?php echo $shins_requireddoc;?>">

                <input id="shins_insurancedoc" type="hidden" name="shins_insurancedoc" value="<?php echo $shins_insurancedoc;?>">
               ...
               <input type="hidden" id="smokecondition" name="smokecondition" value="<?php echo $shinspermit_smokecondition;?>">
               <input type="hidden" id="fireext_serialno" name="fireext_serialno" value="<?php echo $shinspermit_fireext_serialno;?>">
               <input type="hidden" id="fireext_expirydate" name="fireext_expirydate" value="<?php echo $shinspermit_fireext_expirydate;?>">
               <input type="hidden" id="tyre_manufacturingdate" name="tyre_manufacturingdate" value="<?php echo nl2br($shinspermit_tyre_manufacturingdate);?>">
...
<?php
foreach($shins_mtwchecked_selected as $value)
{
?>
                <input id="shins_mtwchecked_selected" type="hidden" name="shins_mtwchecked_selected[]" value="<?php echo $value;?>">
<?php
}
?>
