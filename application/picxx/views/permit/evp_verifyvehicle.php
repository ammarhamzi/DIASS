            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="nav-tabs-custom">
                       ...
                       <div class="row">
                    <div class="col-md-12">
                        <h3>Application : Electrical Vehicle Permit (EVP)</h3>
                    </div>
                </div>
...
<script>
    $('body').on('click', '#verify', function() {
        ...
        $.ajax({
            type: "POST",
            data: {},
            url: "<?php echo base_url() ?>Permit/verify/vehicle/3/" + $("#vehicle_id").val(),
...
<script>
    $(document).ready(function() {
        $.ajax({
            type: "POST",
            data: {},
            url: "<?php echo base_url() ?>Vehicle/companyvehicle/ev",
            success: function(data) {
