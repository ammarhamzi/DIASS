...
?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8"><input type="text" class="form-control datepicker_local" name="task_date" id="task_date" placeholder="<?php echo $this->lang->line('task_date'); ?>" value="<?php echo $task_date; ?>" <?php echo ($button
    == "Update" ? 'readonly="readonly"' : '');
?>/>
                                 </div></div>
