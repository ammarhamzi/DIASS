...
<div class="row">
    <div class="col-md-6">
        <p>Course Date: <b><?php echo $adppermit_course_date;?></b> </p>
        <p>Result: <b>38/40</b></p>
    </div>
    <div class="col-md-6">
        <p>Competency Test Date:<b><?php echo $adppermit_competencytest_date;?></b> </p>
    </div>
</div>
                            </div>
                            <div class="col-md-6">
                     ...
                     if($i==1){
                        ...
                        if($value->examresult_result == $value->examresult_answer){
                        echo 'Question '.$i.':<img src="'.base_url().'/resources/shared_img/correct.png" width="18" height="18" alt=""><br>';
                        }else{
                        echo 'Question '.$i.':<img src="'.base_url().'/resources/shared_img/wrong.png" width="18" height="18" alt=""><br>';
                        }
                     }elseif($i==20){
                        if($value->examresult_result == $value->examresult_answer){
                        echo 'Question '.$i.':<img src="'.base_url().'/resources/shared_img/correct.png" width="18" height="18" alt=""><br>';
