...
// get all
    public function get_all()
    {
        ...
        $this->db->order_by('wipbriefingmanagement_id', 'DESC');
...
// get data by id
    ...
    {
        $this->db->select('wipbriefingmanagement_id, wipbriefingmanagement_slottaken');
        $this->db->where('wipbriefingmanagement.wipbriefingmanagement_date', $date);
