...
class Charges_types_model extends CI_Model
{
    ...
    function charge_type_all($category = '')
    {
        $this->db->select('*');
        $this->db->where('isactive', '1');
...
// get data by id
    ...
    public function get_charges_types_ffop()
    {
        $this->db->select('*');
        $this->db->where('ct_id', 18);
        $this->db->where('isactive', '1');
        $this->db->from('charges_types');
        $query = $this->db->get();
    ...
    public function get_charges_types_tep()
    {
        $this->db->select('*');
        $this->db->where('ct_id', 14);
        $this->db->where('isactive', '1');
        $this->db->from('charges_types');
        $query = $this->db->get();
    ...
    public function get_charges_types_escort()
    {
        $this->db->select('*');
        $this->db->where('ct_id', 17);
        $this->db->where('isactive', '1');
        $this->db->from('charges_types');
        $query = $this->db->get();
    ...
    public function get_charges_types_replacement()
    {
        $this->db->select('*');
        $this->db->where('ct_id', 21);
        $this->db->where('isactive', '1');
        $this->db->from('charges_types');
        $query = $this->db->get();
...
// update data
    ...
    function total_avp_price_per_date($date,$kod = '',$paymentMethod = 1,$shift = 4)
    {
    ...
    function total_payment_by_type_per_date($date,$permit_type_array,$paymentMethod = 1,$shift = 4)
    {
        if(empty($date) || $date == '1970-01-01' || $date == '1900-01-01' || $date == '0000-00-00')
        {
            return 0;
    ...
    function total_payment_by_type1_per_date($date,$permit_type_id,$paymentMethod = 1,$shift = 4,$pro_rated = 0)
    {
        if(empty($date) || $date == '1970-01-01' || $date == '1900-01-01' || $date == '0000-00-00')
        {
            return 0;
