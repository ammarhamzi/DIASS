...
class Examtaker_model extends CI_Model
{
...
// get all
    public function get_all()
    {
        ...
        $this->db->order_by('examtaker_id', 'DESC');
...
// update data
    ...
    {
        $this->db->where('examtaker_id', $id);
        $this->db->update('examtaker', $data);
    }

    public function update_by_permitid($id, $data)
    {
        $this->db->where('examtaker_permit_id', $id);
        $this->db->update('examtaker', $data);
    }
