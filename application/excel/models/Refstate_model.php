...
class Refstate_model extends CI_Model
{
...
// get all
    public function get_all()
    {
        ...
        $this->db->where('ref_state_deleted_at');
        $this->db->order_by('ref_state_id', 'DESC');
...
// delete data
    ...
    public function listajax($columns, $start, $length, $filter = "", $sort = "",
        ...
        if ($sort != "") {
            ...
            $this->db->order_by('ref_state_id', 'ASC');
        }
