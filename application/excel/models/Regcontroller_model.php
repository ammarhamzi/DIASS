...
class Regcontroller_model extends CI_Model
{
...
// get all
    public function get_all()
    {
        ...
        $this->db->where('control_deleted_at');
...
// insert data
    ...
    {
        $this->db->insert('reg_controller', $data);
    }
...
// update data
    ...
    {
        $this->db->where('control_id', $id);
        $this->db->update('reg_controller', $data);
    }
