...
class Permittype_model extends CI_Model {
...
// get all
  function get_all() {
	...
	$this->db->where('permit_type_deleted_at');
	$this->db->order_by('permit_type_id', 'DESC');
...
// get data by id
  function get_by_id($id) {
    $this->db->select('*');
	$this->db->where('permit_type_id', $id);
	$this->db->where('permit_type_deleted_at');
	$this->db->from('permit_type');
...
// insert data
  function insert($data) {
    $this->db->insert('permit_type', $data);
  }

// update data
  function update($id, $data) {
    $this->db->where('permit_type_id', $id);
    $this->db->update('permit_type', $data);
  }

// delete data
  function delete($id) {
    $this->db->where('permit_type_id', $id);
    $this->db->delete('permit_type');
  }
