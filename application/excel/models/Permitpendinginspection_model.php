...
$this->db->distinct();
    ...
    public function listajax($condition, $columns, $start, $length, $filter = "", $sort = "", $sorttype = "")
    {
...
/*        $i = 0;
    ...
    public function recordsTotal($condition)
    {
        $i = 0;
    ...
    public function recordsFiltered($condition, $columns, $filter = "")
    {
        $i = 0;
