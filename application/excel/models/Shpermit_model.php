...
class Shpermit_model extends CI_Model
{
...
// get all
    public function get_all()
    {
        ...
        $this->db->order_by('shpermit_id', 'DESC');
...
// get data by id
    ...
    {
        $this->db->select('shpermit.*, vehicle.*, company.*');
        $this->db->where('shpermit_course_date', $date);
    ...
    {
        $this->db->select('*', false);
        $this->db->where('shpermit_permit_id', $id);
        $this->db->from('shpermit');
