...
// update data
    ...
    function total_avp_price_per_date($date,$kod = '',$paymentMethod = 1,$shift = 4,$paymentLocation = '')
    {
    ...
    function total_payment_by_type_per_date($date,$permit_type_array,$paymentMethod = 1,$shift = 4,$paymentLocation='')
    {
        if(empty($date) || $date == '1970-01-01' || $date == '0000-00-00')
        {
            return 0;
    ...
    function total_payment_by_type1_per_date($date,$permit_type_id,$paymentMethod = 1,$shift = 4,$pro_rated = 0,$paymentLocation='')
    {
        if(empty($date) || $date == '1970-01-01' || $date == '0000-00-00')
        {
            return 0;
    ...
    function get_receipt_no_list($date,$paymentMethod = 1,$paymentLocation='')
    {
