	...
	public function getRawCharWidth($char) {
		if ($char == 173) {
			...
			return (0);
                ...
                //Modified on 29/03/2022 due to PHP 8.1.3 - Implicit conversion from float 0.8826499999999999 to int loses precision
                /* Original code
				...
				for ($xpx = 0; $xpx < $wpx; ++$xpx) {
					for ($ypx = 0; $ypx < $hpx; ++$ypx) {
						...
						$alpha = $this->getGDgamma($img, $color);
                                                //Modified on 29/03/2022 due to PHP 8.1.3 - Implicit conversion from float 0.30910408543115975 to int loses precision
                                                /* Original code
				...
				if ($element[0] == '/') {
					...
					if (($dom[$key]['value'] == 'pre') OR ($dom[$key]['value'] == 'tt')) {
						$dom[$key]['fontname'] = $this->default_monospaced_font;
                                        ...
                                        //Modified on 29/03/2022 due to PHP 8.1.3 - Array and string offset access syntax with curly braces is no longer supported
					/* Original code
