            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="tab_3">
                        <div class="row">
                            <div class="col-md-12">
                                <h3>Application : Electrical Vehicle Driving Permit (EVDP)</h3>
                            </div>
                        </div>
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-6 form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <p><b>Terminal briefing Date:<sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('terminalbriefing_date') ?><span class="text-danger" id="terminalbriefing_date_error"></span></b></p>
                                                    ...
                                                    <div id="calendar"></div>
                                                    <p>
<h3>Selected briefing Date/Location/Session: <span class="label label-warning" id="terminalbriefing_date_display"></span></h3>
                                                    </p>
                                                </div>
                                            </div>
     ...
     <div class="row">
      ...
      <div class="row">
         ...
         <div class="col-md-8"><input type="text" id="expirydate" name="expirydate" class="datepicker"></div>
                                            ...
                                            <h4>Other Documents <sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('evdp_requireddoc') ?><span class="text-danger" id="evdp_requireddoc_error"></span></h4>
                                            <div class="row">
                                                <div class="col-md-12">
...
<ul>
    ...
    <li>Working Permit (Foreigner)</li>
                                                    ...
                                                    <iframe frameBorder="0" width="100%" height="250px" src="/Uploadfiles/evdp_requireddoc/<?php echo $driver_id;?>"></iframe>
                                                </div>
                                                <!--         <div class="col-md-12">
...
<input id="terminalbriefing_session" type="hidden" name="terminalbriefing_session" value="">
<input id="terminalbriefing_title" type="hidden" name="terminalbriefing_title" value="">
    ...
    $(document).ready(function() {
        $(function() {
            ...
            $('#calendar').fullCalendar({
                ...
                defaultView: 'month',
                events: {
                    url: '/Evdpbriefingmanagement/get_availableslot',
                    type: 'POST',
                    data: {},
                    error: function() {
                ...
                eventClick: function(calEvent, jsEvent, view) {
                    ...
                    var location = exam_title[0];
                        ...
                        $("#terminalbriefing_date_display").html(moment(calEvent.start).format('DD-MM-YYYY')+"/"+location+"/"+calEvent.className);
                        $("#terminalbriefing_session").val(calEvent.className);
                        $("#terminalbriefing_title").val(calEvent.title);
...
var status = 0;
if($("#terminalbriefing_date").val() == "") {
   $("#terminalbriefing_date_error").html('<span class="alert_custom">Required</span>') ;
   status = 1;
}else{
$("#terminalbriefing_date_error").html('') ;
}
if($("#driver_photo").val() == "") {
...
if($("#evdp_requireddoc").val() == "") {
   $("#evdp_requireddoc_error").html('<span class="alert_custom">Required</span>') ;
   status = 1;
}else{
    var words = $('#evdp_requireddoc').val().split(',');
    //alert(words.length);
    if(words.length < 5){
     $("#evdp_requireddoc_error").html('<span class="alert_custom">Some required file(s) missing</span>') ;
     status = 1;
    }else{
$("#evdp_requireddoc_error").html('') ;
}
}
