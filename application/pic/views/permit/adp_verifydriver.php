...
<table>
 ...
 <div class="col-md-12 cat_c_hide" style="display:none">
     <input id="healthdeclare" name="healthdeclare" type="checkbox" value="healthdeclare" checked onclick="this.checked=!this.checked;"> I hereby confirmed that the driver have a good health and recommended for airside driving.
 </div>
</div>
<br><br>
<div class="row verifiedform" style="display:none">
...
<table>
	...
	<tr><td><p><input id="vehicleclass" name="vehicleclass[]" type="checkbox" value="6"> Class 6 (EV Vehicles/Equipment)</p></td><td><p style="    margin-left: 25px;">[<a class="fancybox" href="<?php echo base_url('../resources/shared_img/tutorial/5-vehicle-class.jpg');?>">view guide</a>]</p></td></tr>
</table>
 </div>
</div>
