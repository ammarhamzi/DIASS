...
<script src="<?php echo base_url('resources/shared_js/select2/dist/js/select2.min.js'); ?>" crossorigin="anonymous"></script>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="nav-tabs-custom">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <p><b>Application :</b> Stokeholder Vehicle Permit (SHINS)</p>
                            </div>
                        </div>
  ...
  <div class="form-group">
    <label for="shins_insurancedoc">Insurance coverage <sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('shins_insurancedoc') ?><span class="text-danger" id="shins_insurancedoc_error"></span></label>

                                <iframe frameBorder="0" width="100%" height="250px" src="/Uploadfiles/shins_insurancedoc/<?php echo $vehicle_id;?>"></iframe>
  </div>
...
<div class="form-group">
   ...
   <h3><span class="label label-warning" id="inspection_date_display"></span></h3><br>
                        ...
                        <h4>Other Documents <sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('shins_requireddoc') ?><span class="text-danger" id="shins_requireddoc_error"></span></h4>
                        <div class="row">
                            <div class="col-md-12">
...
<ul>
    ...
    <li>PUSPAKOM Cert</li>
                                ...
                                <iframe frameBorder="0" width="100%" height="250px" src="/Uploadfiles/shins_requireddoc/<?php echo $vehicle_id;?>"></iframe>
                            </div>
...
<!--                        <?php
                    if($condition=='renew'){   ?>
                            ...
                            <h3>Detail of Recent SHINS Permit</h3>
                            <div class="row">
                                <div class="col-md-12">
                                    <p>Permit Serial No :
                                        <?php echo $serialno; ?>
                  ...
                  <?php
                     ...
                     ?>
                                ...
                                <table class="table table-bordered" style="width: 100% !important">
                                   ...
                                   <td><input id="fireext_serialno" name="fireext_serialno"> </td>
                                    </tr>
                                    <tr>
                                   ...
                                   <td><input id="fireext_expirydate" name="fireext_expirydate" class="datepicker_local_insurancedate"> </td>
                                    </tr>
                                   ...
                                   <td><!--<input id="tyre_manufacturingdate" name="tyre_manufacturingdate" class="datepicker">--><textarea id="tyre_manufacturingdate" name="tyre_manufacturingdate" class="form-control" placeholder="" rows="5">
tyre front right:
tyre front left:
tyre rear right:
tyre rear left:
...
<!--<td><?php echo $mtwchecklist->mtwchecklist_desc ?></td>-->
                ...
                <input id="permittype" type="hidden" name="permittype" value="shins">
                ...
                <input id="shins_requireddoc" type="hidden" name="shins_requireddoc" value="">
                <input id="shins_insurancedoc" type="hidden" name="shins_insurancedoc" value="">
...
<script>
    ...
    function getuploadfiles(processtype, data) {
        //alert(data);
        if (processtype == 'shins_requireddoc') {
            $("#shins_requireddoc").val(data);
        }
         if(processtype=='shins_insurancedoc'){
         $("#shins_insurancedoc").val(data);
         }
    ...
    $(document).ready(function() {
        $(function() {
            ...
            $('#calendar').fullCalendar({
                ...
                defaultView: 'month',
                events: {
                    url: '/Tepstakeholdermanagement/get_availableslot/',
                    type: 'POST',
                    data: {},
                    error: function() {
...
if($("#shins_insurancedoc").val() == "") {
    $("#shins_insurancedoc_error").html('<span class="alert_custom">Required</span>') ;
    status = 1;
}else{
$("#shins_insurancedoc_error").html('') ;
}
/*if($("#driver_photo").val() == "") {
...
if($("#shins_requireddoc").val() == "") {
    $("#shins_requireddoc_error").html('<span class="alert_custom">Required</span>') ;
    status = 1;
}else{
    var words = $('#shins_requireddoc').val().split(',');
    //alert(words.length);
    if(words.length < 5){
     $("#shins_requireddoc_error").html('<span class="alert_custom">Some required file(s) missing</span>') ;
     status = 1;
    }else{
$("#shins_requireddoc_error").html('') ;
}
}
