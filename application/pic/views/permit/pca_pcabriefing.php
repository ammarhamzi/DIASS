            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="tab_3">
                        <div class="row">
                            <div class="col-md-12">
                                <h3>Application : Preconditioned Air Unit Driving Permit (PCA)</h3>
                            </div>
                        </div>
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-6 form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <p><b>PCA briefing Date:<sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('pcabriefing_date') ?><span class="text-danger" id="pcabriefing_date_error"></span></b></p>
                                                    <p>Please choose any available date to book for pca briefing. Permit application can only proceed after driver has attend the briefing.</p>

                                                    <div id="calendar"></div>
                                                    <p>
<h3>Selected briefing Date/Location/Session: <span class="label label-warning" id="pcabriefing_date_display"></span></h3>
                                                    </p>
                                                </div>
                                            </div>
     ...
     <div class="row">
      ...
      <div class="row">
         ...
         <div class="col-md-8"><input type="text" id="expirydate" name="expirydate" class="datepicker"></div>
                                            ...
                                            <h4>Other Documents <sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('pca_requireddoc') ?><span class="text-danger" id="pca_requireddoc_error"></span></h4>
                                            <div class="row">
                                                <div class="col-md-12">
...
<ul>
    ...
    <li>Support letter from employer/company</li>
                                                    ...
                                                    <iframe frameBorder="0" width="100%" height="250px" src="/Uploadfiles/pca_requireddoc/<?php echo $driver_id;?>"></iframe>
                                                </div>
                                                <!--         <div class="col-md-12">
...
<!--                                            <?php
                    if($condition=='renew'){   ?>
                                                ...
                                                <h3>Detail of Recent PCA Permit</h3>
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <p>Permit Serial No :
                                                            <?php echo $serialno; ?>
     ...
     <div class="row">
      ...
      <iframe frameBorder="0" src="/Uploadfiles/adp_trainercert/<?php echo $driver_id;?>"></iframe>
                                    ...
                                    <input id="permittype" type="hidden" name="permittype" value="pca">
                                    ...
                                    <input id="pcabriefing_date" type="hidden" name="pcabriefing_date" value="">
<input id="pcabriefing_session" type="hidden" name="pcabriefing_session" value="">
<input id="pcabriefing_title" type="hidden" name="pcabriefing_title" value="">
                                    <input id="pca_requireddoc" type="hidden" name="pca_requireddoc" value="">
...
<script>
    ...
    function getuploadfiles(processtype, data) {
        //alert(data);
        if (processtype == 'pca_requireddoc') {
            $("#pca_requireddoc").val(data);
        }
    ...
    $(document).ready(function() {
        $(function() {
            ...
            $('#calendar').fullCalendar({
                ...
                defaultView: 'month',
                events: {
                    url: '/Ffpcabriefingmanagement/get_availableslot',
                    type: 'POST',
                    data: {},
                    error: function() {
                ...
                eventClick: function(calEvent, jsEvent, view) {
                    ...
                    var location = exam_title[0];
                        $("#pcabriefing_date").val(moment(calEvent.start).format('YYYY-MM-DD'));
                        $("#pcabriefing_date_display").html(moment(calEvent.start).format('DD-MM-YYYY')+"/"+location+"/"+calEvent.className);
                        $("#pcabriefing_session").val(calEvent.className);
                        $("#pcabriefing_title").val(calEvent.title);
...
var status = 0;
if($("#pcabriefing_date").val() == "") {
   $("#pcabriefing_date_error").html('<span class="alert_custom">Required</span>') ;
   status = 1;
}else{
$("#pcabriefing_date_error").html('') ;
}
if($("#driver_photo").val() == "") {
...
if($("#pca_requireddoc").val() == "") {
   $("#pca_requireddoc_error").html('<span class="alert_custom">Required</span>') ;
   status = 1;
}else{
    var words = $('#pca_requireddoc').val().split(',');
    //alert(words.length);
    if(words.length < 3){
     $("#pca_requireddoc_error").html('<span class="alert_custom">Some required file(s) missing</span>') ;
     status = 1;
    }else{
$("#pca_requireddoc_error").html('') ;
}
}
