...
<div class="col-md-12">
  ...
  <div class="form-group">
    <label for="wipbriefing_date">Briefing Date: <sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('wipbriefing_date') ?><span class="text-danger" id="shbriefing_date_error"></span></label>
    <input type="text" class="form-control datepicker_local_insurancedate" id="wipbriefing_date" name="wipbriefing_date" placeholder="briefing/send vehicle date">
  </div>

  <div class="form-group">
    <label for="wipbriefing_location">Operation Location: <sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('wipbriefing_location') ?><span class="text-danger" id="wipbriefing_location_error"></span></label>

    <select class="form-control" id="wipbriefing_location" name="wipbriefing_location">
...
$("#wipbriefing_date_error").html('') ;
}

if($("#wipbriefing_location").val() == "") {
   $("#wipbriefing_location_error").html('<span class="alert_custom">Required</span>') ;
   status = 1;
}else{
$("#wipbriefing_location_error").html('') ;
}
...
if($("#wipbriefing_requireddoc").val() == "") {
   ...
   status = 1;
    ...
    var words = $('#wipbriefing_requireddoc').val().split(',');
    //alert(words.length);
    if(words.length < 4){
     $("#wipbriefing_requireddoc_error").html('<span class="alert_custom">Some required file(s) missing</span>') ;
     status = 1;
    }else{
$("#wipbriefing_requireddoc_error").html('') ;
}
}
...
$("#wipbriefing_insurancedoc_error").html('') ;
}
