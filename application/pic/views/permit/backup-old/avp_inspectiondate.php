...
<script src="<?php echo base_url('resources/shared_js/moment/2.29.4/min/moment.23.0/min.js'); ?>" crossorigin="anonymous"></script>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <iframe frameBorder="0" src="/Uploadfiles/avp_requireddoc/<?php echo $vehicle_id;?>"></iframe>
                            </div>
    ...
    $(document).ready(function() {
        $(function() {
            ...
            $('#calendar').fullCalendar({
                ...
                defaultView: 'month',
                events: {
                    url: '/Inspectionmanagement/get_availableslot/avp',
                    type: 'POST',
                    data: {},
                    error: function() {
