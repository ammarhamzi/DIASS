...
<!--                                        <td>Size</td>
        ...
        if(!empty($avp_insurancedoc_filename)){ foreach($avp_insurancedoc_filename as $file){
...
<!--                                        <td>Type</td> -->
        ...
        if(!empty($avp_requireddoc_filename)){ foreach($avp_requireddoc_filename as $file){
          $filename = explode("--", $file['uploadfiles_filename']);
         ?>
                                        <tr>
                                            <td>
                  ...
                  <tr>
                     ...
                     <td><?php echo $mtwchecklist->mtwchecklist_name ?></td>
                                ...
                                <td style="text-align:center; white-space: nowrap;">
                                    ...
                                    <?php
                                        echo '<input id="mtwchecklist_selected" name="mtwchecklist_selected[]" type="checkbox" value="' .$mtwchecklist->mtwchecklist_id. '" ' .(in_array($mtwchecklist->mtwchecklist_id, $avp_mtwchecked_selected)?"checked":""). ' disabled>';
                                    ?>
                                    </div>
                                </td>
                  </tr>
                  ...
                  <?php
                     ...
                     ?>
                                ...
                                <table class="table">
                                   ...
                                   <td>Serial No: </td>
                                   <td>
                                   <?php echo $avppermit_fireext_serialno;?>
                                   ...
                                   <td>Expiry Date: </td>
                                   <td>
                                   <?php echo datelocal($avppermit_fireext_expirydate);?>
                                   ...
                                   <td>
                                   <?php echo nl2br($avppermit_tyre_manufacturingdate);?>
...
<input id="to_step_four" name="to_step_four" type="submit" class="btn btn-primary" value="Submit">
                ...
                <input id="avp_requireddoc" type="hidden" name="avp_requireddoc" value="<?php echo $avp_requireddoc;?>">

                <input id="avp_insurancedoc" type="hidden" name="avp_insurancedoc" value="<?php echo $avp_insurancedoc;?>">
               ...
               <input type="hidden" id="smokecondition" name="smokecondition" value="<?php echo $avppermit_smokecondition;?>">
               <input type="hidden" id="fireext_serialno" name="fireext_serialno" value="<?php echo $avppermit_fireext_serialno;?>">
               <input type="hidden" id="fireext_expirydate" name="fireext_expirydate" value="<?php echo $avppermit_fireext_expirydate;?>">
               <input type="hidden" id="tyre_manufacturingdate" name="tyre_manufacturingdate" value="<?php echo nl2br($avppermit_tyre_manufacturingdate);?>">
<input id="location" type="hidden" name="location" value="<?php echo $location;?>">
<?php
foreach($avp_mtwchecked_selected as $value)
{
?>
                <input id="avp_mtwchecked_selected" type="hidden" name="avp_mtwchecked_selected[]" value="<?php echo $value;?>">
<?php
}
?>
