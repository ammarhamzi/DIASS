            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="tab_3">
                        <div class="row">
                            <div class="col-md-12">
                                <h3>Application : Visual Docking Guidance System Driving Permit (VDGS)</h3>
                            </div>
                        </div>
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-6 form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <p><b>Vdgs briefing Date:<sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('vdgsbriefing_date') ?><span class="text-danger" id="vdgsbriefing_date_error"></span></b></p>
                                                    <p>Please choose any available date to book for vdgs briefing. Permit application can only proceed after driver has attend the briefing.</p>

                                                    <div id="calendar"></div>
                                                    <p>
<h3>Selected briefing Date/Location/Session: <span class="label label-warning" id="vdgsbriefing_date_display"></span></h3>
                                                    </p>
                                                </div>
                                            </div>
     ...
     <div class="row">
      ...
      <div class="row">
         ...
         <div class="col-md-8"><input type="text" id="expirydate" name="expirydate" class="datepicker"></div>
                                            ...
                                            <h4>Other Documents <sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('vdgs_requireddoc') ?><span class="text-danger" id="vdgs_requireddoc_error"></span></h4>
                                            <div class="row">
                                                <div class="col-md-12">
...
<ul>
    ...
    <li>Support letter from employer/company</li>
                                                    ...
                                                    <iframe frameBorder="0" width="100%" height="250px" src="/Uploadfiles/vdgs_requireddoc/<?php echo $driver_id;?>"></iframe>
                                                </div>
                                                <!--         <div class="col-md-12">
...
<!--                                            <?php
                    if($condition=='renew'){   ?>
                                                ...
                                                <h3>Detail of Recent VDGS Permit</h3>
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <p>Permit Serial No :
                                                            <?php echo $serialno; ?>
     ...
     <div class="row">
      ...
      <iframe frameBorder="0" src="/Uploadfiles/adp_trainercert/<?php echo $driver_id;?>"></iframe>
                                    ...
                                    <input id="permittype" type="hidden" name="permittype" value="vdgs">
                                    ...
                                    <input id="vdgsbriefing_date" type="hidden" name="vdgsbriefing_date" value="">
<input id="vdgsbriefing_session" type="hidden" name="vdgsbriefing_session" value="">
<input id="vdgsbriefing_title" type="hidden" name="vdgsbriefing_title" value="">
                                    <input id="vdgs_requireddoc" type="hidden" name="vdgs_requireddoc" value="">
...
<script>
    ...
    function getuploadfiles(processtype, data) {
        //alert(data);
        if (processtype == 'vdgs_requireddoc') {
            $("#vdgs_requireddoc").val(data);
        }
    ...
    $(document).ready(function() {
        $(function() {
            ...
            $('#calendar').fullCalendar({
                ...
                defaultView: 'month',
                events: {
                    url: '/Ffvdgsbriefingmanagement/get_availableslot',
                    type: 'POST',
                    data: {},
                    error: function() {
                ...
                eventClick: function(calEvent, jsEvent, view) {
                    ...
                    var location = exam_title[0];
                        $("#vdgsbriefing_date").val(moment(calEvent.start).format('YYYY-MM-DD'));
                        $("#vdgsbriefing_date_display").html(moment(calEvent.start).format('DD-MM-YYYY')+"/"+location+"/"+calEvent.className);
                        $("#vdgsbriefing_session").val(calEvent.className);
                        $("#vdgsbriefing_title").val(calEvent.title);
/*                        $(".fc-event").css('background-color', 'green');
                        $(this).css('background-color', 'blue');*/
                        //alert(moment().add(3,'days').format("YYYY-MM-DD"));
                        }
                        else
                            alert('The briefing slots are fully booked. Please choose other date.');
                    }
                }
            })
        });
...
var status = 0;
if($("#vdgsbriefing_date").val() == "") {
   $("#vdgsbriefing_date_error").html('<span class="alert_custom">Required</span>') ;
   status = 1;
}else{
$("#vdgsbriefing_date_error").html('') ;
}
if($("#driver_photo").val() == "") {
...
if($("#vdgs_requireddoc").val() == "") {
   $("#vdgs_requireddoc_error").html('<span class="alert_custom">Required</span>') ;
   status = 1;
}else{
    var words = $('#vdgs_requireddoc').val().split(',');
    //alert(words.length);
    if(words.length < 3){
     $("#vdgs_requireddoc_error").html('<span class="alert_custom">Some required file(s) missing</span>') ;
     status = 1;
    }else{
$("#vdgs_requireddoc_error").html('') ;
}
}
