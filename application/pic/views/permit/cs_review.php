...
?>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <p><b>Commercial Supplier Briefing Date:</b></p>
                                <p>
                                   <span class="label label-warning"> <?php echo datelocal($csbriefing_date);?> </span>
                                </p>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <p>
                                   <span class="label label-warning"> <?php echo $csbriefing_location;?> </span>
                                </p>
                            </div>
                        </div>
...
<!--                                        <td>Size</td>
        ...
        if(!empty($cs_insurancedoc_filename)){ foreach($cs_insurancedoc_filename as $file){
...
<!--                                        <td>Type</td> -->
        ...
        if(!empty($cs_requireddoc_filename)){ foreach($cs_requireddoc_filename as $file){
          $filename = explode("--", $file['uploadfiles_filename']);
         ?>
                                        <tr>
                                            <td>
...
<!--                        <?php
                    if($condition=='renew'){   ?>
                            ...
                            <h3>Detail of Recent CS Permit</h3>
                            <div class="row">
                                <div class="col-md-12">
                                    <p>Permit Serial No :
                                        <?php echo $serialno; ?>
    ...
    <table class="table">
        ...
        <?php }
         ...
         ?>
                ...
                <input id="csbriefing_date" type="hidden" name="csbriefing_date" value="<?php echo $csbriefing_date;?>">
                <input id="cs_requireddoc" type="hidden" name="cs_requireddoc" value="<?php echo $cs_requireddoc;?>">

                <input id="cs_insurancedoc" type="hidden" name="cs_insurancedoc" value="<?php echo $cs_insurancedoc;?>">
