            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="nav-tabs-custom">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <p><b>Application :</b> Ground Power Unit Driving Permit (GPU)</p>
                            </div>
                        </div>
            <form autocomplete="off" id="step_submit" name="step_submit" action="/Permit/submit" method="POST"  onsubmit="return validateForm()">
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <p><b>GPU Briefing Date:</b></p>
                                <p>
                                    <span class="label label-warning"><?php echo datelocal($gpubriefing_date);?> </span>
                                </p>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <p><b>Session:</b></p>
                                <p>
                                    <span class="label label-warning"><?php echo $gpubriefing_session;?> </span>
                                </p>
                            </div>
                        </div>
...
<p><?php echo $countryname;?></p>
     ...
     <div class="row">
      ...
      <div class="row">
        ...
        if(!empty($gpu_requireddoc_filename)){ foreach($gpu_requireddoc_filename as $file){
    ...
    <table class="table">
        ...
        <?php }
         ...
         ?>
                ...
                <input id="gpubriefing_date" type="hidden" name="gpubriefing_date" value="<?php echo $gpubriefing_date;?>">
<input id="gpubriefing_session" type="hidden" name="gpubriefing_session" value="<?php echo $gpubriefing_session;?>">
    <input id="location" type="hidden" name="location" value="<?php echo $location;?>">
                <input id="gpu_requireddoc" type="hidden" name="gpu_requireddoc" value="<?php echo $gpu_requireddoc;?>">
