            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="nav-tabs-custom">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <p><b>Application :</b> Passenger Boarding Bridge Driving Permit (PBB)</p>
                            </div>
                        </div>
            <form autocomplete="off" id="step_submit" name="step_submit" action="/Permit/submit" method="POST" onsubmit="return validateForm()">
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <p><b>PBB Briefing Date:</b></p>
                                <p>
                                   <span class="label label-warning"> <?php echo datelocal($pbbbriefing_date);?></span>
                                </p>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <p><b>Session:</b></p>
                                <p>
                                    <span class="label label-warning"><?php echo $pbbbriefing_session;?> </span>
                                </p>
                            </div>
                        </div>
                    </div>
...
<p><?php echo $countryname;?></p>
     ...
     <div class="row">
      ...
      <div class="row">
        ...
        if(!empty($pbb_requireddoc_filename)){ foreach($pbb_requireddoc_filename as $file){
    ...
    <table class="table">
        ...
        <?php }
         ...
         ?>
                ...
                <input id="pbbbriefing_date" type="hidden" name="pbbbriefing_date" value="<?php echo $pbbbriefing_date;?>">
<input id="pbbbriefing_session" type="hidden" name="pbbbriefing_session" value="<?php echo $pbbbriefing_session;?>">
    <input id="location" type="hidden" name="location" value="<?php echo $location;?>">
                <input id="pbb_requireddoc" type="hidden" name="pbb_requireddoc" value="<?php echo $pbb_requireddoc;?>">
