...
<script>
    $('body').on('click', '#verify', function() {
        ...
        $.ajax({
            type: "POST",
            data: {},
            url: "<?php echo base_url() ?>Permit/verify/driver/6/" + $("#driver_id").val(),
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data == "1" || data == "8" || data == "9" || data == "4" || data == "7") {
                    ...
                    $("#notification").html('<div class="alert alert-danger" role="alert">The driver is not available. [Permit application renewal can be made only within 30 days before the expiry date].</div>');
