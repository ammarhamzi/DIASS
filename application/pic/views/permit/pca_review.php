            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="nav-tabs-custom">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <p><b>Application :</b> Preconditioned Air Unit Driving Permit (PCA)</p>
                            </div>
                        </div>
            <form autocomplete="off" id="step_submit" name="step_submit" action="/Permit/submit" method="POST"  onsubmit="return validateForm()">
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <p><b>PCA Briefing Date:</b></p>
                                <p>
                                    <span class="label label-warning"><?php echo datelocal($pcabriefing_date);?> </span>
                                </p>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <p><b>Session:</b></p>
                                <p>
                                    <span class="label label-warning"><?php echo $pcabriefing_session;?> </span>
                                </p>
                            </div>
                        </div>
...
<p><?php echo $countryname;?></p>
     ...
     <div class="row">
      ...
      <div class="row">
        ...
        if(!empty($pca_requireddoc_filename)){ foreach($pca_requireddoc_filename as $file){
    ...
    <table class="table">
        ...
        <?php }
         ...
         ?>
                ...
                <input id="pcabriefing_date" type="hidden" name="pcabriefing_date" value="<?php echo $pcabriefing_date;?>">
<input id="pcabriefing_session" type="hidden" name="gpubriefing_session" value="<?php echo $pcabriefing_session;?>">
    <input id="location" type="hidden" name="location" value="<?php echo $location;?>">
                <input id="pca_requireddoc" type="hidden" name="pca_requireddoc" value="<?php echo $pca_requireddoc;?>">
