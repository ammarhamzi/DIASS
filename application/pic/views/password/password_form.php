...
<div class="container-fluid">
    <ol class="breadcrumb">
      ...
      <!--  <li><a href="<?php echo site_url('password'); ?>"><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span> password <?php echo $this->lang->line('list'); ?></a></li>-->
...
<!--                <div class="row col-md-2">
                    <h5 class="pull-right"><?php echo $this->lang->line('legend'); ?> <span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span> <?php echo $this->lang->line('required_field'); ?></h5>
                            ...
                            <div class="alert alert-info alert-dismissible">
                                ...
                                <p>Your password must follow this guideline:</p>
                                <ul>
                                    <li>Has 8 Characters, Minimum: You need to choose a password that’s long enough. You should generally go for passwords that are a minimum of 8 to 14 characters in length. A longer password would be even better.</li>
<li>Includes minimum of one Number</li>
<li>Includes minimum of one Letter</li>
                                </ul>
                ...
                <div class="row">
                    ...
                    <div class="col-md-10"><input type="text" class="form-control" name="user_username" id="user_username" placeholder="<?php echo $this->lang->line('user_username'); ?>"value="<?php echo $user_username; ?>" maxlength="50" />
                                 </div></div>

                <div class="row">
                    <label class="col-md-2">
                        <?php echo $this->lang->line('user_oldpassword'); ?> <sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('user_oldpassword'); ?>
                    </label>
                    <div class="col-md-10"><input type="text" class="form-control" name="user_oldpassword" id="user_oldpassword" placeholder="<?php echo $this->lang->line('user_oldpassword'); ?>"value="<?php echo $user_oldpassword; ?>" maxlength="250" />
                                 </div></div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-10"><input type="text" class="form-control" name="user_password" id="user_password" placeholder="<?php echo $this->lang->line('user_password'); ?>"value="<?php echo $user_password; ?>" maxlength="250" />
                                 </div></div>
...
?>" />
                        ...
                        <!--<a href="<?php echo site_url('password'); ?>" class="btn btn-default"><span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span> <?php echo $this->lang->line('back'); ?></a>-->
                    </div>
                </div>
            </form>
        </div>
