...
<table width="100%" cellpadding="0" cellspacing="0" style="">
	...
	<tr><td valign="top" colspan="2">
		<table width="100%">
			...
			<p><strong>
      <?php
      if(isset($driverdetail)){
       echo $driverdetail->driver_name;
      }elseif(isset($vehicledetail)){
       echo $vehicledetail->vehicle_registration_no;
      }
      ?>
             / <?php echo $permitdetail->permit_company_receipt;?></strong> </p>
			<p><strong><?php echo $companydetail->company_contact_email;?></strong></p>
			<p><strong><?php echo $companydetail->company_contact_phone;?></strong></p></td>
							<td valign="top" style="padding:10px;">
								<table>
									<tr><td><p>NO RESIT / Receipt No:  <strong>HR/RS <?php echo $permitdetail->permit_payment_invoiceno;?></strong></p>
			...
			<p>CARA BAYAR / Payment method: <strong><?php echo $permitdetail->permit_paymentmethod;?></strong></p>
<?php
if($permitdetail->permit_paymentmethod == '2'){
?>
			<p>No. CEK/ Cheque No: <strong><?php echo $permitdetail->permit_payment_ref_cheque;?></strong></p>
<?php
}
?>
...
<!--			<tr><td>1</td>
			...
			<td><?php echo $chargestypesdetail->price_actual;?></td>-->
			<td><?php echo number_format($permitdetail->permit_payment_new,2);?></td>
			<td><?php echo number_format($permitdetail->permit_payment_new,2);?></td>
		</tr>
        <?php
...
*Untuk pembayaran yang berjumlah RM501 ke atas, sila ke bahagian Kewangan bagi pengeluaran Invoise Cukai Lengkap ("Full Tax Invoice")</td>
		...
		<tr>
			<td style="font-variant: uppercase; text-align: right; font-weight: 800;"></td>
		...
		<table width="100%">
			...
			<p>Nama Pegawai: <strong><?php echo $permitdetail->user_name_permit_issuance_processedby;?></strong> | Diterima pada: <strong><?php echo datelocal($permitdetail->permit_updated_at);?></strong></p> </td><td width="20%"></td></tr>
			<tr><td colspan="2" style="font-size: 8px;">This receipt is computer generated and no signature is required.</td></tr>
