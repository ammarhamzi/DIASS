...
<iframe frameBorder="0" width="100%" height="250px" src="/Uploadfilespermitid/evdp_requireddoc/<?php echo $driver_id;?>/<?php echo $raw_permit_id;?>"></iframe>
<?php
}else{
?>
                                <table class="table">
...
<!--                <br>
                <div class="panel panel-default">
                    <div class="panel-body">
                        <form autocomplete="off" id="submitform" name="submitform" action="/permitall/evdp_submit/" method="POST">
                            <div class="row">
                                <h3>Your Action</h3>
