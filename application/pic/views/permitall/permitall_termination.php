        ...
        <div class="panel-body">
            <div>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <form autocomplete="off" id="submitform" name="submitform" action="/permitall/termination_action/" method="POST">
                            <div class="row">
                                ...
                                <table class="table">
                                    ...
                                    <tr>
                                        <td>
                                        <h4>Please state your reason for termination:<sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('remark') ?></h4>
                                        <textarea id="remark" name="remark" rows="7" cols="80"></textarea></td>
                                    </tr>
                                    <tr>
                                       <td>
                                        <h4>Upload suppported document(s)<sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('permit_termination') ?></h4>
                                        <iframe frameBorder="0"  width="100%" height="250px" src="/Uploadfiles/permit_termination/<?php echo fixzy_decoder($permit_id); ?>"></iframe>
                                       </td>
                                    </tr>

                                    <tr>
                                        <td><input id="agree" name="agree" type="checkbox" value="y"> I hereby confirm that the information provided herein is accurate, correct and complete and that the documents submitted along with this application form are genuine. <?php echo form_error('agree') ?><br><input id="submit" name="submit" type="submit" value="Submit" class="btn btn-primary"></td>
                                    </tr>

                                </table>

                                <input type="hidden" name="permit_id" id="permit_id" value="<?php echo $permit_id; ?>">
                                <input id="permit_termination" type="hidden" name="permit_termination" value="">
...
<script>
    ...
    function getuploadfiles(processtype, data) {
        //alert(data);
        if (processtype == 'permit_termination') {
            $("#permit_termination").val(data);
        }
    }
</script>