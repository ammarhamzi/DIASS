...
?></div>
    <div class="col-md-3"><p>Date: <b><?php echo datelocal($shinspermit_inspection_date);?></b></p></div>
    <div class="col-md-3"><p>Location: <b><?php echo ($shinspermit_inspection_location?$shinspermit_inspection_location:"KLIA");?></b></p></div>
...
?>
    ...
    <div class="col-md-3"><p>TEP date range: <b><?php echo datelocal(datelocal($permit_issuance_startdate));?> to <?php echo datelocal(datelocal($permit_issuance_expirydate));?> (<?php echo $days+1;?> days)</b></p></div>
</div>
<br>
                <!-- Nav tabs -->
                            ...
                            <div class="col-md-4">
                                ...
                                <table class="table table-condensed table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-md-6">
                                            <?php echo datelocal($shinspermit_policyexpirydate); ?>
                                        </td>
                                    </tr>
                            ...
                            <!--                            <div class="col-md-4">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php //echo datelocal($adppermit_certbytrainer_date); ?>
                                        </td>
                                    </tr>
...
<ul>
    ...
    <li>previous vehicle service sheet</li>
    <li>PUSPAKOM Cert</li>

</ul>
<iframe frameBorder="0" width="100%" height="250px" src="/Uploadfilespermitid/shins_requireddoc/<?php echo $vehicle_id;?>/<?php echo $raw_permit_id;?>"></iframe>
<?php
}else{
?>
                                <table class="table">
                    ...
                    <div role="tabpanel" class="tab-pane" id="inspectionresult">
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <p>Date: <b><?php echo datelocal($shinspermit_inspection_date); ?></b> </p>
                                    </div>
                                    <div class="col-md-12">
                                        <p>Inspector: <b><?php echo $shinspermit_result_inspector_id; ?></b> </p>
                                    </div>
                                    <div class="col-md-12">
...
<h4>Mechanical Engineer :</h4>
                                <div class="row">
                                    <div class="col-md-12">
                                        <p>Date: <b><?php echo datelocal($shinspermit_managerverified_date); ?></b> </p>
                                    </div>
                                    <div class="col-md-12">
                            ...
                            <div class="col-md-8">
                                <h3>Inspection Result
                                    <?php
                                     if($shinspermit_result == 'passed'){
                                     echo '<span style="color:green">PASS</span>';
                                     }elseif($shinspermit_result == 'failed'){
    echo '<span style="color:red">FAILED</span>';
                                     }elseif($shinspermit_result == 'managerfailed'){
    echo '<span style="color:red">Mechanical Engineer Unverified</span>';
                                     }elseif($shinspermit_result == 'kiv'){
                  ...
                  <tr>
                     ...
                     <td><?php echo $mtwchecklist->mtwchecklist_name ?></td>
                                ...
                                <td style="text-align:center; white-space: nowrap;">
                                    ...
                                    <?php
                                        echo '<input type="checkbox" value="' .$mtwchecklist->mtwchecklist_id. '" ' .(in_array($mtwchecklist->mtwchecklist_id, $shins_selfchecked_selected)?"checked":""). ' disabled>';
                                    ?>
                                    </div>
                                </td>
                                <td style="text-align:left; white-space: nowrap;">
                                    ...
                                    <?php
                                        //echo '<input type="checkbox" value="' .$mtwchecklist->mtwchecklist_id. '" ' .(in_array($mtwchecklist->mtwchecklist_id, $shins_mtwchecked_selected)?"checked":""). ' disabled>';
                                    ?>
                                            <input type="radio" name="mtwinspect_<?php echo $mtwchecklist->mtwchecklist_id;?>"  value="y" <?php echo (in_array($mtwchecklist->mtwchecklist_id, $shins_mtwchecked_y_selected)?"checked":"");?> disabled
                                            /> <span style="color: #00CC00">PASS</span>
                                            <br>
                                            <input type="radio" name="mtwinspect_<?php echo $mtwchecklist->mtwchecklist_id;?>" value="n" <?php echo (in_array($mtwchecklist->mtwchecklist_id, $shins_mtwchecked_n_selected)?"checked":"");?> disabled
                                            /> <span style="color: #CC0000">FAIL</span>
                                            <br>
                                            <input type="radio" name="mtwinspect_<?php echo $mtwchecklist->mtwchecklist_id;?>" value="n/a" <?php echo (in_array($mtwchecklist->mtwchecklist_id, $shins_mtwchecked_na_selected)?"checked":"");?> disabled
...
<div class="row">
  <div class="col-md-12">
                                <table class="table table-bordered" style="width: 100% !important">
                                   ...
                                   <td>
                                   <?php echo $shinspermit_smokecondition;?>
                                    </td>
                                    <td><input type="checkbox" name="smokecondition_checked" value="y" <?php echo ($shinspermit_smokecondition_checked=='y'?'checked':'');?> disabled></td>
                                    </tr>
                                    <tr>
                                   <th colspan="3" style=" background-color: #C9D4E1">Fire Extinguisher </th>
                                    ...
                                    <tr>
                                   <td>Serial No: </td>
                                   <td><?php echo $shinspermit_fireext_serialno;?> </td>
                                   <td><input type="checkbox" name="fireext_serialno_checked" value="y" <?php echo ($shinspermit_fireext_serialno_checked=='y'?'checked':'');?> disabled></td>
                                    </tr>
                                    <tr>
                                   <td>Expiry Date: </td>
                                   <td><?php echo datelocal($shinspermit_fireext_expirydate);?> </td>
                                   <td><input type="checkbox" name="fireext_expirydate_checked" value="y" <?php echo ($shinspermit_fireext_expirydate_checked=='y'?'checked':'');?> disabled></td>
                                    </tr>
                                   ...
                                   <td><?php echo $shinspermit_tyre_manufacturingdate;?> </td>
                                   <td><input type="checkbox" name="tyre_manufacturingdate_checked" value="y" <?php echo ($shinspermit_tyre_manufacturingdate_checked=='y'?'checked':'');?> disabled></td>
                                    </tr>
                                </table>
  </div>
</div>
