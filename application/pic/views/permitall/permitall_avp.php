...
?></div>
    <div class="col-md-3"><p>Date: <b><?php echo datelocal($avppermit_inspection_date);?></b></p></div>
...
<iframe frameBorder="0" width="100%" height="250px" src="/Uploadfilespermitid/avp_requireddoc/<?php echo $vehicle_id;?>/<?php echo $raw_permit_id;?>"></iframe>
<?php
}else{
?>
                                <table class="table">
