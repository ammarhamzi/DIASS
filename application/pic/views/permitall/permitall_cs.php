                            ...
                            <div class="col-md-4">
                                ...
                                <table class="table table-condensed table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-md-6">
                                            <?php echo datelocal($cspermit_policyexpirydate); ?>
                                        </td>
                                    </tr>
...
<iframe frameBorder="0" width="100%" height="250px" src="/Uploadfilespermitid/cs_requireddoc/<?php echo $vehicle_id;?>/<?php echo $raw_permit_id;?>"></iframe>
<?php
}else{
?>
                                <table class="table">
...
<!--                <br>
                <div class="panel panel-default">
                    <div class="panel-body">
                        <form autocomplete="off" id="submitform" name="submitform" action="/permitall/cs_submit/" method="POST">
                            <div class="row">
                                <h3>Your Action</h3>
