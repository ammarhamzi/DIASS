...
<div class="container-fluid">
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo site_url('permitvalid'); ?>"><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span> <?php echo $this->lang->line('permitvalid'); ?> <?php echo $this->lang->line('list'); ?></a></li>
        <li class="active"><span class="glyphicon glyphicon-file" aria-hidden="true"></span>
            <?php echo $this->lang->line('permitvalid'); ?>
...
?>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <form autocomplete="off" id="submitform" name="submitform" action="/permitvalid/adp_submit/" method="POST">
                            <div class="row">
                                <h3>Your Action</h3>
...
?>
    ...
    <a href="/permitvalid/termination/<?php echo $permit_id;?>" class="btn btn-info">Termination</a>
    <a href="/permitvalid/replacement/<?php echo $permit_id;?>" class="btn btn-success">Replacement</a>
