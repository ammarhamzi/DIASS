...
<!--       <tr>
         <th class="col-md-3 text-right"><?php echo $this->lang->line('user_password'); ?></th>
         <td class="col-md-9"><?php echo $user_password; ?></td>
       </tr>-->
                ...
                <tr>
                    ...
                    <td class="col-md-9"><p><img src = "<?php echo base_url(); ?>resources/shared_img/<?php echo ($user_photo
