            ...
            <iframe frameBorder="0" class="embed-responsive-item" src="/Uploadfiles/driver_info/<?php echo $driver_id; ?>"></iframe>
                        ...
                        <div class="row">
                            <div class="col-md-12 text-right">
                                ...
                                <button type="submit" class="btn btn-primary"><span class="glyphicon glyphicon-save" aria-hidden="true"></span> Submit</button>
...
?>
    <script>
        $(document).ready(function() {
            var arr = [ 'driver_permit_typeid', 'driver_activity_statusid', 'driver_application_date','driver_name','driver_displayname','driver_dob','driver_ic','driver_nationality_country_id'];
...
/*if($("#driver_blacklistedremark").val() == "") {
    $("#driver_blacklistedremark_error").html('<span class="alert_custom">Required</span>') ;
    status = 1;
}else{
$("#driver_blacklistedremark_error").html('') ;
}*/
if($("#driver_info").val() == "") {
