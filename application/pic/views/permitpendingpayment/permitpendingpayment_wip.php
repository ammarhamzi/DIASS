...
<div class="container-fluid">
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo site_url('permitpendingpayment'); ?>"><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span> <?php echo $this->lang->line('permitpendingpayment'); ?> <?php echo $this->lang->line('list'); ?></a></li>
        <li class="active"><span class="glyphicon glyphicon-file" aria-hidden="true"></span>
            <?php echo $this->lang->line('permitpendingpayment'); ?>
...
?>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <form autocomplete="off" id="submitform" name="submitform" action="/permitpendingpayment/adp_submit/" method="POST">
                            <div class="row">
                                <h3>Your Action</h3>
...
if($permit_officialstatus!='COMPLETED'){
?>
    <a href="/permitpendingpayment/cancellation/<?php echo $permit_id;?>" class="btn btn-warning">Cancellation</a>
<?php
}
?>
