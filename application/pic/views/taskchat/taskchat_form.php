...
<h4><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> <?php echo $this->lang->line('taskchat'); ?> <?php echo $button; ?></h4>
  </div>
...
<div class="row">
          <label class="col-md-3 text-right">
            <?php echo $this->lang->line('task_id'); ?> <sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('task_id'); ?>
          </label>
<div class="col-md-9"><input type="text" class="form-control isInteger" name="task_id" id="task_id" placeholder="<?php echo $this->lang->line('task_id'); ?>" value="<?php echo $task_id; ?>" maxlength="11" />
         </div></div>

<div class="row">
          <label class="col-md-3 text-right">
            <?php echo $this->lang->line('taskchat_memberid'); ?> <sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('taskchat_memberid'); ?>
          </label>
<div class="col-md-9"><input type="text" class="form-control isInteger" name="taskchat_memberid" id="taskchat_memberid" placeholder="<?php echo $this->lang->line('taskchat_memberid'); ?>" value="<?php echo $taskchat_memberid; ?>" maxlength="11" />
         </div></div>

<div class="row">
          <label class="col-md-3 text-right">
            <?php echo $this->lang->line('taskchat_content'); ?> <sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('taskchat_content'); ?>
          </label>
<div class="col-md-9"><textarea class="form-control" name="taskchat_content" id="taskchat_content" placeholder="<?php echo $this->lang->line('taskchat_content'); ?>" rows="5" cols="50"><?php echo $taskchat_content; ?></textarea>
         </div></div>

<div class="row">
          <label class="col-md-3 text-right">
            <?php echo $this->lang->line('taskchat_date'); ?> <sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('taskchat_date'); ?>
          </label>
<div class="col-md-9"><input type="text" class="form-control datetimepicker" name="taskchat_date" id="taskchat_date" placeholder="<?php echo $this->lang->line('taskchat_date'); ?>" value="<?php echo $taskchat_date; ?>" />
         </div></div>

<div class="row">
<div class="col-md-offset-3 col-md-9">
         <input type="hidden" name="taskchat_id" value="<?php echo (isset($id) ? $id : ""); ?>" />
