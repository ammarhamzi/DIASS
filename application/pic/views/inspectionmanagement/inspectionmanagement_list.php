            ...
            <table id="mytable" class="table" style="width: 100% !important">
                ...
                <thead>
                    <tr>
                        ...
                        <!--<th><?php echo $this->lang->line('inspectionmanagement_remark');?></th> -->
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var table = $("#mytable").DataTable({
            "processing": true,
            "serverSide": true,
            "ajax": "<?php echo site_url() ?>/inspectionmanagement/get_json",
            responsive: true,
            dom: 'lfrBtip',
            buttons: [
                <?php
         ...
         ?> {
                    ...
                    action: function(e, dt, node, config) {
                        redirect("<?php echo site_url('inspectionmanagement/create');?>");
                    }
                },
                <?php }?>
                <?php
