...
$this->load->model('evpchecklist_model');*/
        ...
        // Re-enabled authentication check for local development
        if ($this->session->userdata('authentication') == "y" && !$this->session->userdata('islogin') && strtolower($this->router->fetch_class()) != "authentication" && strtolower($this->router->fetch_class()) != "examdriver") {
            ...
            if ($this->session->userdata('islogin') && $this->check_requiredinfo() == false && strtolower($this->router->fetch_class()) != "profile" && strtolower($this->router->fetch_class()) != "authentication") {
