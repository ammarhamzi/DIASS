...
class Exammanagement_model extends CI_Model
{
...
// get all
    ...
    userlist.user_name AS user_name_exammanagement_officer_pic', false);
        ...
        $this->db->order_by('exammanagement.exammanagement_id', 'DESC');
        $this->db->from('exammanagement');
        $this->db->join('userlist', 'userlist.user_id = exammanagement.exammanagement_officer_pic', 'left');
...
// get data by id
    ...
    {
        $this->db->select('*');
        $this->db->where('exammanagement.exammanagement_id', $id);
        $this->db->where('exammanagement_deleted_at');
        $this->db->from('exammanagement');
    ...
    public function get_by_date($date)
    {
        ...
        $this->db->where('exammanagement.exammanagement_date', $date);
        $this->db->where('exammanagement_deleted_at');
        $this->db->from('exammanagement');
