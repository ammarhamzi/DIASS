...
// get all
  ...
  function get_candidate_answer($id) {
    $this->db->select('examresult.*, examsession.examsession_pass', FALSE);    
    $this->db->from('examresult');
    $this->db->join('examsession', 'examsession.examsession_id = examresult.examresult_examsession_id', 'left');
