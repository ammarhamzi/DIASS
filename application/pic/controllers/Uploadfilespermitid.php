...
class Uploadfilespermitid extends CI_Controller
{
    ...
    public function adp_requireddoc($driverid, $permitid = '', $deleteid = '')
    {
        ...
        $data['files']       = $this->uploadfiles_model->get_adp_requireddoc($driverid,$permitid);
    ...
    public function driver_photo($driverid, $deleteid = '')
    {
    ...
    public function evdp_requireddoc($driverid, $permitid = '', $deleteid = '')
    {
        ...
        // Get files data from the database
        $data['files']       = $this->uploadfiles_model->get_evdp_requireddoc($driverid,$permitid);
    ...
    public function driver_info($driverid, $deleteid = '')
    {
    ...
    public function avp_requireddoc($vehicleid, $permitid = '', $deleteid = '')
    {
        ...
        // Get files data from the database
        $data['files']       = $this->uploadfiles_model->get_avp_requireddoc($vehicleid,$permitid);
    ...
    public function evp_requireddoc($vehicleid, $permitid = '', $deleteid = '')
    {
        ...
        // Get files data from the database
        $data['files']       = $this->uploadfiles_model->get_evp_requireddoc($vehicleid,$permitid);
    ...
    public function pbb_requireddoc($driverid, $permitid = '', $deleteid = '')
    {
        ...
        // Get files data from the database
        $data['files']       = $this->uploadfiles_model->get_pbb_requireddoc($driverid,$permitid);
    ...
    public function sh_requireddoc($vehicleid, $permitid = '', $deleteid = '')
    {
        ...
        // Get files data from the database
        $data['files']       = $this->uploadfiles_model->get_sh_requireddoc($vehicleid,$permitid);
    ...
    public function vdgs_requireddoc($driverid, $permitid = '', $deleteid = '')
    {
        ...
        // Get files data from the database
        $data['files']       = $this->uploadfiles_model->get_vdgs_requireddoc($driverid,$permitid);
    ...
    public function cs_requireddoc($vehicleid, $permitid = '', $deleteid = '')
    {
        ...
        // Get files data from the database
        $data['files']       = $this->uploadfiles_model->get_cs_requireddoc($vehicleid,$permitid);
...
/*            'Previous Vehicle Service Sheet or PUSPAKOM Cert',
    ...
    public function gpu_requireddoc($driverid, $permitid = '', $deleteid = '')
    {
        ...
        // Get files data from the database
        $data['files']       = $this->uploadfiles_model->get_gpu_requireddoc($driverid,$permitid);
    ...
    public function pca_requireddoc($driverid, $permitid = '', $deleteid = '')
    {
        ...
        // Get files data from the database
        $data['files']       = $this->uploadfiles_model->get_pca_requireddoc($driverid,$permitid);
    ...
    public function wip_requireddoc($vehicleid, $permitid = '', $deleteid = '')
    {
        ...
        // Get files data from the database
        $data['files']       = $this->uploadfiles_model->get_wip_requireddoc($vehicleid,$permitid);
    ...
    public function shins_requireddoc($vehicleid, $permitid = '', $deleteid = '')
    {
        ...
        // Get files data from the database
        $data['files']       = $this->uploadfiles_model->get_shins_requireddoc($vehicleid,$permitid);
    ...
    public function wipbriefing_requireddoc($vehicleid, $permitid = '', $deleteid = '')
    {
        ...
        // Get files data from the database
        $data['files']       = $this->uploadfiles_model->get_wipbriefing_requireddoc($vehicleid,$permitid);
