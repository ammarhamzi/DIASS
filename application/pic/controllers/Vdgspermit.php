        ...
        if ($this->permission->cp_read == true) {
            ...
            if ($row) {
                $data = [
                    ...
                    'vdgspermit_attendvdgsbriefing' => $row->vdgspermit_attendvdgsbriefing,
...
//check if parentchild exist
    ...
    public function create()
    {
        ...
        if ($this->permission->cp_create == true) {
            ...
            $data = [
                ...
                'vdgspermit_attendvdgsbriefing' => set_value('vdgspermit_attendvdgsbriefing'),
        ...
        if ($this->permission->cp_create == true) {
            ...
            if ($this->form_validation->run() == false) {
                ...
                $data = [
                    ...
                    'vdgspermit_attendvdgsbriefing' => $this->input->post('vdgspermit_attendvdgsbriefing', true),
        ...
        if ($this->permission->cp_update == true) {
            ...
            if ($row) {
                $data = [
                    ...
                    'vdgspermit_attendvdgsbriefing' => set_value('vdgspermit_attendvdgsbriefing', $row->vdgspermit_attendvdgsbriefing),
    ...
    public function _rules()
    {
        ...
        $this->form_validation->set_rules('vdgspermit_attendvdgsbriefing', ' ', 'trim');
    ...
    public function get_json()
    {
        ...
        foreach ($results as $r) {
            ...
            array_push($data, [
                ...
                $r['vdgspermit_attendvdgsbriefing'],
