...
exit;*/
        ...
        $count_slottaken = $this->tepbriefingmanagement_model->get_slottaken($value->tepbriefingmanagement_date,$value->tepbriefingmanagement_location);
...
$title = $value->tepbriefingmanagement_location.'-'.$count_slottaken.'/'. $value->tepbriefingmanagement_slot;
