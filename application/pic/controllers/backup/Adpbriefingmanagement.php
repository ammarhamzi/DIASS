...
/* $this->logQueries($this->config->item('dblog')); */
  ...
  public function _rules() {
    ...
    if($condition=="renew"){
        ...
        $row = $this->adpbriefingmanagement_model->get_slot($firstdate,$condition,$drivingclass);
/*    var_dump($row);
exit;*/
...
$title = $value->adpbriefingmanagement_location.'-'.(!empty($value->adpbriefingmanagement_slottaken)?$value->adpbriefingmanagement_slottaken:'0').'/'. $value->adpbriefingmanagement_slot;
