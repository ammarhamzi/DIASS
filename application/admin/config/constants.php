...
|
*/
defined('_LOGIN_METHOD') OR define('_LOGIN_METHOD', 'STAGING');
...
|
*/
defined('_LOGIN_SPECIAL_USERNAME') OR define('_LOGIN_SPECIAL_USERNAME', '["super_admin", "admin@diass.com", "diass@diass.com"]');
...
define('CHANGETOREJECT_PERMIT','Permit application rejected');
define('CHANGETOREJECT_PERMIT_DESC','Permit application rejected by admin');

define('_ACCEPT_FILE_TYPE','.jpg,.jpeg,.png,.pdf,.ppt,.pptx,.doc,.docx');

/*
|--------------------------------------------------------------------------
| Offence Catalogue Revision Control
|--------------------------------------------------------------------------
|
| Controls which offence catalog version to use for new enforcements.
| Supported revisions: 2019, 2020, 2025
|
*/
defined('CURRENT_OFFENCE_REVISION') OR define('CURRENT_OFFENCE_REVISION', '2025');