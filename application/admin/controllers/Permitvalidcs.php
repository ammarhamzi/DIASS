...
class Permitvalidcs extends MY_Controller
{

    public function __construct()
    {
        parent::__construct();
        $this->load->model('permitvalidcs_model');
        ...
        $this->lang->load('permitvalidcs_lang', $this->session->userdata('language'));
    ...
    public function index()
    {
        ...
        if ($this->permission->showlist == true) {
            ...
            $data = [
                ...
                'controller' => 'Permitvalidcs',
                'pagetitle' => 'Active TEP (Commercial Supplier) Permits',
            ];
    ...
    public function get_json($location='all')
    {
        ...
        $results = $this->permitvalidcs_model->listajax(
            $location,
            $columns,
           $columnfilter,
...
$r['permit_issuance_serialno'],
        ...
        echo json_encode(
            [
                ...
                "recordsTotal" => $this->permitvalidcs_model->recordsTotal($location)->recordstotal,
                "recordsFiltered" => $this->permitvalidcs_model->recordsTotal($location)->recordstotal,
                'data' => $data
            ]
        );
    }
...
;
/* End of file Permitvalidcs.php */
/* Location: ./application/controllers/Permitvalidcs.php */
