...
class Permitvalidwip extends MY_Controller
{

    public function __construct()
    {
        parent::__construct();
        $this->load->model('permitvalidwip_model');
        ...
        $this->lang->load('permitvalidwip_lang', $this->session->userdata('language'));
    ...
    public function index()
    {
        ...
        if ($this->permission->showlist == true) {
            ...
            $data = [
                ...
                'controller' => 'Permitvalidwip',
                'pagetitle' => 'Active TEP (Work In Progress - Runway, taxiway, apron) Permits',
            ];
    ...
    public function get_json($location='all')
    {
        ...
        $results = $this->permitvalidwip_model->listajax(
            $location,
            $columns,
           $columnfilter,
...
$r['permit_issuance_serialno'],
        ...
        echo json_encode(
            [
                ...
                "recordsTotal" => $this->permitvalidwip_model->recordsTotal($location)->recordstotal,
                "recordsFiltered" => $this->permitvalidwip_model->recordsTotal($location)->recordstotal,
                'data' => $data
            ]
        );
    }
...
;
/* End of file Permitvalidwip.php */
/* Location: ./application/controllers/Permitvalidwip.php */
