...
class Permitvalidpbb extends MY_Controller
{

    public function __construct()
    {
        parent::__construct();
        $this->load->model('permitvalidpbb_model');
        ...
        $this->lang->load('permitvalidpbb_lang', $this->session->userdata('language'));
    ...
    public function index()
    {
        ...
        if ($this->permission->showlist == true) {
            ...
            $data = [
                ...
                'controller' => 'Permitvalidpbb',
                'pagetitle' => 'Active FFOP (Passenger Boarding Bridge) Permits',
            ];
...
//        ];
        ...
        $results = $this->permitvalidpbb_model->listajax(
            $location,
            $columns,
           $columnfilter,
...
$r['permit_issuance_serialno'],
        ...
        echo json_encode(
            [
                ...
                "recordsTotal" => $this->permitvalidpbb_model->recordsTotal($location)->recordstotal,
                "recordsFiltered" => $this->permitvalidpbb_model->recordsTotal($location)->recordstotal,
                'data' => $data
            ]
        );
    }
...
;
/* End of file Permitvalidpbb.php */
/* Location: ./application/controllers/Permitvalidpbb.php */
