...
class Permitglobalreport_2 extends MY_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('permitglobalreport_2_model');
    ...
    public function index()
    {
        ...
        if ($this->permission->showlist == true) {
            ...
            $data = [
                ...
                'controller' => 'permitglobalreport_2',
            ...
            $this->content = 'permitglobalreport_2/permitall_list_process_2';
...
//        
//        $columnfilter = [
//             'permit_location' => $this->input->post('permit_location'),
//            'company_name' => $this->input->post('company_name'),
//            'permit_type_desc' =>  $this->input->post('permit_type_desc'),
//            'permit_group_name' => $this->input->post('permit_group_name'),
//            'permit_condition_name' => $this->input->post('permit_condition_name'),
//            'permit_officialstatus_name' => $this->input->post('permit_officialstatus_name'),
//            'vehiclegroup_name' => $this->input->post('vehiclegroup_name'),
//            'enginecapacity_name' => htmlspecialchars($this->input->post('enginecapacity_name')),
//           'ref_country_printable_name' => $this->input->post('ref_country_printable_name'),
//           'permit_issuance_startdate' => (!empty($this->input->post('permit_issuance_startdate'))?dateserver($this->input->post('permit_issuance_startdate')):""),
//           'permit_issuance_expirydate' => (!empty($this->input->post('permit_issuance_expirydate'))?dateserver($this->input->post('permit_issuance_expirydate')):""),
//           'permit_created_at_from' => (!empty($this->input->post('permit_created_at_from'))?dateserver($this->input->post('permit_created_at_from')):""),
//           'permit_created_at_to' => (!empty($this->input->post('permit_created_at_to'))?dateserver($this->input->post('permit_created_at_to')):""),
//        ];

        $results = $this->permitglobalreport_2_model->listajax(
            $columnfilter,
...
//            $this->input->get('order')[0]['dir']
        ...
        foreach ($results as $r) {
            ...
            if ($this->permission->cp_read == true) {
                $rud .= anchor(site_url('permitglobalreport_2/' . strtolower($r['permit_type_name']) . '/' . fixzy_encoder($r['permit_id'])), '<button type="button" class="btn btn-info"><span class="glyphicon glyphicon-search" aria-hidden="true"></span></button>') .
                    ' ';
            }
$driver_id = "";
                $val       = "";
