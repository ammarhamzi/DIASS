...
class Permitprintout extends MY_Controller
{

    public function __construct()
    {
        parent::__construct();
        $this->load->model('permitprintout_model');
        ...
        $this->lang->load('permitprintout_lang', $this->session->userdata('language'));
    ...
    public function adp($id)
    {
        ...
        if (trim($data['adppermit_verifybymahb_drivingarea']) == 'A') {
            $this->load->view('permitprintout/permitprintout_adp_a', $data);
        } elseif (trim($data['adppermit_verifybymahb_drivingarea']) == 'B1') {
            $this->load->view('permitprintout/permitprintout_adp_b1', $data);
        } elseif (trim($data['adppermit_verifybymahb_drivingarea']) == 'B2') {
            $this->load->view('permitprintout/permitprintout_adp_b2', $data);
        } elseif (trim($data['adppermit_verifybymahb_drivingarea']) == 'C') {
            $this->load->view('permitprintout/permitprintout_adp_c', $data);
        }
    ...
    public function evdp($id)
    {
        ...
        $this->load->view('permitprintout/permitprintout_evdp_raw', $data);
    ...
    public function avp($id)
    {
        ...
        $this->load->view('permitprintout/permitprintout_avp_raw', $data);
    ...
    public function evp($id)
    {
        ...
        $this->load->view('permitprintout/permitprintout_evp_raw', $data);
    ...
    public function adp_submit()
    {
        ...
        $this->db->trans_start();
        $this->permitprintout_model->update($permitid, $data_permit);
    ...
    public function get_json()
    {
        ...
        $results = $this->permitprintout_model->listajax(
            $columns,
            $columnfilter,
        ...
        foreach ($results as $r) {
            ...
            if ($this->permission->cp_read == true) {
                ...
                if ($r['permit_officialstatus_name_permit_officialstatus'] == "completed") {
                    $rud .= anchor(site_url('permitprintout/termination/' . fixzy_encoder($r['permit_id'])), 'Terminate', 'class="btn btn-primary btn-xs"') . ' ' . anchor(site_url('permitprintout/replacement/' . fixzy_encoder($r['permit_id'])), 'Replace', 'class="btn btn-primary btn-xs"') . ' ' . anchor_popup(site_url('permitprintout/' . strtolower($r['permit_type_name_permit_typeid']) . '/' . fixzy_encoder($r['permit_id'])), 'Renew', 'class="btn btn-primary btn-xs"') .
                        ' ';
                } else {
                    if ($r['permit_officialstatus_name_permit_officialstatus'] != "canceled" && $r['permit_officialstatus_name_permit_officialstatus'] != "paid" && $r['permit_status'] != "permitterminationpending" && $r['permit_status'] != "permitreplacementpending") {
                        $rud .= anchor(site_url('permitprintout/cancellation/' . fixzy_encoder($r['permit_id'])), 'Cancel', 'class="btn btn-primary btn-xs"') .
                            ' ';
                    }

                }

                $rud .= anchor_popup(site_url('permitprintout/' . strtolower($r['permit_type_name_permit_typeid']) . '/' . fixzy_encoder($r['permit_id'])), '<button type="button" class="btn btn-info"><span class="glyphicon glyphicon-print" aria-hidden="true"></span></button>') .
                    ' ';
            }
...
/*                $i, */
        ...
        echo json_encode(
            [
                ...
                "recordsTotal" => $this->permitprintout_model->recordsTotal()->recordstotal,
                "recordsFiltered" => $this->permitprintout_model->recordsFiltered($columns, $columnfilter,$this->input->get('search')['value'])->recordsfiltered,
                'data' => $data
            ]
        );
    }
    ...
    public function pbb($id)
    {
        ...
        $this->load->view('permitprintout/permitprintout_pbb_raw', $data);
    ...
    public function pca($id)
    {
        ...
        $this->load->view('permitprintout/permitprintout_pca_raw', $data);
    ...
    public function gpu($id)
    {
        ...
        $this->load->view('permitprintout/permitprintout_gpu_raw', $data);
    ...
    public function cs($id)
    {
        ...
        $this->load->view('permitprintout/permitprintout_cs_raw', $data);
    ...
    public function vdgs($id)
    {
        ...
        $this->load->view('permitprintout/permitprintout_vdgs_raw', $data);
    ...
    public function sh($id)
    {
        ...
        $this->load->view('permitprintout/permitprintout_sh_raw', $data);
    ...
    public function wip($id)
    {
        ...
        $this->load->view('permitprintout/permitprintout_wip_raw', $data);
    ...
    public function shins($id)
    {
        ...
        $this->load->view('permitprintout/permitprintout_shins_raw', $data);
    ...
    public function wipbriefing($id)
    {
        ...
        $this->load->view('permitprintout/permitprintout_wipbriefing_raw', $data);
...
;
/* End of file Permitprintout.php */
/* Location: ./application/controllers/Permitprintout.php */
