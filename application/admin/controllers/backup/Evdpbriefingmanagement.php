...
$title = $value->evdpbriefingmanagement_location.'-(' .$value->evdpbriefingmanagement_category. ')-'.$value->evdpbriefingmanagement_slottaken.'/'. $value->evdpbriefingmanagement_slot;
