...
class Permitvalidevdp extends MY_Controller
{

    public function __construct()
    {
        parent::__construct();
        $this->load->model('permitvalidevdp_model');
        ...
        $this->lang->load('permitvalidevdp_lang', $this->session->userdata('language'));
    ...
    public function index()
    {
        ...
        if ($this->permission->showlist == true) {
            ...
            $data = [
                ...
                'controller' => 'Permitvalidevdp',
                'pagetitle' => 'Active Electrical Vehicle Driving Permits',
            ];
...
//        ];
        ...
        $results = $this->permitvalidevdp_model->listajax(
            $location,
            $columns,
           $columnfilter,
...
$r['permit_issuance_serialno'],
        ...
        echo json_encode(
            [
                ...
                "recordsTotal" => $this->permitvalidevdp_model->recordsTotal($location)->recordstotal,
                "recordsFiltered" => $this->permitvalidevdp_model->recordsTotal($location)->recordstotal,
                'data' => $data
            ]
        );
    }
...
;
/* End of file Permitvalidevdp.php */
/* Location: ./application/controllers/Permitvalidevdp.php */
