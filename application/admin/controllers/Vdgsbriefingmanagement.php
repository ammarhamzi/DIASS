...
class Vdgsbriefingmanagement extends MY_Controller
{
    ...
    public function scheduler()
    {
        ...
        if ($this->permission->showlist == true) {
            ...
            $this->content = 'vdgsbriefingmanagement/vdgsbriefingmanagement_schedule';
            ##--slave_combine_to_list--##
            $this->layout($data, $setting);
...
//check if parentchild exist
    ...
    {
		if($date){
			$vdgsbriefingmanagement_date = $date;
		} else {
        ...
        if ($this->permission->cp_create == true) {
            ...
            $data = [
                ...
                'vdgsbriefingmanagement_date' => $vdgsbriefingmanagement_date,
...
exit;*/
        foreach ($row as $value) {
            ...
            $calendar[] = [
                ...
                "title" => $value->vdgsbriefingmanagement_slottaken."/".$value->vdgsbriefingmanagement_slot." Driver(s)",
