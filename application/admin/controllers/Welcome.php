...
class Welcome extends MY_Controller
{
    ...
    public function __construct()
    {
        ...
        // update all expired permit
        $this->permit_model->update_to_expired();
    }
    ...
    public function index()
    {
        ...
        if ($user_type == 1) {
            ...
            elseif($this->session->userdata('groupid')=="14"){
            //exam
               $this->content = 'foundation/dashboard/dashboard_examadmin';
