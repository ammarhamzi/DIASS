...
class Permitvalidvdgs extends MY_Controller
{

    public function __construct()
    {
        parent::__construct();
        $this->load->model('permitvalidvdgs_model');
        ...
        $this->lang->load('permitvalidvdgs_lang', $this->session->userdata('language'));
    ...
    public function index()
    {
        ...
        if ($this->permission->showlist == true) {
            ...
            $data = [
                ...
                'controller' => 'Permitvalidvdgs',
                'pagetitle' => 'Active FFOP (Visual Docking Guidance System) Permits',
            ];
    ...
    public function get_json($location='all')
    {
        ...
        $results = $this->permitvalidvdgs_model->listajax(
            $location,
            $columns,
           $columnfilter,
...
$r['permit_issuance_serialno'],
        ...
        echo json_encode(
            [
                ...
                "recordsTotal" => $this->permitvalidvdgs_model->recordsTotal($location)->recordstotal,
                "recordsFiltered" => $this->permitvalidvdgs_model->recordsTotal($location)->recordstotal,
                'data' => $data
            ]
        );
    }
...
;
/* End of file Permitvalidvdgs.php */
/* Location: ./application/controllers/Permitvalidvdgs.php */
