...
//check if parentchild exist
    ...
    public function get_availableslot($permittype)
    {
        $row = $this->inspectionmanagement_model->get_slot($permittype);
/*    var_dump($row);
exit;*/
        foreach ($row as $value) {
            ...
            $calendar[] = [
                ...
                "title" => $value->inspectionmanagement_slottaken."/".$value->inspectionmanagement_slot." Vehicle(s)",
