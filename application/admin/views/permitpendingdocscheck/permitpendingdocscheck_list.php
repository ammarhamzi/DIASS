...
<div class="container-fluid">
    <ol class="breadcrumb">
        ...
        <li class="active"><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span>
            <?php echo $this->lang->line('permitpendingdocscheck');?>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var table = $("#mytable").DataTable({
            "processing": true,
            "serverSide": true,
            "ajax": "<?php echo site_url() ?>/permitpendingdocscheck/get_json",
            responsive: true,
            dom: 'lfrBtip',
            buttons: [
/*                <?php
         ...
         ?> {
                    ...
                    action: function(e, dt, node, config) {
                        redirect("<?php echo site_url('permitpendingdocscheck/create');?>");
                    }
                },
                <?php }?>*/
                <?php
