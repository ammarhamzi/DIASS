...
<!--                                 <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                        ...
                        <form role="form" id="submitform" name="submitform" action="/admin/permitpendingdocscheck/evdp_submit/" method="POST">
                                <div class="box-body">
...
<?php echo ($permit_apply_remark?$permit_apply_remark:"<i>- No Remark -</i>");?>
                                ...
                                <div class="form-group">
                                    <label for="remark">Terminal Briefing Date <span style="font-size: small">(Change it if necessary)</span></label>
                                    <input id="activitydate" name="activitydate" class="form-control datepicker_local_insurancedate"  value="<?php echo datelocal($evdppermit_course_date);?>">
                                </div>
                                <div class="form-group">
