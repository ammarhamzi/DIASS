...
<!--                                 <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                        ...
                        <form role="form" id="submitform" name="submitform" action="/admin/permitpendingdocscheckvehicle/cs_submit/" method="POST">
                                <div class="box-body">
...
?>
                                <div class="form-group">
                                    ...
                                    <input id="activitydate" name="activitydate" class="form-control datepicker_local_insurancedate" value="<?php echo datelocal($cspermit_course_date);?>">
                                </div>
...
<input type="hidden" name="needescort" id="needescort" value="<?php echo $cspermit_needescort; ?>">
                    </div>
                    </form>
                </div>
</div>
