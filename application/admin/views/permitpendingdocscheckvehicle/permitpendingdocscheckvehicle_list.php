...
<div class="container-fluid">
    <ol class="breadcrumb">
        ...
        <li class="active"><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span>
            <?php echo $this->lang->line('permitpendingdocscheckvehicle');?>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var table = $("#mytable").DataTable({
            "processing": true,
            "serverSide": true,
            "ajax": "<?php echo site_url() ?>/permitpendingdocscheckvehicle/get_json",
            responsive: true,
            dom: 'lfrBtip',
            buttons: [
                <?php
         ...
         ?> {
                    ...
                    action: function(e, dt, node, config) {
                        redirect("<?php echo site_url('permitpendingdocscheckvehicle/create');?>");
                    }
                },
                <?php }?>
                <?php
