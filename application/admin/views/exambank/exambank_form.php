<div class="container-fluid">
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo site_url('exambank');?>"><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span> <?php echo $this->lang->line('exambank');?> <?php echo $this->lang->line('list');?></a></li>
    ...
    <div class="panel panel-info">
        <div class="panel-heading">
            <h4><span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
                <?php echo $this->lang->line('exambank');?>
                <?php echo $button ?>
            </h4>
        </div>
        <div class="panel-body">
            ...
            <?php echo $this->lang->line('exambank_title');?> <sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('exambank_title') ?>
          </label>
                            <div class="col-md-9"><input type="text" class="form-control" name="exambank_title" id="exambank_title" placeholder="<?php echo $this->lang->line('exambank_title');?>" value="<?php echo $exambank_title; ?>" maxlength="255" />
                            </div>
                        </div>

                        <div class="row">
                            <label class="col-md-3 text-right">
            <?php echo $this->lang->line('exambank_description');?> <?php echo form_error('exambank_description') ?>
          </label>
                            <div class="col-md-9"><textarea class="form-control" name="exambank_description" id="exambank_description" placeholder="<?php echo $this->lang->line('exambank_description');?>" rows="5" cols="50"><?php echo $exambank_description; ?></textarea>
                            </div>
                        </div>

                        <div class="row">
                            <div class="col-md-offset-3 col-md-9">
                                <input type="hidden" name="exambank_id" value="<?php echo (isset($id)?$id:" "); ?>" />
                                ...
                                <a href="<?php echo site_url('exambank') ?>" class="btn btn-default"><span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span> <?php echo $this->lang->line('back');?></a>
                            </div>
                        </div>
                    </form>
                </div>
