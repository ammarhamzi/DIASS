            ...
            <table id="mytable" class="table" style="width: 100% !important">
                ...
                <thead>
                    <tr>
                        <th class="no-sort">#</th>
                        <th>
                            <?php echo $this->lang->line('exambank_title');?>
                        </th>
                        <th>
                            <?php echo $this->lang->line('exambank_description');?>
                        </th>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var table = $("#mytable").DataTable({
            "processing": true,
            "serverSide": true,
            "ajax": "<?php echo site_url() ?>/exambank/get_json",
            responsive: true,
            dom: 'lfrBtip',
            buttons: [
                <?php
         ...
         ?> {
                    ...
                    action: function(e, dt, node, config) {
                        redirect("<?php echo site_url('exambank/create');?>");
                    }
                },
                <?php }?>
                <?php
