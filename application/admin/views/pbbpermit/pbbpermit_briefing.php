...
Update Assessment Status
    ...
    <div class="box  box-primary">
        <div class="box-header with-border">
            ...
            <h3 class="box-title">Check Assessment (Passenger Boarding Bridge) - <?php echo datelocal($course_date);?></h3>
        ...
        <div class="box-body">
                        ...
                        <table id="mytable" class="table" style="width: 100% !important">
                            ...
                            <thead>
                                <tr>
                                    <th class="no-sort">Assessment Status</th>
                                    <th>
...
if($pbbbriefing){
$i=0;
foreach ($pbbbriefing as $value) {
$trainer = $value->pbbpermit_certbytrainer;
$briefingdate = $value->pbbpermit_certbytrainer_date;
/*$permit_id = $value->pbbpermit_permit_id;*/
/*print_r($value);*/
?>
                                    <tr>
                                        <td>
                                            <input type="radio" name="pbbpermit_<?php echo $value->pbbpermit_id;?>"  value="<?php echo $value->pbbpermit_id;?>|<?php echo $value->pbbpermit_permit_id;?>|y" <?php echo ($value->pbbpermit_attendpbbbriefing=="y"?"checked":"");?> <?php echo (empty($value->pbbpermit_completed_docs)?"disabled":"");?>
                                            /> <span style="color: #00CC00">PASSED</span>
                                            <br>
                                            <input type="radio" name="pbbpermit_<?php echo $value->pbbpermit_id;?>" value="<?php echo $value->pbbpermit_id;?>|<?php echo $value->pbbpermit_permit_id;?>|n" <?php echo ($value->pbbpermit_attendpbbbriefing=="n"?"checked":"");?> <?php echo (empty($value->pbbpermit_completed_docs)?"disabled":"");?>
                                            /> <span style="color: #CC0000">FAILED</span>
                                        <input id="pbbpermit_id" type="hidden" name="pbbpermit_id[]" value="<?php echo $value->pbbpermit_id;?>">
                                        </td>
                                        <td>
                                    ...
                                    <th>
                                        <?php echo (empty($value->pbbpermit_completed_docs)?'<span style="color: #CC0000">Not Approved By MAHB</span>':'Approved');?>
                                    </th>
                                    </tr>
                                    <?php
}
...
<tr>
    ...
    <td><input type="text" name="pbbpermit_certbytrainer" id="pbbpermit_certbytrainer" value="<?php echo $trainer;?>"></td>
</tr>
<tr>
    <th width="20%">Briefing Date:</th>
    <td><input type="text" name="pbbpermit_certbytrainer_date" id="pbbpermit_certbytrainer_date" class="datepicker" value="<?php echo $briefingdate;?>"></td>
</tr>
</table>
                        <div class="row">
