    ...
    ?>
                    <div class="box  box-primary">
                        <div class="box-header with-border">
                                    ...
                                    <h3 class="box-title">Assessment Attendance (Passenger Boarding Brigde)</h3>
    ...
    $(document).ready(function() {
        $(function() {
            ...
            $('#calendar').fullCalendar({
                ...
                defaultView: 'month',
                events: {
                    url: '/admin/Ffpbbbriefingmanagement/get_availableslot',
                    type: 'POST',
                    data: {},
                    error: function() {
                ...
                eventClick: function(calEvent, jsEvent, view) {
                    ...
                    //} else {
$(location).attr('href', "/admin/pbbpermit/assessment_status/"+moment(calEvent.start).format('YYYY-MM-DD'));
                    //}
                }
            })
        });
