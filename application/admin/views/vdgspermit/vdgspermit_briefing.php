...
Update Attendance
    ...
    <div class="box  box-primary">
        <div class="box-header with-border">
            ...
            <h3 class="box-title">Check Attendance (Visual Docking Guidance System) - <?php echo datelocal($course_date);?></h3>
...
if($vdgsbriefing){
$i=0;
foreach ($vdgsbriefing as $value) {
$trainer = $value->vdgspermit_certbytrainer;
$briefingdate = $value->vdgspermit_certbytrainer_date;
/*$permit_id = $value->vdgspermit_permit_id;*/
/*print_r($value);*/
?>
                                    <tr>
                                        <td>
                                        ...
                                        <td><!-- <input type="checkbox" name="vdgspermit_id[]" id="vdgspermit_id" value="<?php echo $value->vdgspermit_id; ?>|<?php echo $value->vdgspermit_permit_id; ?>" <?php echo ($value->vdgspermit_attendvgdsbriefing == "y" ? "checked" : ""); ?> <?php echo (empty($value->vdgspermit_completed_docs) ? "disabled" : ""); ?>
                                                           /> -->
                                            <?php 
                                            /*$todayDate = date('Y-m-d');
                                            if(datelocal($course_date) >= datelocal($todayDate))
                                            {
                                            echo '<input type="checkbox" name="vdgspermit_id[]" id="vdgspermit_id" value="<?php echo $value->vdgspermit_id;?>|<?php echo $value->vdgspermit_permit_id;?>" ';
                                            echo ($value->vdgspermit_attendvgdsbriefing=="y"?"checked":"");
                                            echo (empty($value->vdgspermit_completed_docs)?"disabled":"");
                                            echo ' />';
                                             }
                                             else{
                                                 echo '<input type="checkbox" name="vdgspermit_id[]" id="vdgspermit_id" value="<?php echo $value->vdgspermit_id;?>|<?php echo $value->vdgspermit_permit_id;?>" ';
                                            ...
                                            {
                                            echo '<input type="checkbox" name="vdgspermit_id[]" id="vdgspermit_id" value="'.$value->vdgspermit_id.'|'.$value->vdgspermit_permit_id.'" ';
                                            echo ($value->vdgspermit_attendvgdsbriefing=="y"?"checked":"");
                                            echo (empty($value->vdgspermit_completed_docs)?"disabled":"");
                                            echo ' />';
                                             }
                                        ...
                                        <td>
                                            ...
                                            <?php echo $value->driver_name.$value->vdgspermit_attendvgdsbriefing;?>
                                        </td>
                                        <td>
                                    ...
                                    <th>
                                        <?php echo (empty($value->vdgspermit_completed_docs)?'<span style="color: #CC0000">Not Approved By MAHB</span>':'Approved');?>
                                    </th>
                                    </tr>
                                    <?php
}
...
<tr>
    ...
    <td><input type="text" name="vdgspermit_certbytrainer" id="vdgspermit_certbytrainer" value="<?php echo $trainer;?>"></td>
</tr>
<tr>
    <th width="20%">Briefing Date:</th>
    <td><input type="text" name="vdgspermit_certbytrainer_date" id="vdgspermit_certbytrainer_date" class="datepicker" value="<?php echo $briefingdate;?>"></td>
</tr>
</table>
                        <div class="row">
...
<!--<input type="hidden" name="permit_id" id="permit_id" value="<?php echo $permit_id;?>">-->
            ...
            <?php 
                                ...
                                <button type="button" onclick="tableToExcel('exporttoexcel', 'VDGS Briefing')" class="btn btn-primary noprint" id="buttonExcel"><span class="glyphicon glyphicon-print" aria-hidden="true"></span> Excel</button>
