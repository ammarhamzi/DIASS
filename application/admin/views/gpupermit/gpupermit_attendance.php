    ...
    ?>
                    <div class="box  box-primary">
                        <div class="box-header with-border">
                                    ...
                                    <h3 class="box-title">Briefing Attendance (Ground Power Unit)</h3>
...
$(location).attr('href', "/admin/gpupermit/briefingattend/"+moment(calEvent.start).format('YYYY-MM-DD'));
                    }
                }
            })
        });
