...
<div class="container-fluid">
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo site_url('logging'); ?>"><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span> logging <?php echo $this->lang->line('list'); ?></a></li>
    ...
    <div class="panel panel-info">
        <div class="panel-heading">
            <h4><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> logging <?php echo $button; ?></h4>
        </div>
            ...
            <form action="<?php echo $action; ?>" method="post">
                ...
                <div class="row">
                    <label class="col-md-1">
                        <?php echo $this->lang->line('user_id'); ?> <sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('user_id'); ?>
                    </label>

                    <div class="col-md-11"><select class="form-control select2" name="user_id" id="user_id">
                            <option value="">-SELECT-</option>
                            <?php
foreach ($user as $value) {
    ?>
                                <option value="<?php echo $value->user_id; ?>" <?php echo ($value->user_id
        === $user_id ? 'selected="selected"' : "");
...
?>
                ...
                <div class="row">
                    <label class="col-md-1">
<?php echo $this->lang->line('string_query'); ?> <sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('string_query'); ?>
                    </label>
                    <div class="col-md-11"><textarea class="form-control" name="string_query" id="string_query" placeholder="<?php echo $this->lang->line('string_query'); ?>" rows="5" cols="50"><?php echo $string_query; ?></textarea>
                                 </div></div>

                <div class="row">
                    <label class="col-md-1">
<?php echo $this->lang->line('query_type'); ?> <sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('query_type'); ?>
                    </label>
                    <div class="col-md-11"><input type="text" class="form-control" name="query_type" id="query_type" placeholder="<?php echo $this->lang->line('query_type'); ?>"value="<?php echo $query_type; ?>" maxlength="10" />
                                 </div></div>

                <div class="row">
                    <label class="col-md-1">
<?php echo $this->lang->line('datetime_query'); ?> <sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('datetime_query'); ?>
                    </label>
                    <div class="col-md-11"><input type="text" class="form-control datetimepicker" name="datetime_query" id="datetime_query" placeholder="<?php echo $this->lang->line('datetime_query'); ?>" value="<?php echo $datetime_query; ?>" />
                                 </div></div>

                <div class="row">
                    <label class="col-md-1">
<?php echo $this->lang->line('executetime'); ?> <sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('executetime'); ?>
                    </label>
                    <div class="col-md-11"><input type="text" class="form-control isCurrency" name="executetime" id="executetime" placeholder="<?php echo $this->lang->line('executetime'); ?>" value="<?php echo $executetime; ?>" />
                                 </div></div>
...
if (isset($id)) {
    ...
    $(document).ready(function ()
      {
        var arr =['user_id', 'string_query', 'query_type', 'datetime_query', 'executetime'];
