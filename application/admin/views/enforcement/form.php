                    ...
                    <form action="<?php echo $action; ?>" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                ...
                                <div class="row">
                                    <label class="col-md-3 text-right">
                                        <?php echo 'Flight / Aircraft Number';//$this->lang->line('user_username'); ?> <sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('flight_number'); ?>
                                    </label>
                                    <div class="col-md-9"><input type="text" class="form-control" name="flight_number" id="flight_number" placeholder="<?php echo 'Flight / Aircraft Number';//$this->lang->line('user_username'); ?>"value="<?php echo $flight_number; ?>" required="50" />         
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <label class="col-md-3 text-right">
                                        <?php echo 'Notes';//$this->lang->line('user_username'); ?> <sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('notes'); ?>
                                    </label>
                                    <div class="col-md-9">
                                        <textarea class="form-control" name="notes" id="notes" required="" rows="4"><?php echo $notes; ?></textarea>      
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <label class="radio-inline"><input type="radio" name="approval_choice" value="0" checked><strong>Pending</strong></label>
                                        <label class="radio-inline"><input type="radio" name="approval_choice" value="1"><strong>Approve</strong></label>
                                        <label class="radio-inline"><input type="radio" name="approval_choice" value="2"><strong>Reject</strong></label>
                                    </div>
                                </div>
                                <br />
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Remarks <?php echo form_error('remarks_approval'); ?></label>
                                            <textarea class="form-control" name="remarks_approval" id="remarks_approval"><?=$remarks_approval?></textarea>
                                        </div>
                                    </div>
                                </div>                                
                                <?php */ ?>
                            ...
                            <div class="col-md-5">
                                ...
                                <div class="row">
                                    <label class="col-md-4 text-right">
                                        <?php echo 'Requestor';//$this->lang->line('user_username'); ?> <sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('requestor_txt'); ?>
                                    </label>
                                    <div class="col-md-8">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <select class="form-control select2" name="pic_id" id="pic_id">
                                                ...
                                                {
                                                    ?>
                                                    <option value="<?php echo $value->user_id; ?>" <?php echo (($value->user_id == $pic_id) ? 'selected="selected"' : "");?>><?php echo $value->user_name; ?></option>
                                                    <?php
                                                }
                                                ?>
                                            </select>  
                                    ...
                                    <div class="row">
                                        <label class="col-md-4 text-right">
                                            <?php echo 'Address';//$this->lang->line('user_username'); ?>  <?php echo form_error('pic_address'); ?>
                                        </label>
                                    ...
                                    <div class="row">
                                        <label class="col-md-4 text-right">
                                            <?php echo 'Phone No';//$this->lang->line('user_username'); ?>  <?php echo form_error('pic_phoneNo'); ?>
                                        </label>
                                    ...
                                    <div class="row">
                                        <label class="col-md-4 text-right">
                                            <?php echo 'Email';//$this->lang->line('user_username'); ?>  <?php echo form_error('pic_email'); ?>
                                        </label>
...
<script>
    $(document).ready(function ()
    {
        ...
        $('.content_exam_set_participant').on('change','.upload_p',function(){
            var exam_set_ids = $(this).attr('exam_set_ids');
            $('#upload_p_'+exam_set_ids).hide('200',function(){

                var this_file_path = this.value,
                    proceed_to_upload = 1;

                if(proceed_to_upload == 1)
                {
                    var formData = new FormData();
                    // formData.append('upload_p', $('#upload_p_'+exam_set_ids)[0].files[0]);

                    $.ajax({
                       url : "<?=site_url('td_con/upload_file_ajax/upload_participant?exam_set_ids="+exam_set_ids+"')?>",
                       type : 'POST',
                       data : formData,
