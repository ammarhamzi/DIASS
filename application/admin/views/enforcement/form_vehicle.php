                        ...
                        <div class="col-sm-9">
                            <select class="form-control select2" name="addOffence_type" id="addOffence_type" style="width: 100% !important;" >
                                ...
                                ?>
                                    <optgroup label="<?=$parent_arr['type']?>">
                                        ...
                                        {
                                            // Format suspension period display (use AVP for vehicles, handle both numeric days and text-based periods)
                                            $period_display = '';
                                            if (isset($roffence_type->avp_suspension_text)) {
                                                // 2025 catalogue with AVP text
                                                $period_display = $roffence_type->avp_suspension_text;
                            ...
                            <div class="help-block" style="margin-top: 10px;">
                                <div class="span_description_offence" style="padding: 10px; background-color: #f5f5f5; border-left: 3px solid #3c8dbc; display: none;">
                                    ...
                                    <strong>AVP Suspension:</strong> <span class="offence-suspension"></span><br/>
