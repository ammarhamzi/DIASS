...
<div class="container-fluid">
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo site_url('permitpendingapproval'); ?>"><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span> <?php echo $this->lang->line('permitpendingapproval'); ?> <?php echo $this->lang->line('list'); ?></a></li>
        <li class="active"><span class="glyphicon glyphicon-file" aria-hidden="true"></span>
            <?php echo $this->lang->line('permitpendingapproval'); ?>
...
?>
                        ...
                        <!--                        <table class="table table-condensed table-responsive">
                            ...
                            <tr>
                                <th class="col-md-3 text-right">
                                    <?php echo $this->lang->line('driver_permit_groupid'); ?>
                                </th>
                                <td class="col-md-9">
                                    <?php echo $driver_permit_groupid; ?>
                                </td>
                            </tr>

                            <tr>
                                <th class="col-md-3 text-right">
                                    <?php echo $this->lang->line('driver_permit_statusid'); ?>
                                </th>
                                <td class="col-md-9">
                                    <?php echo $driver_permit_statusid; ?>
                                </td>
                            </tr>
                    ...
                    <div role="tabpanel" class="tab-pane" id="inspectionresult">
                        <div class="row">
                            <div class="col-md-6">
                                <h3>Inspection :
                                    <?php
                                     if($wippermit_result == 'y'){
                                     echo '<span style="color:green">PASS</span>';
                                     }elseif($wippermit_result == 'n'){
...
?></h3>
                                <div class="row">
                                    <div class="col-md-6">
                                        <p>Inspection Date: <b><?php echo $wippermit_inspection_date; ?></b> </p>
                                    </div>
                                    <div class="col-md-6">
                                        <p>Inspection By:<b><?php echo $wippermit_result_inspector_id; ?></b> </p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    <?php
$i         = 0;
$countloop = count($wipchecklist_data);
                                        ...
                                        <table id="mytable" class="table" style="width: 100% !important">
                                            ...
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>
                                                        <?php echo $this->lang->line('wipchecklist_name'); ?>
                                                    </th>
                                                    <th>
                                                        <?php echo $this->lang->line('wipchecklist_desc'); ?>
                                                    </th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php echo $wipchecklist->wipchecklist_name; ?>
                                                    </td>
                                                    <td>
                                                        <?php echo $wipchecklist->wipchecklist_desc; ?>
                                                    </td>
                                                    ...
                                                    <td style="text-align:center; white-space: nowrap;">
                                                        <div class="btn-group" role="group" aria-label="...">
                                                            ...
                                                            <?php
echo '<input type="checkbox" ' . ($wipchecklist->wipchecklist_checked == "y" ? "checked" : "") . ' disabled>';
        ?>
                                                        </div>
                                                    </td>
                                                    <td style="text-align:center; white-space: nowrap;">
                                                        <div class="btn-group" role="group" aria-label="...">
                                                            ...
                                                            <?php
echo '<input type="checkbox" ' . ($wipchecklist->wipchecklist_mtwchecked == "y" ? "checked" : "") . ' disabled>';
        ?>
                                                        </div>
                                                    </td>
                                                </tr>
...
?>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <form id="submitform" name="submitform" action="/permitpendingapproval/adp_submit/" method="POST">
                            <div class="row">
                                <h3>Your Action</h3>
...
if($permit_officialstatus!='COMPLETED'){
?>
    <a href="/permitpendingapproval/cancellation/<?php echo $permit_id;?>" class="btn btn-warning">Cancellation</a>
<?php
}
?>
