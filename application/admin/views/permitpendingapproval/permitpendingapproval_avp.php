                    ...
                    <div role="tabpanel" class="tab-pane" id="inspectionresult">
                        <div class="row">
                            <div class="col-md-6">
                                <h3>Inspection :
                                    <?php
                                     if($avppermit_result == 'y'){
                                     echo '<span style="color:green">PASS</span>';
                                     }elseif($avppermit_result == 'n'){
...
?></h3>
                                <div class="row">
                                    <div class="col-md-6">
                                        <p>Inspection Date: <b><?php echo $avppermit_inspection_date; ?></b> </p>
                                    </div>
                                    <div class="col-md-6">
                                        <p>Inspection By:<b><?php echo $avppermit_result_inspector_id; ?></b> </p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    <?php
$i         = 0;
$countloop = count($avpchecklist_data);
                                        ...
                                        <table id="mytable" class="table" style="width: 100% !important">
                                            ...
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>
                                                        <?php echo $this->lang->line('avpchecklist_name'); ?>
                                                    </th>
                                                    <th>
                                                        <?php echo $this->lang->line('avpchecklist_desc'); ?>
                                                    </th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php echo $avpchecklist->avpchecklist_name; ?>
                                                    </td>
                                                    <td>
                                                        <?php echo $avpchecklist->avpchecklist_desc; ?>
                                                    </td>
                                                    ...
                                                    <td style="text-align:center; white-space: nowrap;">
                                                        <div class="btn-group" role="group" aria-label="...">
                                                            ...
                                                            <?php
echo '<input type="checkbox" ' . ($avpchecklist->avpchecklist_checked == "y" ? "checked" : "") . ' disabled>';
        ?>
                                                        </div>
                                                    </td>
                                                    <td style="text-align:center; white-space: nowrap;">
                                                        <div class="btn-group" role="group" aria-label="...">
                                                            ...
                                                            <?php
echo '<input type="checkbox" ' . ($avpchecklist->avpchecklist_mtwchecked == "y" ? "checked" : "") . ' disabled>';
        ?>
                                                        </div>
                                                    </td>
                                                </tr>
