...
<ol class="breadcrumb">
  ...
  <li><a href="<?php echo site_url('parkingarea');?>"><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span> <?php echo $this->lang->line('parkingarea');?> <?php echo $this->lang->line('list');?></a></li>
...
<h4><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> <?php echo $this->lang->line('parkingarea');?> <?php echo $button ?></h4>
  </div>
...
<div class="row">
          <label class="col-md-3 text-right">
            <?php echo $this->lang->line('parkingarea_name');?> <sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('parkingarea_name') ?>
          </label>
<div class="col-md-9"><input type="text" class="form-control" name="parkingarea_name" id="parkingarea_name" placeholder="<?php echo $this->lang->line('parkingarea_name');?>"value="<?php echo $parkingarea_name; ?>" maxlength="255" />
         </div></div>


<div class="row">
          <label class="col-md-3 text-right">
            <?php echo $this->lang->line('parkingarea_desc');?> <?php echo form_error('parkingarea_desc') ?>
          </label><div class="col-md-9"><textarea class="form-control" name="parkingarea_desc" id="parkingarea_desc" placeholder="<?php echo $this->lang->line('parkingarea_desc');?>" rows="5" cols="50"><?php echo $parkingarea_desc; ?></textarea>
         </div></div>


<div class="row">
          <label class="col-md-3 text-right">
            <?php echo $this->lang->line('parkingarea_maps');?> <?php echo form_error('parkingarea_maps') ?>
          </label><div class="col-md-9"><input type="text" class="form-control" name="parkingarea_maps" id="parkingarea_maps" placeholder="<?php echo $this->lang->line('parkingarea_maps');?>"value="<?php echo $parkingarea_maps; ?>" maxlength="255" />
         </div></div>
         
<div class="row">
<div class="col-md-offset-3 col-md-9">
         <input type="hidden" name="parkingarea_id" value="<?php echo (isset($id)?$id:""); ?>" />
         ...
         <a href="<?php echo site_url('parkingarea') ?>" class="btn btn-default"><span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span> <?php echo $this->lang->line('back');?></a>
    </div>
</div>
      </form>
      </div>
