            ...
            <table id="mytable" class="table table-bordered table-hover" style="width: 100% !important">
                ...
                <thead>
                    <tr>
                        <th class="no-sort">#</th>
                        <th>
                            <?php echo $this->lang->line('examquestion_question');?>
                        </th>
                        <th>
                            <?php echo $this->lang->line('examquestion_compulsory');?>
                        </th>
                        <th>
                            <?php echo $this->lang->line('examquestion_category');?>
                        </th>
                        <th style="width:112px;" class="no-sort">&nbsp;</th>
                    </tr>
                </thead>
                <tfoot>
                    <tr>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var table = $("#mytable").DataTable({
            "processing": true,
            "serverSide": true,
            "ajax": "<?php echo site_url() ?>/examquestion/get_json",
            responsive: true,
            dom: 'lfrBtip',
            buttons: [
                <?php
                ...
                ?> {
                    ...
                    action: function(e, dt, node, config) {
                        redirect("<?php echo site_url('examquestion/create');?>");
                    }
                },
                <?php }?>
                <?php
