...
<h4><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> <?php echo $this->lang->line('enginetype');?> <?php echo $button ?></h4>
  </div>
...
<div class="row">
          <label class="col-md-3 text-right">
            <?php echo $this->lang->line('enginetype_name');?> <sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('enginetype_name') ?>
          </label>
<div class="col-md-9"><input type="text" class="form-control" name="enginetype_name" id="enginetype_name" placeholder="<?php echo $this->lang->line('enginetype_name');?>"value="<?php echo $enginetype_name; ?>" maxlength="255" />
         </div></div>


<div class="row">
          <label class="col-md-3 text-right">
            <?php echo $this->lang->line('enginetype_desc');?> <?php echo form_error('enginetype_desc') ?>
          </label><div class="col-md-9"><textarea class="form-control" name="enginetype_desc" id="enginetype_desc" placeholder="<?php echo $this->lang->line('enginetype_desc');?>" rows="5" cols="50"><?php echo $enginetype_desc; ?></textarea>
         </div></div>


<div class="row">
          <label class="col-md-3 text-right">
            <?php echo $this->lang->line('enginetype_cc');?> <?php echo form_error('enginetype_cc') ?>
          </label><div class="col-md-9"><input type="text" class="form-control" name="enginetype_cc" id="enginetype_cc" placeholder="<?php echo $this->lang->line('enginetype_cc');?>"value="<?php echo $enginetype_cc; ?>" maxlength="10" />
         </div></div>
         
<div class="row">
<div class="col-md-offset-3 col-md-9">
         <input type="hidden" name="enginetype_id" value="<?php echo (isset($id)?$id:""); ?>" />
         ...
         <a href="<?php echo site_url('enginetype') ?>" class="btn btn-default"><span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span> <?php echo $this->lang->line('back');?></a>
    </div>
</div>
      </form>
      </div>
