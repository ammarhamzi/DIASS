  ...
  <li class="active"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> <?php echo $this->lang->line('form');?> <?php echo $button ?></li>
                    ...
                    <div class="box  box-primary">
                        <div class="box-header with-border">
                                    ...
                                    <h3 class="box-title"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span>  <?php echo $button ?> <?php echo $this->lang->line('avpevpinspectionmanagement');?></h3>
...
<div class="row">
          <label class="col-md-3 text-right">
            <?php echo $this->lang->line('avpevpinspectionmanagement_date');?> <sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('avpevpinspectionmanagement_date') ?>
          </label>
<div class="col-md-9"><input type="text" class="form-control datepicker" name="avpevpinspectionmanagement_date" id="avpevpinspectionmanagement_date" placeholder="<?php echo $this->lang->line('avpevpinspectionmanagement_date');?>" value="<?php echo $avpevpinspectionmanagement_date; ?>" />
         </div></div>

<div class="row">
          <label class="col-md-3 text-right">
            <?php echo $this->lang->line('avpevpinspectionmanagement_slot');?> <sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('avpevpinspectionmanagement_slot') ?>
          </label>
<div class="col-md-9"><input type="text" class="form-control isInteger" name="avpevpinspectionmanagement_slot" id="avpevpinspectionmanagement_slot" placeholder="<?php echo $this->lang->line('avpevpinspectionmanagement_slot');?>" value="<?php echo $avpevpinspectionmanagement_slot; ?>" maxlength="10" />
         </div></div>


<div class="row">
          <label class="col-md-3 text-right">
            <?php echo $this->lang->line('avpevpinspectionmanagement_remark');?> <?php echo form_error('avpevpinspectionmanagement_remark') ?>
          </label><div class="col-md-9"><input type="text" class="form-control" name="avpevpinspectionmanagement_remark" id="avpevpinspectionmanagement_remark" placeholder="<?php echo $this->lang->line('avpevpinspectionmanagement_remark');?>"value="<?php echo $avpevpinspectionmanagement_remark; ?>" maxlength="500" />
         </div></div>
         
<div class="row">
<div class="col-md-offset-3 col-md-9">
         <input type="hidden" name="avpevpinspectionmanagement_id" value="<?php echo (isset($id)?$id:""); ?>" />
         ...
         <a href="<?php echo site_url('avpevpinspectionmanagement') ?>" class="btn btn-default"><span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span> <?php echo $this->lang->line('back');?></a>
    </div>
</div>
      </form>
      </div>
