...
Update Attendance
    ...
    <div class="box  box-primary">
        <div class="box-header with-border">
            ...
            <h3 class="box-title">Check Attendance (Stakeholder) - <?php echo datelocal($course_date);?></h3>
...
if($shbriefing){
$i=0;
foreach ($shbriefing as $value) {
$trainer = $value->shpermit_certbytrainer;
$briefingdate = $value->shpermit_certbytrainer_date;
/*$permit_id = $value->shpermit_permit_id;*/
/*print_r($value);*/
?>
                                    <tr>
                                        <td>
                                        ...
                                        <td><input type="checkbox" name="shpermit_id[]" id="shpermit_id" value="<?php echo $value->shpermit_id;?>|<?php echo $value->shpermit_permit_id;?>" <?php echo ($value->shpermit_attendshbriefing=="y"?"checked":"");?> <?php echo (empty($value->shpermit_completed_docs)?"disabled":"");?>
                                            />
...
<!--                                        <td>
                                    ...
                                    <th>
                                        <?php echo (empty($value->shpermit_completed_docs)?'<span style="color: #CC0000">Not Approved By MAHB</span>':'Approved');?>
                                    </th>
                                    </tr>
                                    <?php
}
...
<tr>
    ...
    <td><input type="text" name="shpermit_certbytrainer" id="shpermit_certbytrainer" value="<?php echo $trainer;?>"></td>
</tr>
<tr>
    <th width="20%">Briefing Date:</th>
    <td><input type="text" name="shpermit_certbytrainer_date" id="shpermit_certbytrainer_date" class="datepicker" value="<?php echo $briefingdate;?>"></td>
</tr>
</table>
                        <div class="row">
