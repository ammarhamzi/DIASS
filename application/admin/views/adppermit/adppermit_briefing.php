...
<script type="text/javascript" src="/resources/shared_js/exportHtml/tableExport.js"></script>
<script type="text/javascript" src="/resources/shared_js/exportHtml/jquery.base64.js"></script>
<script type="text/javascript" src="/resources/shared_js/exportHtml/html2canvas.js"></script>
<script type="text/javascript" src="/resources/shared_js/exportHtml/jspdf/libs/sprintf.js"></script>
<script type="text/javascript" src="/resources/shared_js/exportHtml/jspdf/jspdf.js"></script>
<script type="text/javascript" src="/resources/shared_js/exportHtml/jspdf/libs/base64.js"></script>
<div class="container-fluid" id="exportmetoexcel">
    <ol class="breadcrumb">
...
Update Attendance
    ...
    <div class="box  box-primary">
        <div class="box-header with-border">
            ...
            <h3 class="box-title">Check Attendance (ADP) - Date:<?php echo $course_date;?>, Location:<?php echo $course_location;?>, Category:<?php echo $course_category;?></h3>
...
if($adpbriefing){
$i=0;
foreach ($adpbriefing as $value) {
$trainer = $value->adppermit_certbytrainer;
$briefingdate = $value->adppermit_certbytrainer_date;
/*$permit_id = $value->adppermit_permit_id;*/
/*print_r($value);*/
?>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <!--<input type="checkbox" name="adppermit_id[]" id="adppermit_id" value="<?php echo $value->adppermit_id;?>|<?php echo $value->adppermit_permit_id;?>" <?php echo ($value->adppermit_attendbriefing=="y"?"checked":"");?> <?php echo (empty($value->adppermit_completed_docs)?"disabled":"");?>
                                            />-->
                                            <?php 
                                            $todayDate = date('Y-m-d');
                                            if(datelocal($course_date) >= datelocal($todayDate))
                                            {
                                            /*echo '<input type="checkbox" name="evdppermit_id[]" id="evdppermit_id" value="<?php echo $value->evdppermit_id;?>|<?php echo $value->adppermit_permit_id;?> <?php echo ($value->evdppermit_attendterminalbriefing=="y"?"checked":"");?> <?php echo (empty($value->evdppermit_completed_docs)?"disabled":"");?> />';
                                            */
                                                //if(empty($value->adppermit_attendbriefing))
                                                //{
                                            echo '<input type="checkbox" name="adppermit_id[]" id="adppermit_id" value="'.$value->adppermit_id.'|'.$value->permit_id.'" ';
                                            echo ($value->adppermit_attendbriefing=="y"?"checked":"");
                                            echo (empty($value->adppermit_completed_docs)?"disabled":"");
                                            echo ' />';
                                                /*}
                                                else
                                                {
                                                    echo '<input type="checkbox" name="adppermit_id[]" id="adppermit_id" value="<?php echo $value->adppermit_id;?>|<?php echo $value->adppermit_permit_id;?>" ';
                                                echo (" disabled ");
                                                echo ' />';
                                                }*/
                                             }
                                    ...
                                    <th>
                                        <?php echo (empty($value->adppermit_completed_docs)?'<span style="color: #CC0000">Not Approved By MAHB</span>':'Approved');?>
                                    </th>
                                    </tr>
                                    <?php
}
...
<tr>
    ...
    <td><input type="text" name="adppermit_certbytrainer" id="adppermit_certbytrainer" value="<?php echo $trainer;?>"></td>
</tr>
<tr>
    <th width="20%">Briefing Date:</th>
    <td><input type="text" name="adppermit_certbytrainer_date" id="adppermit_certbytrainer_date" class="datepicker" value="<?php echo $briefingdate;?>"></td>
</tr>
</table>
                        <div class="row">
...
<!--<input type="hidden" name="permit_id" id="permit_id" value="<?php echo $permit_id;?>">-->
            ...
            <?php 
                                ...
                                <button type="button" onclick="tableToExcel('exporttoexcel', 'ADP Briefing')" class="btn btn-primary noprint" id="buttonExcel"><span class="glyphicon glyphicon-print" aria-hidden="true"></span> Excel</button>
