...
Update Attendance
    ...
    <div class="box  box-primary">
        <div class="box-header with-border">
            ...
            <h3 class="box-title">Exam Attendance (ADP) - Date:<?php echo $course_date;?>, Location:<?php echo $course_location;?>, Category:<?php echo $course_category;?></h3>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            */ 
                                            ...
                                            {
                                                //if(!empty($value->adppermit_completed_docs))
                                                //{
...
<!--<input type="hidden" name="permit_id" id="permit_id" value="<?php echo $permit_id;?>">-->
            ...
            <?php 
                                ...
                                <button type="button" onclick="tableToExcel('exporttoexcel', 'ADP Exam')" class="btn btn-primary noprint" id="buttonExcel"><span class="glyphicon glyphicon-print" aria-hidden="true"></span> Excel</button>
