...
Update Attendance
    ...
    <div class="box  box-primary">
        <div class="box-header with-border">
            ...
            <h3 class="box-title">Check Attendance (ADP) - <?php echo datelocal($course_date);?></h3>
...
?>
                                    <tr>
                                        ...
                                        <td><input type="checkbox" name="adppermit_id[]" id="adppermit_id" value="<?php echo $value->adppermit_id;?>|<?php echo $value->adppermit_permit_id;?>" <?php echo ($value->adppermit_attendbriefing=="y"?"checked":"");?> <?php echo (empty($value->adppermit_completed_docs)?"disabled":"");?>
                                            />
                                            <?php echo $value->driver_name.$value->adppermit_attendbriefing;?>
                                        </td>
                                        <td>
