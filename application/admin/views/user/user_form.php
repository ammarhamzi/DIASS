...
<div class="form-group">
    <label for="user_username">Email/Username <sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('user_username'); ?></label>
<input type="text" class="form-control" name="user_username" id="user_username" placeholder="Email/Username" value="<?php echo $user_username; ?>" maxlength="50" />
</div>
...
?>
<div class="form-group">
    <label for="user_password"><?php echo $this->lang->line('user_password'); ?> </label>
<input type="text" class="form-control" name="user_password" id="user_password" placeholder="Left empty if password is unchanged" value="" maxlength="250" />
</div>
<?php
}
?>
...
<div class="form-group">
    <label for="user_groupid"><?php echo $this->lang->line('user_groupid'); ?> <sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('user_groupid'); ?></label>
    <select class="form-control select2" name="user_groupid[]" id="user_groupid">
...
if ($user_photo) {
    ?>
                                <p><img src="/resources/shared_img/<?php echo ($user_photo
...
; ?>" readonly>
                        ...
                        <div class="uploadrestrict">(supported png,jpg,jpeg)</div>
</div>
    </div>
</div>
    ...
    jQuery(document).ready(function($) {
        var options = {
            beforeSend: function() {
                ...
                $(".upload-image-messages").html('<p><img src = "/resources/shared_img/system/ajax-loader.gif" class = "loader" /></p>');
            },
            complete: function(response) {
                ...
                if (arr[1] == "success") {
                    ...
                    $(".upload-image-messages").html('<p><img src = "/resources/shared_img/' + arr[0] + '" width="100" height="100" /></p>');
                } else {
