            ...
            <?php echo $this->lang->line('permit_created_at');?> <sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('permit_created_at') ?>
                        ...
                        <div class="row">
                            <div class="col-md-offset-3 col-md-9">
                                ...
                                <a href="<?php echo site_url('permitpendingreplacement') ?>" class="btn btn-default"><span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span> <?php echo $this->lang->line('back');?></a>
                            </div>
                        </div>
                    </form>
                </div>
