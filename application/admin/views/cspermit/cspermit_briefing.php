...
Update Attendance
    ...
    <div class="box  box-primary">
        <div class="box-header with-border">
            ...
            <h3 class="box-title">Check Attendance (Commercial Supplier) - <?php echo datelocal($course_date);?></h3>
...
if($csbriefing){
$i=0;
foreach ($csbriefing as $value) {
$trainer = $value->cspermit_certbytrainer;
$briefingdate = $value->cspermit_certbytrainer_date;
/*$permit_id = $value->cspermit_permit_id;*/
/*print_r($value);*/
?>
                                    <tr>
                                        <td>
                                        ...
                                        <td><input type="checkbox" name="cspermit_id[]" id="cspermit_id" value="<?php echo $value->cspermit_id;?>|<?php echo $value->cspermit_permit_id;?>" <?php echo ($value->cspermit_attendcsbriefing=="y"?"checked":"");?> <?php echo (empty($value->cspermit_completed_docs)?"disabled":"");?>
                                            />
...
<!--                                        <td>
                                    ...
                                    <th>
                                        <?php echo (empty($value->cspermit_completed_docs)?'<span style="color: #CC0000">Not Approved By MAHB</span>':'Approved');?>
                                    </th>
                                    </tr>
                                    <?php
}
...
<tr>
    ...
    <td><input type="text" name="cspermit_certbytrainer" id="cspermit_certbytrainer" value="<?php echo $trainer;?>"></td>
</tr>
<tr>
    <th width="20%">Briefing Date:</th>
    <td><input type="text" name="cspermit_certbytrainer_date" id="cspermit_certbytrainer_date" class="datepicker" value="<?php echo $briefingdate;?>"></td>
</tr>
</table>
                        <div class="row">
