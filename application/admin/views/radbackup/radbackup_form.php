...
<div class="container-fluid">
    ...
    <div class="panel panel-info">
        <div class="panel-heading">
            <h4><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> radbackup <?php echo $button; ?></h4>
        </div>
            ...
            <form action="<?php echo $action; ?>" method="post">
                ...
                <div class="row">
                    <label class="col-md-1">
                        <?php echo $this->lang->line('radbackup_datetime'); ?> <sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('radbackup_datetime'); ?>
                    </label>
                    <div class="col-md-11"><input type="text" class="form-control datetimepicker" name="radbackup_datetime" id="radbackup_datetime" placeholder="<?php echo $this->lang->line('radbackup_datetime'); ?>" value="<?php echo $radbackup_datetime; ?>" />
                                 </div></div>

                <div class="row">
                    <div class="col-md-offset-1 col-md-11">
                        <input type="hidden" name="radbackup_id" value="<?php echo (isset($id)
    ? $id : "");
?>" />
