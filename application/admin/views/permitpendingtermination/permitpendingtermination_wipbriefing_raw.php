...
<!--                                 <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                        ...
                        <form id="submitform" name="submitform" action="/admin/permitpendingtermination/wipbriefing_submit/" method="POST">
                                <div class="box-body">
...
<br>
                                    <input id="adminapproval" name="adminapproval" type="radio" value="y"><span style="color: #339900"> Permit termination accepted </span> <br>
                                    <input id="adminapproval" name="adminapproval" type="radio" value="n"> <span style="color: #FF0000">Permit termination unaccepted</span>
                                </div>
