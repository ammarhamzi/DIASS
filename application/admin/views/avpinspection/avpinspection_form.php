...
<div class="container-fluid">
  <ol class="breadcrumb">
    ...
    <li class="active"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> <?php echo $this->lang->line('avpinspection_form');?></li>
  </ol>
  <div class="panel panel-info">
    <div class="panel-heading">
      <h4><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> <?php echo $this->lang->line('avpinspection');?></h4>
    </div>
                  ...
                  <table class="table table-bordered table-condensed table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="text-center"><input data-chktype="chk" class="inspection" type="checkbox" value="<?php echo $requirement->avpchecklist_id ?>" id="<?php echo 'chk' . $requirement->avpchecklist_id ?>" <?php if($requirement->avpchecklist_checked=='y') echo 'checked' ?>></td>
                        <td class="text-center"><input data-chktype="chkmtw" class="inspection" type="checkbox" value="<?php echo $requirement->avpchecklist_id ?>" id="<?php echo 'chkmtw' . $requirement->avpchecklist_id ?>" <?php ($requirement->avpchecklist_mtwmanagerchecked == null ? '' : ($requirement->avpchecklist_mtwmanagerchecked == 'Y' ? 'checked' : '')) ?>></td>
                      </tr>
                      <?php
                          }
                          else 
                ...
                <div class="row col-md-12">
                  <table class="table table-bordered table-condensed table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td><?php echo $requirement->avpchecklist_name; ?></td>
                        <td class="text-center"><input data-chktype="chk" class="inspection" value="<?php echo $requirement->avpchecklist_id ?>" type="checkbox" id="<?php echo 'chk' . $requirement->avpchecklist_id ?>" <?php if($requirement->avpchecklist_checked=='y') echo 'checked' ?>></td>
