...
<?php
if(empty($evdppermit_attendterminalbriefing)){
?>
    <div class="col-md-3">

    <p>Briefing Date: </p><input id="change_opdate" name="change_opdate" type="text" class="datepicker_local" value="<?php echo datelocal($evdppermit_course_date);?>">
    <input id="current_opdate" type="hidden" name="current_opdate" value="<?php echo $evdppermit_course_date;?>">
        <input id="change_opdate_button" name="change_opdate_button" type="button" value="Change"></div>
<?php
}else{
?>
        <div class="col-md-3"><p>Briefing Date: <b><?php echo datelocal($evdppermit_course_date);?></b></p></div>
<?php
}
?>

    <div class="col-md-3"><p>Location: <b><?php echo ($evdppermit_course_location?$evdppermit_course_location:"KLIA");?></b></p></div>
    <div class="col-md-3"><p>Session: <b><?php echo ($evdppermit_course_session?$evdppermit_course_session:"All Day");?></b></p></div>
</div>
<br>
                <!-- Nav tabs -->
...
<!--                <br>
                <div class="panel panel-default">
                    <div class="panel-body">
                        <form id="submitform" name="submitform" action="/admin/permitall/evdp_submit/" method="POST">
                            <div class="row">
                                <h3>Your Action</h3>
...
$("#change_opdate_button").click(function () {
 $.ajax({
 	...
 	url: "<?php echo base_url() ?>permitall/change_opdate/evdp",
 	success: function(data) {
      alert(data);
 	},
