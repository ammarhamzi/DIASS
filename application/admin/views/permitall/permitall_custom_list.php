        ...
        <div class="panel-body">-->
                    <div class="box  box-primary">
                        <div class="box-header with-border">
                                    ...
                                    <h3 class="box-title"><?php echo $pagetitle. ' ('.datelocal($selecteddate).')';?></h3>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var table = $("#mytable").DataTable({
            ...
            "processing": true,
            "serverSide": true,
            "ajax": '<?php echo site_url() ?>/<?php echo $controller;?>/get_json/<?php echo $permittype;?>/<?php echo $selecteddate;?>',
            responsive: true,
            dom: 'lfrBtip',
            buttons: [
/*                <?php
