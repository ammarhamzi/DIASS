                  ...
                  <tr>
                     ...
                     <td><?php echo $mtwchecklist->mtwchecklist_name ?></td>
                                ...
                                <td style="text-align:center; white-space: nowrap;">
                                    ...
                                    <?php
                                        echo '<input onclick="this.checked=!this.checked;"  id="selfchecklist_selected" name="selfchecklist_selected[]"  type="checkbox" value="' .$mtwchecklist->mtwchecklist_id. '" ' .(in_array($mtwchecklist->mtwchecklist_id, $wip_selfchecked_selected)?"checked":""). ' >';
                                    ?>
                                    </div>
                                </td>
                                <td style="text-align:left; white-space: nowrap;">
                                    ...
                                    <?php
                                        //echo '<input  id="mtwchecklist_selected" name="mtwchecklist_selected[]" type="checkbox" value="' .$mtwchecklist->mtwchecklist_id. '"' .(in_array($mtwchecklist->mtwchecklist_id, $wip_mtwchecked_selected)?"checked":""). '>';
                                    ?>

                                            <input type="radio" name="mtwinspect_<?php echo $mtwchecklist->mtwchecklist_id;?>"  value="y" <?php echo (in_array($mtwchecklist->mtwchecklist_id, $wip_mtwchecked_y_selected)?"checked":"");?> checked
   ...
   <div class="col-md-12">
                                <table class="table table-bordered" style="width: 100% !important">
                                   ...
                                   <?php echo $wippermit_smokecondition;?>
                                    ...
                                    <?php
 if($wippermit_smokecondition_mtw == '-'){
?>
                    <select id="smokecondition_mtw" name="smokecondition_mtw" size="1">
                   <option value="L1" <?php echo ($wippermit_smokecondition=='L1'?"selected":"");?>>L1</option>
                   <option value="L2" <?php echo ($wippermit_smokecondition=='L2'?"selected":"");?>>L2</option>
                   <option value="L3" <?php echo ($wippermit_smokecondition=='L3'?"selected":"");?>>L3</option>
                   <option value="L4" <?php echo ($wippermit_smokecondition=='L4'?"selected":"");?>>L4</option>
                   <option value="L5" <?php echo ($wippermit_smokecondition=='L5'?"selected":"");?>>L5</option>
                   </select>
<?php
 }else{
?>
                    <select id="smokecondition_mtw" name="smokecondition_mtw" size="1">
                   <option value="L1" <?php echo ($wippermit_smokecondition_mtw=='L1'?"selected":"");?>>L1</option>
                   <option value="L2" <?php echo ($wippermit_smokecondition_mtw=='L2'?"selected":"");?>>L2</option>
                   <option value="L3" <?php echo ($wippermit_smokecondition_mtw=='L3'?"selected":"");?>>L3</option>
                   <option value="L4" <?php echo ($wippermit_smokecondition_mtw=='L4'?"selected":"");?>>L4</option>
                   <option value="L5" <?php echo ($wippermit_smokecondition_mtw=='L5'?"selected":"");?>>L5</option>
                   </select>
<?php
 }
                                    ?>
                                   ...
                                   <input id="fireext_serialno_mtw" name="fireext_serialno_mtw" value="<?php echo ($wippermit_fireext_serialno_mtw=='-'?$wippermit_fireext_serialno:$wippermit_fireext_serialno_mtw);?>">
                                   </td>
                                    </tr>
                                    <tr>
                                   <td>Expiry Date: </td>
                                   ...
                                   <input id="fireext_expirydate_mtw" name="fireext_expirydate_mtw" class="datepicker_local" value="<?php echo ($wippermit_fireext_expirydate_mtw=='-'?datelocal($wippermit_fireext_expirydate):datelocal($wippermit_fireext_expirydate_mtw));?>">
                                   </td>
                                    </tr>
...
<?php echo str_replace(array('<br>','<br />'),array('',''),($wippermit_tyre_manufacturingdate_mtw=='-'?$wippermit_tyre_manufacturingdate:$wippermit_tyre_manufacturingdate_mtw));?>
                                   </textarea>
                                   </td>
                                    </tr>
<!--                                    <tr>
