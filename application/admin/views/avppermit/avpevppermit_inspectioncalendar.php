    ...
    ?>
                    <div class="box  box-primary">
                        <div class="box-header with-border">
                                    ...
                                    <h3 class="box-title">AVP/EVP Inspection Calendar</h3>
    ...
    $(document).ready(function() {
        $(function() {
            ...
            $('#calendar').fullCalendar({
                ...
                defaultView: 'month',
                events: {
                    url: '/admin/avpevpinspectionmanagement/get_availableslot/',
                    type: 'POST',
                    data: {},
                    error: function() {
...
$(location).attr('href', "/admin/permitpendinginspection/list/avp/"+moment(calEvent.start).format('YYYY-MM-DD'));
                    /*} */
                }
            })
        });
