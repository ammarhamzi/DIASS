...
<html>
    <head>
        ...
        <?php */ ?>
        <link rel="stylesheet" href="<?php echo base_url('../resources/shared_js/bootstrap-timepicker/css/bootstrap-timepicker.css'); ?>">
        <script src="<?php echo base_url('../resources/shared_js/bootstrap-timepicker/js/bootstrap-timepicker.js'); ?>"></script>
