...
<ol class="breadcrumb">
  ...
  <li class="active"><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span> Companies</li>
</ol>
...
<th><?php echo $this->lang->line('company_userdepartment');?></th>
<th><?php echo $this->lang->line('company_registerednumber');?></th>
<th><?php echo $this->lang->line('company_contact_person');?></th>
<th><?php echo $this->lang->line('company_contact_email');?></th>
<th><?php echo $this->lang->line('company_contact_phone');?></th>
<th><?php echo $this->lang->line('company_contact_fax');?></th>
...
<th><?php echo $this->lang->line('company_contact_fax');?></th>
      ...
      <script type="text/javascript">
        ...
        "processing": true,
        "serverSide": true,
        "ajax": "<?php echo site_url() ?>/company/get_json",
               responsive: true,
         dom: 'lfrBtip',
         buttons: [
          <?php
         ...
         {                 text: '<span class="glyphicon glyphicon-plus" aria-hidden="true"></span> <?php echo $this->lang->line("add_new");?>',
             action: function ( e, dt, node, config ) {
                 redirect("<?php echo site_url('company/create');?>");
             } },
         <?php }?>
          <?php
