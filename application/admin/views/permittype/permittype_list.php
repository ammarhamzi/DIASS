...
<ol class="breadcrumb">
  ...
  <li class="active"><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span> <?php echo $this->lang->line('permittype');?> <?php echo $this->lang->line('list');?></li>
</ol>
    ...
    ?>
                    <div class="box  box-primary">
                        <div class="box-header with-border">
                                    ...
                                    <h3 class="box-title">Permit Types</h3>
            ...
            <table id="mytable" class="table" style="width: 100% !important">
               ...
               <thead>
                  <tr>
                     <th class="no-sort">#</th>
                     <th><?php echo $this->lang->line('permit_type_name');?></th>
<th><?php echo $this->lang->line('permit_type_desc');?></th>
...
<th><?php echo $this->lang->line('permit_type_desc');?></th>
      ...
      <script type="text/javascript">
        ...
        "processing": true,
        "serverSide": true,
        "ajax": "<?php echo site_url() ?>/permittype/get_json",
               responsive: true,
         dom: 'lfrBtip',
         buttons: [
/*          <?php
         ...
         {                 text: '<span class="glyphicon glyphicon-plus" aria-hidden="true"></span> <?php echo $this->lang->line("add_new");?>',
             action: function ( e, dt, node, config ) {
                 redirect("<?php echo site_url('permittype/create');?>");
             } },
         <?php }?>*/
          <?php
