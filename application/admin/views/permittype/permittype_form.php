...
<ol class="breadcrumb">
  ...
  <li><a href="<?php echo site_url('permittype');?>"><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span> <?php echo $this->lang->line('permittype');?> <?php echo $this->lang->line('list');?></a></li>
...
<h4><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> <?php echo $this->lang->line('permittype');?> <?php echo $button ?></h4>
  </div>
...
<div class="row">
          <label class="col-md-3 text-right">
            <?php echo $this->lang->line('permit_type_name');?> <?php echo form_error('permit_type_name') ?>
          </label><div class="col-md-9"><input type="text" class="form-control" name="permit_type_name" id="permit_type_name" placeholder="<?php echo $this->lang->line('permit_type_name');?>"value="<?php echo $permit_type_name; ?>" maxlength="255" />
         </div></div>


<div class="row">
          <label class="col-md-3 text-right">
            <?php echo $this->lang->line('permit_type_desc');?> <?php echo form_error('permit_type_desc') ?>
          </label><div class="col-md-9"><textarea class="form-control" name="permit_type_desc" id="permit_type_desc" placeholder="<?php echo $this->lang->line('permit_type_desc');?>" rows="5" cols="50"><?php echo $permit_type_desc; ?></textarea>
         </div></div>
         
<div class="row">
<div class="col-md-offset-3 col-md-9">
         <input type="hidden" name="permit_type_id" value="<?php echo (isset($id)?$id:""); ?>" />
         ...
         <a href="<?php echo site_url('permittype') ?>" class="btn btn-default"><span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span> <?php echo $this->lang->line('back');?></a>
    </div>
</div>
      </form>
      </div>
