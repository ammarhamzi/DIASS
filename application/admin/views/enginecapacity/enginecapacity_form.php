...
<ol class="breadcrumb">
  ...
  <li><a href="<?php echo site_url('enginecapacity');?>"><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span> <?php echo $this->lang->line('enginecapacity');?> <?php echo $this->lang->line('list');?></a></li>
...
<h4><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> <?php echo $this->lang->line('enginecapacity');?> <?php echo $button ?></h4>
  </div>
...
<div class="row">
          <label class="col-md-3 text-right">
            <?php echo $this->lang->line('enginecapacity_name');?> <sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('enginecapacity_name') ?>
          </label>
<div class="col-md-9"><input type="text" class="form-control" name="enginecapacity_name" id="enginecapacity_name" placeholder="<?php echo $this->lang->line('enginecapacity_name');?>"value="<?php echo $enginecapacity_name; ?>" maxlength="255" />
         </div></div>


<div class="row">
          <label class="col-md-3 text-right">
            <?php echo $this->lang->line('enginecapacity_desc');?> <?php echo form_error('enginecapacity_desc') ?>
          </label><div class="col-md-9"><textarea class="form-control" name="enginecapacity_desc" id="enginecapacity_desc" placeholder="<?php echo $this->lang->line('enginecapacity_desc');?>" rows="5" cols="50"><?php echo $enginecapacity_desc; ?></textarea>
         </div></div>
         
<div class="row">
<div class="col-md-offset-3 col-md-9">
         <input type="hidden" name="enginecapacity_id" value="<?php echo (isset($id)?$id:""); ?>" />
         ...
         <a href="<?php echo site_url('enginecapacity') ?>" class="btn btn-default"><span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span> <?php echo $this->lang->line('back');?></a>
    </div>
</div>
      </form>
      </div>
