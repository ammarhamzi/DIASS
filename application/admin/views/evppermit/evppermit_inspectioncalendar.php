    ...
    ?>
                    <div class="box  box-primary">
                        <div class="box-header with-border">
                                    ...
                                    <h3 class="box-title">EVP Inspection calendar</h3>
...
$(location).attr('href', "/admin/permitpendinginspection/list/evp/"+moment(calEvent.start).format('YYYY-MM-DD'));
                    }
                }
            })
        });
