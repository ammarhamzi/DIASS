<div class="container-fluid">
                            ...
                            <h3 class="box-title">Your Action : Generate & print out Airside Vehicle Permit.</h3>
...
<!--                                 <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                        ...
                        <form id="submitform" name="submitform" action="/admin/permitcollect/avp_submit/" method="POST">
                            <div class="box-body">
