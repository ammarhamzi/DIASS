<div class="container-fluid">
                            ...
                            <h3 class="box-title">Your Action : Generate & print out Electrical Vehicle Driving Permit.</h3>
...
<!--                                 <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                        ...
                        <form id="submitform" name="submitform" action="/admin/permitcollect/evdp_submit/" method="POST">
                            <div class="box-body">
