...
<?php
//super admin, airside admin, airside manager, mtw admin, mtw manager
if($this->session->userdata('role')== 1 || $this->session->userdata('role') ==9 || $this->session->userdata('role') == 10 || $this->session->userdata('role') == 8 || $this->session->userdata('role') == 11){
?>
...
?>
<?php
//super admin, mtw admin, mtw manager
if($this->session->userdata('role')== 1 || $this->session->userdata('role') == 8 || $this->session->userdata('role') == 11){
?>
...
?>
<?php
//super admin, airside admin, airside manager
if($this->session->userdata('role')== 1 || $this->session->userdata('role') ==9 || $this->session->userdata('role') == 10){
?>
...
?>
            <tr>
                ...
                <td>Permit require approval from airside manager</td>
                <td><?php echo $pending_approval;?></td>
                <td><a href="permitpendingapproval/index/">View All</a></td>
            </tr>
            <tr>
                <td>Verify Documents</td>
                <td>Permit submitted and waiting for verification<br>(ADP & EVDP & PBB & GPU & VGDS & PCA)</td>
...
?>
            <tr>
                <td>Verify Documents</td>
                <td>Permit submitted and waiting for verification<br>(AVP & EVP & WIP & Commercial Supplier & Stokeholder)</td>
...
<div class="row">
    <div class="col-md-6">
<h3>Inspection<span style="font-size: 10pt"> for inspector</span></h3>
<table id="inspection_list" class="display" style="width:100%">
        ...
        <tbody>
            <tr>
                <td>AVP Inspection</td>
                <td><a href="Avppermit/inspectioncalendar/">View All</a></td>
            </tr>
            <tr>
                <td>EVP Inspection</td>
                <td><a href="Evppermit/inspectioncalendar/">View All</a></td>
            </tr>
            <tr>
                <td>TEP Inspection (WIP)</td>
    ...
    <div class="col-md-6">
<h3>Review <span style="font-size: 10pt">for manager</span></h3>
...
<table id="attendance_list" class="display" style="width:100%">
        ...
        <tbody>
            ...
            <tr>
                <td>VGDS Briefing</td>
                <td><a href="vgdspermit/attendance/">View All</a></td>
            </tr>
...
?>
            <tr>
                <td>Airside Driver Permit</td>
                <td>0</td>
            </tr>
            <tr>
                <td>Electrical Vehicle Driver Permit</td>
                <td>0</td>
            </tr>
            <tr>
