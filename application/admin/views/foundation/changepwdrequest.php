...
<html>
    <head>
        ...
        <title>DIASS :: DIGITAL INTEGRATED AIRSIDE SERVICE SYSTEM | Change Password Request</title>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="login-logo">
                        <a href="<?php echo site_url(); ?>">FixzyGEN</a>
                    </div>
                    <section class="col-lg-9 col-md-9 col-sm-9"  style=" background-color: white;padding: 25px 25px 50px 25px; border-radius: 10px;">
                        <p>Thank you for your submission.<br /><br /></p>
                        <p>Please check your email to continue. <br>Please check in your spam email too if  not receive it more than 5 minutes. <br /><br /><input type="submit" id="goto" value="Go to login page" style="float:right" class="btn btn-primary btn-block btn-flat"/></p>
