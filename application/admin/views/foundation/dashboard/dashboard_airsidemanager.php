...
<section class="content-header">
    <h1>
        Dashboard
        <small>Licensing Approver</small>
    </h1>
    <ol class="breadcrumb">
...
<table id="actions_list" class="display" style="width:100%">
        ...
        <tbody>
            ...
            <tr>
                <td><b><span style="color: #990000">Pending Approval</span></b></td>
                <td><b><span style="color: #990000">Permit require approval from licensing approver</span></b></td>
                <td><b><span style="color: #990000"><?php echo $pending_approval;?></span></b></td>
