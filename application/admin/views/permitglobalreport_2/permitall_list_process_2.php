...
<div class="container-fluid">
    <ol class="breadcrumb">
        ...
        <li class="active"><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span> Permit Issuance Date
        </li>
    </ol>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <label for="applicationdate">Permit Issuance Date <sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup></label>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var table = $("#mytable").DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?php echo site_url(); ?>permitglobalreport_2/get_json/",
                "type": "GET",
                "data": {
