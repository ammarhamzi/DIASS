    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            <table class="table table-condensed table-responsive">
                ...
                <tr>
                    <th class="col-md-3 text-right">
                        <?php echo $this->lang->line('permit_timeline_updated_at');?>
                    </th>
                    <td class="col-md-9">
                        <?php echo $permit_timeline_updated_at; ?>
                    </td>
                </tr>

                <tr>
                    <th class="col-md-3 text-right">
                        <?php echo $this->lang->line('permit_timeline_deleted_at');?>
                    </th>
                    <td class="col-md-9">
                        <?php echo $permit_timeline_deleted_at; ?>
                    </td>
                </tr>
