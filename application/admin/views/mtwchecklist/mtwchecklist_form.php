...
<ol class="breadcrumb">
  ...
  <li><a href="<?php echo site_url('mtwchecklist');?>"><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span> <?php echo $this->lang->line('mtwchecklist');?> <?php echo $this->lang->line('list');?></a></li>
...
<h4><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> <?php echo $this->lang->line('mtwchecklist');?> <?php echo $button ?></h4>
  </div>
...
<div class="row">
          <label class="col-md-3 text-right">
            <?php echo $this->lang->line('mtwchecklist_type');?> <sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('mtwchecklist_type') ?>
          </label>
<div class="col-md-9"><input type="text" class="form-control" name="mtwchecklist_type" id="mtwchecklist_type" placeholder="<?php echo $this->lang->line('mtwchecklist_type');?>" value="<?php echo $mtwchecklist_type; ?>" maxlength="3"/>
          </div></div>

<div class="row">
          <label class="col-md-3 text-right">
            <?php echo $this->lang->line('mtwchecklist_name');?> <sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('mtwchecklist_name') ?>
          </label>
<div class="col-md-9"><input type="text" class="form-control" name="mtwchecklist_name" id="mtwchecklist_name" placeholder="<?php echo $this->lang->line('mtwchecklist_name');?>"value="<?php echo $mtwchecklist_name; ?>" maxlength="255" />
         </div></div>


<div class="row">
          <label class="col-md-3 text-right">
            <?php echo $this->lang->line('mtwchecklist_desc');?> <?php echo form_error('mtwchecklist_desc') ?>
          </label><div class="col-md-9"><input type="text" class="form-control" name="mtwchecklist_desc" id="mtwchecklist_desc" placeholder="<?php echo $this->lang->line('mtwchecklist_desc');?>"value="<?php echo $mtwchecklist_desc; ?>" maxlength="255" />
         </div></div>

<div class="row">
          <label class="col-md-3 text-right">
            <?php echo $this->lang->line('mtwchecklist_required');?> <sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('mtwchecklist_required') ?>
          </label>
<div class="col-md-9"><input type="text" class="form-control" name="mtwchecklist_required" id="mtwchecklist_required" placeholder="<?php echo $this->lang->line('mtwchecklist_required');?>" value="<?php echo $mtwchecklist_required; ?>" maxlength="1"/>
          </div></div>
         
<div class="row">
<div class="col-md-offset-3 col-md-9">
         <input type="hidden" name="mtwchecklist_id" value="<?php echo (isset($id)?$id:""); ?>" />
         ...
         <a href="<?php echo site_url('mtwchecklist') ?>" class="btn btn-default"><span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span> <?php echo $this->lang->line('back');?></a>
    </div>
</div>
      </form>
      </div>
