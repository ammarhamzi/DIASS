...
class Offendlist_model extends CI_Model
{
    ...
    public function get_all()
    {
        ...
        $this->db->select('offendlist_dummy.*, offendlist_category.off_cat_name');
        $this->db->where('offendlist_dummy.offendlist_deleted_at IS NULL');
        $this->db->join('offendlist_category','offendlist_category.off_cat_ref = offendlist_dummy.offendlist_offendtype','left');
        $this->db->from('offendlist_dummy');
