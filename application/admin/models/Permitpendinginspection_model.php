...
class Permitpendinginspection_model extends CI_Model
{
...
// delete data
    ...
    public function listajax_backup($condition, $columns, $start, $length, $filter = "", $sort = "", $sorttype = "")
    {
...
$this->db->distinct();
        $this->db->where('permit_deleted_at');
        //$this->db->where('permit_status', 'inspectionpending');
        ...
        if ($condition['permittype'] == 'avp') {
            $permit_type = 4;
            $this->db->join('avppermit', 'avppermit.avppermit_permit_id = permit.permit_id', 'left');
            $this->db->where('avppermit_inspection_date', $condition['selecteddate']);
        } elseif ($condition['permittype'] == 'evp') {
            $permit_type = 3;
            $this->db->join('evppermit', 'evppermit.evppermit_permit_id = permit.permit_id', 'left');
            $this->db->where('evppermit_inspection_date', $condition['selecteddate']);
        }  elseif ($condition['permittype'] == 'wip') {
            $permit_type = 9;
            $this->db->join('wippermit', 'wippermit.wippermit_permit_id = permit.permit_id', 'left');
            $this->db->where('wippermit_inspection_date', $condition['selecteddate']);
        } elseif ($condition['permittype'] == 'shins') {
            $permit_type = 13;
            $this->db->join('shinspermit', 'shinspermit.shinspermit_permit_id = permit.permit_id', 'left');
            $this->db->where('shinspermit_inspection_date', $condition['selecteddate']);
        }

        $this->db->where('permit_typeid', $permit_type);
    ...
    public function listajax($location,$condition, $columns, $start, $length, $filter = "", $sort = "", $sorttype = "")
    {
if($condition['permittype']=='wip'){
$i = 0;
        $this->db->select('
    permit.*,
    permit_group.permit_group_name AS permit_group_name_permit_groupid,
...
permit_type.permit_type_desc AS permit_type_desc,
    ...
    wippermit.wippermit_inspection_location AS inspection_location', false);
        $this->db->distinct();
        $this->db->where('permit_deleted_at');
        if($location!="all"){
...
permit_type.permit_type_desc AS permit_type_desc,
    ...
    permit_status.permit_status_name AS permit_status_desc_permit_status,
    permit_officialstatus.permit_officialstatus_name AS permit_officialstatus_name_permit_officialstatus,
    avppermit.avppermit_inspection_location AS inspection_location', false);
        $this->db->distinct();
        $this->db->where('permit_deleted_at');
        if($location!="all"){
         $this->db->like('permit_location', $location, 'before');
...
permit_type.permit_type_desc AS permit_type_desc,
    ...
    permit_status.permit_status_name AS permit_status_desc_permit_status,
    permit_officialstatus.permit_officialstatus_name AS permit_officialstatus_name_permit_officialstatus,
    evppermit.evppermit_inspection_location AS inspection_location', false);
$this->db->distinct();
        $this->db->where('permit_deleted_at');
        //$this->db->where('permit_status', 'inspectionpending');
...
/*        $i = 0;
       ...
       // combine
       $queryResult = $this->db->query($query1." UNION ".$query2)->result_array();
    ...
    public function recordsTotal($condition,$location)
    {
        $i = 0;
    ...
    public function recordsFiltered($condition,$location, $columns, $filter = "")
    {
        $i = 0;
