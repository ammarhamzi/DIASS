...
// delete data
    ...
    public function get_read_cancel($adpadv_no)
    {
        $this->db->select('*', false);
        $this->db->from('enforcement_main');
        $this->db->where('enforcements_main_adpadv_no', $adpadv_no);
        //$this->db->where('enforcements_main_status', 'Open'); //Added on 5Jan2023
        $this->db->where("(enforcements_main_status='Close' OR enforcements_main_status='Cancel')", NULL, FALSE);
        ...
        //$this->db->where('enforcements_main_status', 'Open'); //Added on 5Jan2023
        ////$this->db->from('enforcement_main');
        //$query = $this->db->get('enforcement_main');
        //return $query->num_rows();
    }
    
    public function get_read_all($adpadv_no)
    {
        $this->db->select('*', false);
        $this->db->from('enforcement_main');
        $this->db->where('enforcements_main_adpadv_no', $adpadv_no);
...
// delete data
    ...
    function driver_detail_adp($driver_id)
    {
...
//    }
    ...
    function sum_merit_point($from_category,$driverOrVehicleid)
    {
        ...
        //$this->db->where('enforcement_main.enforcements_main_adpadv_no',$permit_no);
        $wherez = "(enforcement_main.enforcements_main_status = 'Open' or enforcement_main.enforcements_main_status = 'Close')";
        $this->db->where($wherez);
        //$this->db->where('enforcement_main.enforcements_main_status','Cancel');
        return $query = $this->db->get()->row()->merit_point;
    }
...
// $this->db->where('driver_id', $driver_id);
    ...
    {
        $this->db->select('enforcement_n.*, offendlist_2020.offendlist_violationNo, offendlist_2020.offendlist_regNo, offendlist_category.off_cat_name');
        $this->db->from('enforcement_n');
    ...
    /**
     * DEPRECATED: Use get_offence_history() instead
     * Legacy method with partial revision support
     */
