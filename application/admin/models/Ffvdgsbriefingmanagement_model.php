...
// get all
  function get_all() {
	...
	$this->db->order_by("ffvdgs_briefingmanagement_date", "DESC");
...
//	end as ffvdgs_briefingmanagement_location", FALSE);
  ...
  function recordsFiltered($columns, $filter=''){
    ...
    public function get_slottaken($date,$location,$session)
    {
        ...
        $this->db->where("vdgspermit_course_session",$session);
        ...
        $this->db->join('permit', 'permit.permit_id = vdgspermit.vdgspermit_permit_id');
        $query = $this->db->get();
