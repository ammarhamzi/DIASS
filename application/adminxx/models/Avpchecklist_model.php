...
// update data
  ...
  function update_mtw_inspection($id,$selected){
    //reset all
    $this->db->where('avpchecklist_permit_id', $id);
    $this->db->update('avpchecklist', ['avpchecklist_mtwchecked' => NULL]);

              foreach ($selected as $selectid) {
                $this->db->where('avpchecklist_permit_id', $id);
                $this->db->where('avpchecklist_mtwchecklist_id', $selectid);
                $this->db->update('avpchecklist', ['avpchecklist_mtwchecked' => 'y']);
            }
  }
  ...
  function update_mtw_inspection_v2($id,$selected_y,$selected_n){
    ...
    $this->db->update('avpchecklist', ['avpchecklist_mtwchecked' => NULL]);
              ...
              foreach ($selected_y as $selectidy) {
                $this->db->where('avpchecklist_permit_id', $id);
                $this->db->where('avpchecklist_mtwchecklist_id', $selectidy);
                $this->db->update('avpchecklist', ['avpchecklist_mtwchecked' => 'y']);
            }

              foreach ($selected_n as $selectidn) {
                $this->db->where('avpchecklist_permit_id', $id);
                $this->db->where('avpchecklist_mtwchecklist_id', $selectidn);
                $this->db->update('avpchecklist', ['avpchecklist_mtwchecked' => 'n']);
            }
  }
  ...
  function update_mtw_inspection_v3($id,$selected_y,$selected_n,$selected_na){
    ...
    $this->db->update('avpchecklist', ['avpchecklist_mtwchecked' => NULL]);
              ...
              foreach ($selected_na as $selectidna) {
                $this->db->where('avpchecklist_permit_id', $id);
                $this->db->where('avpchecklist_mtwchecklist_id', $selectidna);
                $this->db->update('avpchecklist', ['avpchecklist_mtwchecked' => 'n/a']);
            }
  }
