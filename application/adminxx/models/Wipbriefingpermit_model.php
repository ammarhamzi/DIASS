...
class Wipbriefingpermit_model extends CI_Model
{
...
// get all
    public function get_all()
    {
        ...
        $this->db->order_by('wipbriefingpermit_id', 'DESC');
...
// get data by id
    ...
    {
        $this->db->select('*');
        $this->db->where('wipbriefingpermit_id', $id);
        $this->db->from('wipbriefingpermit');
    ...
    {
        $this->db->select('wipbriefingpermit.*, vehicle.*, company.*');
        $this->db->where('wipbriefingpermit_course_date', $date);
    ...
    {
        $this->db->select('*', false);
        $this->db->where('wipbriefingpermit_permit_id', $id);
        $this->db->from('wipbriefingpermit');
...
// insert data
    ...
    {
        $this->db->insert('wipbriefingpermit', $data);
    }
...
// update data
    ...
    {
        $this->db->where('wipbriefingpermit_id', $id);
        $this->db->update('wipbriefingpermit', $data);
    }
...
// delete data
    ...
    {
        $this->db->where('wipbriefingpermit_id', $id);
        $this->db->delete('wipbriefingpermit');
    }
