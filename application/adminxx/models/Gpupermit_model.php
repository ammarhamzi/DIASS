...
class Gpupermit_model extends CI_Model
{
...
// get all
    public function get_all()
    {
        ...
        $this->db->order_by('gpupermit_id', 'DESC');
...
// get data by id
    ...
    {
        $this->db->select('gpupermit.*, driver.*, company.*');
        $this->db->where('gpupermit_course_date', $date);
    ...
    {
        $this->db->select('*', false);
        $this->db->where('gpupermit_permit_id', $id);
        $this->db->from('gpupermit');
