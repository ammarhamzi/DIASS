...
class Enginecapacity_model extends CI_Model {
...
// get all
  function get_all() {
	...
	$this->db->where('enginecapacity_deleted_at');
	$this->db->order_by('enginecapacity_id', 'DESC');
...
// get data by id
  function get_by_id($id) {
    $this->db->select('*');
	$this->db->where('enginecapacity_id', $id);
	$this->db->where('enginecapacity_deleted_at');
	$this->db->from('enginecapacity');
...
// insert data
  function insert($data) {
    $this->db->insert('enginecapacity', $data);
  }

// update data
  function update($id, $data) {
    $this->db->where('enginecapacity_id', $id);
    $this->db->update('enginecapacity', $data);
  }

// delete data
  function delete($id) {
    $this->db->where('enginecapacity_id', $id);
    $this->db->delete('enginecapacity');
  }
