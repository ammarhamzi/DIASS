...
class Permitvalidavp extends MY_Controller
{

    public function __construct()
    {
        parent::__construct();
        $this->load->model('permitvalidavp_model');
        ...
        $this->lang->load('permitvalidavp_lang', $this->session->userdata('language'));
    ...
    public function index()
    {
        ...
        if ($this->permission->showlist == true) {
            ...
            $data = [
                ...
                'controller' => 'Permitvalidavp',
                'pagetitle' => 'Active Airside Vehicle Permits',
            ];
...
//        ];
        ...
        $test = $columns[$this->input->get('order')[0]['column']];
        $test2 = $this->input->get('order')[0]['dir'];
        $results = $this->permitvalidavp_model->listajax(
            $location,
            $columns,
           $columnfilter,
            ...
            /* $columns[!empty($this->input->get('order')[0]['column'])?$this->input->get('order')[0]['column']:"permit.permit_id"],  */
            //!empty($this->input->get('order')[0]['column'])?$this->input->get('order')[0]['column']:"",
            //!empty($this->input->get('order')[0]['dir'])?$this->input->get('order')[0]['dir']:"DESC"
...
$r['permit_issuance_serialno'],
        ...
        echo json_encode(
            [
                ...
                "recordsTotal" => $this->permitvalidavp_model->recordsTotal($location)->recordstotal,
                "recordsFiltered" => $this->permitvalidavp_model->recordsTotal($location)->recordstotal,
                'data' => $data
            ]
        );
    }
...
;
/* End of file Permitvalidavp.php */
/* Location: ./application/controllers/Permitvalidavp.php */
