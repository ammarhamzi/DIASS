...
class Permitpendingreplacement extends MY_Controller
{

    public function __construct()
    {
        parent::__construct();
        $this->load->model('permitpendingreplacement_model');
        ...
        $this->lang->load('permitpendingreplacement_lang', $this->session->userdata('language'));
...
$this->lang->load('wipbriefingpermit_lang', $this->session->userdata('language'));
    ...
    public function index()
    {
        ...
        if ($this->permission->showlist == true) {
            ...
            $data = [
                ...
                'controller' => 'permitpendingreplacement',
                'pagetitle' => 'Pending Replacement Permits',
            ];
    ...
    public function adp($id)
    {
        ...
        $this->content  = 'permitpendingreplacement/permitpendingreplacement_adp_raw';
    ...
    public function evdp($id)
    {
        ...
        $this->content  = 'permitpendingreplacement/permitpendingreplacement_evdp_raw';
        ##--slave_combine_to_read--##
        $this->layout($data, $setting);
    ...
    public function avp($id)
    {
        ...
        $this->content  = 'permitpendingreplacement/permitpendingreplacement_avp_raw';
        ##--slave_combine_to_read--##
        $this->layout($data, $setting);
    ...
    public function evp($id)
    {
        ...
        $this->content  = 'permitpendingreplacement/permitpendingreplacement_evp_raw';
        ##--slave_combine_to_read--##
        $this->layout($data, $setting);
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($this->input->post('adminapproval', true) == 'y') {
                ...
                $data_permit = [
                    ...
                    'permit_replacement_remark' => $this->input->post('remark', true),
                ...
                $data_timeline = [
                    ...
                    'permit_timeline_name' => PERMIT_REPLACED_PAYMENT,
                    'permit_timeline_desc' => PERMIT_REPLACED_PAYMENT_DESC,
...
'permit_timeline_remark' => $this->input->post('remark', true)
                ...
                $this->db->trans_start();
                $this->permitpendingreplacement_model->update($permitid, $data_permit);
                ...
                $data_timeline = [
                    'permit_timeline_permitid' => $permitid,
                    'permit_timeline_userid' => $userid,
                    'permit_timeline_name' => PERMIT_REPLACE_REJECTED,
                    'permit_timeline_desc' => PERMIT_REPLACE_REJECTED_DESC,
...
'permit_timeline_remark' => $this->input->post('remark', true)
                ...
                if ($this->db->trans_status() === false) {
                    ...
                    redirect(site_url('permitpendingreplacement'));
        }
...
redirect('/');
    ...
    public function get_json($location='all')
    {
        ...
        $results = $this->permitpendingreplacement_model->listajax(
        $location,
            $columns,
            $columnfilter,
        ...
        foreach ($results as $r) {
            ...
            if ($this->permission->cp_read == true) {
                $rud .= anchor(site_url('permitpendingreplacement/' . strtolower($r['permit_type_name_permit_typeid']) . '/' . fixzy_encoder($r['permit_id'])), '<button type="button" class="btn btn-info"><span class="glyphicon glyphicon-search" aria-hidden="true"></span></button>') .
                    ' ';
            }
...
/*                $i, */
        ...
        echo json_encode(
            [
                ...
                "recordsTotal" => $this->permitpendingreplacement_model->recordsTotal($location)->recordstotal,
                "recordsFiltered" => $this->permitpendingreplacement_model->recordsFiltered($location,$columns,$columnfilter, $this->input->get('search')['value'])->recordsfiltered,
                'data' => $data
            ]
        );
    }
    ...
    public function pbb($id)
    {
        ...
        $this->content  = 'permitpendingreplacement/permitpendingreplacement_pbb_raw';
        ##--slave_combine_to_read--##
        $this->layout($data, $setting);
...
redirect('/');
    ...
    public function sh($id)
    {
        ...
        $this->content  = 'permitpendingreplacement/permitpendingreplacement_sh_raw';
        ##--slave_combine_to_read--##
        $this->layout($data, $setting);
...
redirect('/');
    ...
    public function vdgs($id)
    {
        ...
        $this->content  = 'permitpendingreplacement/permitpendingreplacement_vdgs_raw';
        ##--slave_combine_to_read--##
        $this->layout($data, $setting);
...
redirect('/');
    ...
    public function cs($id)
    {
        ...
        $this->content  = 'permitpendingreplacement/permitpendingreplacement_cs_raw';
        ##--slave_combine_to_read--##
        $this->layout($data, $setting);
...
redirect('/');
    ...
    public function gpu($id)
    {
        ...
        $this->content  = 'permitpendingreplacement/permitpendingreplacement_gpu_raw';
        ##--slave_combine_to_read--##
        $this->layout($data, $setting);
...
redirect('/');
    ...
    public function pca($id)
    {
        ...
        $this->content  = 'permitpendingreplacement/permitpendingreplacement_pca_raw';
        ##--slave_combine_to_read--##
        $this->layout($data, $setting);
...
redirect('/');
    ...
    public function wip($id)
    {
        ...
        $this->content  = 'permitpendingreplacement/permitpendingreplacement_wip_raw';
        ##--slave_combine_to_read--##
        $this->layout($data, $setting);
...
redirect('/');
    ...
    public function shins($id)
    {
        ...
        $this->content  = 'permitpendingreplacement/permitpendingreplacement_shins_raw';
        ##--slave_combine_to_read--##
        $this->layout($data, $setting);
...
'permit_timeline_remark' => $this->input->post('remark', true)
    ...
    public function wipbriefing($id)
    {
        ...
        $this->content  = 'permitpendingreplacement/permitpendingreplacement_wipbriefing_raw';
        ##--slave_combine_to_read--##
        $this->layout($data, $setting);
...
;
/* End of file Permitpendingreplacement.php */
/* Location: ./application/controllers/Permitpendingreplacement.php */
