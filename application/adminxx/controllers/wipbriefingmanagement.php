...
class Wipbriefingmanagement extends MY_Controller
{
    ...
    public function scheduler()
    {
        ...
        if ($this->permission->showlist == true) {
            ...
            $this->content = 'wipbriefingmanagement/wipbriefingmanagement_schedule';
            ##--slave_combine_to_list--##
            $this->layout($data, $setting);
...
//check if parentchild exist
    ...
    {
		if($date){
			$wipbriefingmanagement_date = $date;
		} else {
        ...
        if ($this->permission->cp_create == true) {
            ...
            $data = [
                ...
                'wipbriefingmanagement_date' => $wipbriefingmanagement_date,
...
exit;*/
        foreach ($row as $value) {
            ...
            $calendar[] = [
                ...
                "title" => $value->wipbriefingmanagement_slottaken."/".$value->wipbriefingmanagement_slot." Driver(s)",
