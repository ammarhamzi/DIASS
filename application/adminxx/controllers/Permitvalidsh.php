...
class Permitvalidsh extends MY_Controller
{

    public function __construct()
    {
        parent::__construct();
        $this->load->model('permitvalidsh_model');
        ...
        $this->lang->load('permitvalidsh_lang', $this->session->userdata('language'));
    ...
    public function index()
    {
        ...
        if ($this->permission->showlist == true) {
            ...
            $data = [
                ...
                'controller' => 'Permitvalidsh',
                'pagetitle' => 'Active TEP (Stakeholder) Permits',
            ];
    ...
    public function get_json($location='all')
    {
        ...
        $results = $this->permitvalidsh_model->listajax(
            $location,
            $columns,
           $columnfilter,
...
$r['permit_issuance_serialno'],
        ...
        echo json_encode(
            [
                ...
                "recordsTotal" => $this->permitvalidsh_model->recordsTotal($location)->recordstotal,
                "recordsFiltered" => $this->permitvalidsh_model->recordsTotal($location)->recordstotal,
                'data' => $data
            ]
        );
    }
...
;
/* End of file Permitvalidsh.php */
/* Location: ./application/controllers/Permitvalidsh.php */
