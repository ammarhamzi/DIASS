									...
									<td colspan="2" >
										<table width="100%" border="0" cellpadding="2" cellspacing="0">
											<tr>
												...
												<td width="15%" style="font-size: 0.7em !important;">
					...
					<tr>
						<td >
							<table width="100%" border="1" cellpadding="5" cellspacing="0">
								...
								<tr>
									<td colspan="2" rowspan="2">I/C No.</td>
									<td colspan="2" rowspan="2">'.$offence_reg_no.'</td>
									<td colspan="2" rowspan="2">Permit Serial No.</td>
								...
								<tr>
									<td colspan="3" rowspan="2" align="center">Notice Accept BY</td>
								...
								<tr>
									<td colspan="3" align="center">Reported by<br />(Airside Duty Officer)</td>
									<td colspan="5" align="center">
										<table width="95%" border="0" cellpadding="0" cellspacing="0">
											<tr>
												<td width="40%"><br /><br /><br /><br />Date : ____________________</td>
        ...
        if(!empty($single_date_get))
        {
            ...
            foreach ($charge_type_list as $ctl) 
            {
                ...
                switch ($kod) {
                    ...
                    case '5352':
                        //TEP
                        $qty = $this->Service_charges_model->category_charges_price_per_date($single_date_get,17,$payment_method_get,$working_session);
                        if($qty > 0)
                        {
                            $charge_type_output[] = array_merge(
                                        $ctl,
