...
class Permitcanceled extends MY_Controller
{

    public function __construct()
    {
        parent::__construct();
        $this->load->model('permitcanceled_model');
        ...
        $this->lang->load('permitcanceled_lang', $this->session->userdata('language'));
...
$this->lang->load('wipbriefingpermit_lang', $this->session->userdata('language'));
    ...
    public function index()
    {
        ...
        if ($this->permission->showlist == true) {
            ...
            $data = [
                ...
                'controller' => 'permitcanceled',
                'pagetitle' => 'Canceled Permits',
            ];
    ...
    public function adp($id)
    {
        ...
        $this->content  = 'permitcanceled/permitcanceled_adp_raw';
    ...
    public function evdp($id)
    {
        ...
        $this->content  = 'permitcanceled/permitcanceled_evdp_raw';
        ##--slave_combine_to_read--##
        $this->layout($data, $setting);
    ...
    public function avp($id)
    {
        ...
        $this->content  = 'permitcanceled/permitcanceled_avp_raw';
        ##--slave_combine_to_read--##
        $this->layout($data, $setting);
    ...
    public function evp($id)
    {
        ...
        $this->content  = 'permitcanceled/permitcanceled_evp_raw';
        ##--slave_combine_to_read--##
        $this->layout($data, $setting);
...
'permit_timeline_remark' => $this->input->post('remark', true)
                ...
                $this->db->trans_start();
                $this->permitcanceled_model->update($permitid, $data_permit);
...
'permit_timeline_remark' => $this->input->post('remark', true)
                ...
                if ($this->db->trans_status() === false) {
                    ...
                    redirect(site_url('permitcanceled'));
        }
...
redirect('/');
    ...
    public function get_json($location='all')
    {
        ...
        $results = $this->permitcanceled_model->listajax(
        $location,
            $columns,
            $columnfilter,
        ...
        foreach ($results as $r) {
            ...
            if ($this->permission->cp_read == true) {
                $rud .= anchor(site_url('permitcanceled/' . strtolower($r['permit_type_name_permit_typeid']) . '/' . fixzy_encoder($r['permit_id'])), '<button type="button" class="btn btn-info"><span class="glyphicon glyphicon-search" aria-hidden="true"></span></button>') .
                    ' ';
            }
...
/*                $i, */
        ...
        echo json_encode(
            [
                ...
                "recordsTotal" => $this->permitcanceled_model->recordsTotal($location)->recordstotal,
                "recordsFiltered" => $this->permitcanceled_model->recordsFiltered($location, $columns, $columnfilter, $this->input->get('search')['value'])->recordsfiltered,
                'data' => $data
            ]
        );
    }
    ...
    public function pbb($id)
    {
        ...
        $this->content  = 'permitcanceled/permitcanceled_pbb_raw';
        ##--slave_combine_to_read--##
        $this->layout($data, $setting);
...
redirect('/');
    ...
    public function sh($id)
    {
        ...
        $this->content  = 'permitcanceled/permitcanceled_sh_raw';
        ##--slave_combine_to_read--##
        $this->layout($data, $setting);
...
redirect('/');
    ...
    public function vdgs($id)
    {
        ...
        $this->content  = 'permitcanceled/permitcanceled_vdgs_raw';
        ##--slave_combine_to_read--##
        $this->layout($data, $setting);
...
redirect('/');
    ...
    public function cs($id)
    {
        ...
        $this->content  = 'permitcanceled/permitcanceled_cs_raw';
        ##--slave_combine_to_read--##
        $this->layout($data, $setting);
...
redirect('/');
    ...
    public function gpu($id)
    {
        ...
        $this->content  = 'permitcanceled/permitcanceled_gpu_raw';
        ##--slave_combine_to_read--##
        $this->layout($data, $setting);
...
redirect('/');
    ...
    public function pca($id)
    {
        ...
        $this->content  = 'permitcanceled/permitcanceled_pca_raw';
        ##--slave_combine_to_read--##
        $this->layout($data, $setting);
...
redirect('/');
    ...
    public function wip($id)
    {
        ...
        $this->content  = 'permitcanceled/permitcanceled_wip_raw';
        ##--slave_combine_to_read--##
        $this->layout($data, $setting);
...
redirect('/');
    ...
    public function shins($id)
    {
        ...
        $this->content  = 'permitcanceled/permitcanceled_shins_raw';
        ##--slave_combine_to_read--##
        $this->layout($data, $setting);
...
'permit_timeline_remark' => $this->input->post('remark', true)
    ...
    public function wipbriefing($id)
    {
        ...
        $this->content  = 'permitcanceled/permitcanceled_wipbriefing_raw';
        ##--slave_combine_to_read--##
        $this->layout($data, $setting);
...
;
/* End of file Permitcanceled.php */
/* Location: ./application/controllers/Permitcanceled.php */
