...
class Gpubriefingmanagement extends MY_Controller
{
    ...
    public function scheduler()
    {
        ...
        if ($this->permission->showlist == true) {
            ...
            $this->content = 'gpubriefingmanagement/gpubriefingmanagement_schedule';
            ##--slave_combine_to_list--##
            $this->layout($data, $setting);
...
//check if parentchild exist
    ...
    {
		if($date){
			$gpubriefingmanagement_date = $date;
		} else {
        ...
        if ($this->permission->cp_create == true) {
            ...
            $data = [
                ...
                'gpubriefingmanagement_date' => $gpubriefingmanagement_date,
...
exit;*/
        foreach ($row as $value) {
            ...
            $calendar[] = [
                ...
                "title" => $value->gpubriefingmanagement_slottaken."/".$value->gpubriefingmanagement_slot." Driver(s)",
