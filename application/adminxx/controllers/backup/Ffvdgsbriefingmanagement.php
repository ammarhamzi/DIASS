...
/*                      if($this->permission->cp_read == true){
    ...
    {
        $row = $this->ffvdgsbriefingmanagement_model->get_slot();
/*    var_dump($row);
exit;*/
...
$title = $value->ffvdgs_briefingmanagement_location.'-(' .$value->ffvdgs_briefingmanagement_category. ')-'.(!empty($value->ffvdgs_briefingmanagement_slottaken)?$value->ffvdgs_briefingmanagement_slottaken:'0').'/'. $value->ffvdgs_briefingmanagement_slot;
