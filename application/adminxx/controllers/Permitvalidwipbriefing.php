...
class Permitvalidwipbriefing extends MY_Controller
{

    public function __construct()
    {
        parent::__construct();
        $this->load->model('permitvalidwipbriefing_model');
        ...
        $this->lang->load('permitvalidwipbriefing_lang', $this->session->userdata('language'));
    ...
    public function index()
    {
        ...
        if ($this->permission->showlist == true) {
            ...
            $data = [
                ...
                'controller' => 'Permitvalidwipbriefing',
                'pagetitle' => 'Active TEP (Work In Progress - others areas) Permits',
            ];
    ...
    public function get_json($location='all')
    {
        ...
        $results = $this->permitvalidwipbriefing_model->listajax(
            $location,
            $columns,
           $columnfilter,
...
$r['permit_issuance_serialno'],
        ...
        echo json_encode(
            [
                ...
                "recordsTotal" => $this->permitvalidwipbriefing_model->recordsTotal($location)->recordstotal,
                "recordsFiltered" => $this->permitvalidwipbriefing_model->recordsTotal($location)->recordstotal,
                'data' => $data
            ]
        );
    }
...
;
/* End of file Permitvalidwipbriefing.php */
/* Location: ./application/controllers/Permitvalidwipbriefing.php */
