...
$this->lang->load('wipbriefingpermit_lang', $this->session->userdata('language'));
    ...
    public function adp($id)
    {
        ...
        $this->content  = 'permitpendingapproval/permitpendingapproval_adp_raw';
    ...
    public function evdp($id)
    {
        ...
        $this->content  = 'permitpendingapproval/permitpendingapproval_evdp_raw';
        ##--slave_combine_to_read--##
        $this->layout($data, $setting);
    ...
    public function avp($id)
    {
        ...
        $this->content  = 'permitpendingapproval/permitpendingapproval_avp_raw';
        ##--slave_combine_to_read--##
        $this->layout($data, $setting);
    ...
    public function evp($id)
    {
        ...
        $this->content  = 'permitpendingapproval/permitpendingapproval_evp_raw';
        ##--slave_combine_to_read--##
        $this->layout($data, $setting);
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($this->input->post('adminapproval', true) == 'y') {
                ...
                $data_permit = [
                    ...
                    'permit_approved_by' => $this->session->userdata('name'),
                ];
...
'permit_timeline_remark' => $this->input->post('remark', true)
                ...
                $this->db->trans_start();
                $this->permitpendingapproval_model->update($permitid, $data_permit);
...
$driver_vehicle_id = $this->permitall_model->get_driverorvehicle_id($permittype,$permitid);
                ...
                if ($this->db->trans_status() === false) {
                    ...
                    redirect(site_url('permitpendingapproval'));
        }
...
redirect('/');
    ...
    public function get_json($location='all')
    {
        ...
        $results = $this->permitpendingapproval_model->listajax(
        $location,
            $columns,
            $columnfilter,
        ...
        foreach ($results as $r) {
            ...
            if ($this->permission->cp_read == true) {
                $rud .= anchor(site_url('permitpendingapproval/' . strtolower($r['permit_type_name_permit_typeid']) . '/' . fixzy_encoder($r['permit_id'])), '<button type="button" class="btn btn-info"><span class="glyphicon glyphicon-search" aria-hidden="true"></span></button>') .
                    ' ';
            }
...
/*                $i, */
        ...
        echo json_encode(
            [
                ...
                "recordsTotal" => $this->permitpendingapproval_model->recordsTotal($location)->recordstotal,
                "recordsFiltered" => $this->permitpendingapproval_model->recordsFiltered($location, $columns, $columnfilter, $this->input->get('search')['value'])->recordsfiltered,
                'data' => $data
            ]
        );
    }
    ...
    public function pbb($id)
    {
        ...
        $this->content  = 'permitpendingapproval/permitpendingapproval_pbb_raw';
        ##--slave_combine_to_read--##
        $this->layout($data, $setting);
...
redirect('/');
    ...
    public function sh($id)
    {
        ...
        $this->content  = 'permitpendingapproval/permitpendingapproval_sh_raw';
        ##--slave_combine_to_read--##
        $this->layout($data, $setting);
...
redirect('/');
    ...
    public function vdgs($id)
    {
        ...
        $this->content  = 'permitpendingapproval/permitpendingapproval_vdgs_raw';
        ##--slave_combine_to_read--##
        $this->layout($data, $setting);
...
redirect('/');
    ...
    public function cs($id)
    {
        ...
        $this->content  = 'permitpendingapproval/permitpendingapproval_cs_raw';
        ##--slave_combine_to_read--##
        $this->layout($data, $setting);
...
redirect('/');
    ...
    public function gpu($id)
    {
        ...
        $this->content  = 'permitpendingapproval/permitpendingapproval_gpu_raw';
        ##--slave_combine_to_read--##
        $this->layout($data, $setting);
...
redirect('/');
    ...
    public function pca($id)
    {
        ...
        $this->content  = 'permitpendingapproval/permitpendingapproval_pca_raw';
        ##--slave_combine_to_read--##
        $this->layout($data, $setting);
...
redirect('/');
    ...
    public function wip($id)
    {
        ...
        $this->content  = 'permitpendingapproval/permitpendingapproval_wip_raw';
        ##--slave_combine_to_read--##
        $this->layout($data, $setting);
...
redirect('/');
    ...
    public function shins($id)
    {
        ...
        $this->content  = 'permitpendingapproval/permitpendingapproval_shins_raw';
        ##--slave_combine_to_read--##
        $this->layout($data, $setting);
...
$this->permitall_model->update_driver_vehicle_status($permittype,$driver_vehicle_id, 9);
    ...
    public function wipbriefing($id)
    {
        ...
        $this->content  = 'permitpendingapproval/permitpendingapproval_wipbriefing_raw';
        ##--slave_combine_to_read--##
        $this->layout($data, $setting);
