...
class PdfOutput extends CI_Controller
{
    ...
    public function enforcement_print($id)
    {
        ...
        /*----------  CHILD ENFORCEMENT  ----------*/
        $child_enforcement_list = $this->Enforcement_model->offence_list_history_2020($enforcement_main_det->enforcements_main_id,$enforcement_main_det->enforcements_main_rev_year);
        ...
        foreach ($child_enforcement_list as $r_cel) {
            ...
            $child_result_arr[] = $r_cel->off_cat_name . ' | ' . $r_cel->offendlist_violationNo . '-' . $r_cel->offendlist_regNo . ' | ' . $r_cel->offendlist_natureViolation;
        }
