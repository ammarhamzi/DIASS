...
/*                      if($this->permission->cp_read == true){
    ...
    {
        $row = $this->adpbriefingmanagement_model->get_slot();
/*    var_dump($row);
exit;*/
        foreach ($row as $value) {
/*            $available  = (int) $value->adpbriefingmanagement_slot - (int) $value->adpbriefingmanagement_slottaken;
            $title = $value->adpbriefingmanagement_location.'-'.$available.'/'. $value->adpbriefingmanagement_slot.'-'. $value->adpbriefingmanagement_category;*/
            $title = $value->adpbriefingmanagement_location.'-'.$value->adpbriefingmanagement_slottaken.'/'. $value->adpbriefingmanagement_slot.'-'. $value->adpbriefingmanagement_category.'-'. $value->adpbriefingmanagement_condition;
...
$color = '#6C3483';
            ...
            $calendar[] = [
                ...
                "color"  => $color,
                "location" => $value->adpbriefingmanagement_location,
                "category" => $value->adpbriefingmanagement_category,
                "condition" => $value->adpbriefingmanagement_condition,
            ];
        }
