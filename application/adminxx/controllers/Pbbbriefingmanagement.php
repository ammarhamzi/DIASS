...
class Pbbbriefingmanagement extends MY_Controller
{
    ...
    public function scheduler()
    {
        ...
        if ($this->permission->showlist == true) {
            ...
            $this->content = 'pbbbriefingmanagement/pbbbriefingmanagement_schedule';
            ##--slave_combine_to_list--##
            $this->layout($data, $setting);
...
//check if parentchild exist
    ...
    {
		if($date){
			$pbbbriefingmanagement_date = $date;
		} else {
        ...
        if ($this->permission->cp_create == true) {
            ...
            $data = [
                ...
                'pbbbriefingmanagement_date' => $pbbbriefingmanagement_date,
...
exit;*/
        foreach ($row as $value) {
            ...
            $calendar[] = [
                ...
                "title" => $value->pbbbriefingmanagement_slottaken."/".$value->pbbbriefingmanagement_slot." Driver(s)",
