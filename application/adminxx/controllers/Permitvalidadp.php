...
class Permitvalidadp extends MY_Controller
{

    public function __construct()
    {
        parent::__construct();
        $this->load->model('permitvalidadp_model');
        ...
        $this->lang->load('permitvalidadp_lang', $this->session->userdata('language'));
    ...
    public function index()
    {
        ...
        if ($this->permission->showlist == true) {
            ...
            $data = [
                ...
                'controller' => 'Permitvalidadp',
                'pagetitle' => 'Active Airside Driving Permits',
            ];
...
//        ];
        ...
        $results = $this->permitvalidadp_model->listajax(
            $location,
            $columns,
           $columnfilter,
...
$r['permit_issuance_serialno'],
        ...
        echo json_encode(
            [
                ...
                "recordsTotal" => $this->permitvalidadp_model->recordsTotal($location)->recordstotal,
                "recordsFiltered" => $this->permitvalidadp_model->recordsTotal($location)->recordstotal,
                'data' => $data
            ]
        );
    }
...
;
/* End of file Permitvalidadp.php */
/* Location: ./application/controllers/Permitvalidadp.php */
