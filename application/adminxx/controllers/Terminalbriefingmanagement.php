...
class Terminalbriefingmanagement extends MY_Controller
{
    ...
    public function scheduler()
    {
        ...
        if ($this->permission->showlist == true) {
            ...
            $this->content = 'terminalbriefingmanagement/terminalbriefingmanagement_schedule';
            ##--slave_combine_to_list--##
            $this->layout($data, $setting);
...
//check if parentchild exist
    ...
    {
		if($date){
			$terminalbriefingmanagement_date = $date;
		} else {
        ...
        if ($this->permission->cp_create == true) {
            ...
            $data = [
                ...
                'terminalbriefingmanagement_date' => $terminalbriefingmanagement_date,
...
exit;*/
        foreach ($row as $value) {
            ...
            $calendar[] = [
                ...
                "title" => $value->terminalbriefingmanagement_slottaken."/".$value->terminalbriefingmanagement_slot." Driver(s)",
