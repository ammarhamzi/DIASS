...
class Permitvalidshins extends MY_Controller
{

    public function __construct()
    {
        parent::__construct();
        $this->load->model('permitvalidshins_model');
        ...
        $this->lang->load('permitvalidshins_lang', $this->session->userdata('language'));
    ...
    public function index()
    {
        ...
        if ($this->permission->showlist == true) {
            ...
            $data = [
                ...
                'controller' => 'Permitvalidshins',
                'pagetitle' => 'Active TEP (Stakeholder - inspection) Permits',
            ];
    ...
    public function get_json($location='all')
    {
        ...
        $results = $this->permitvalidshins_model->listajax(
            $location,
            $columns,
           $columnfilter,
...
$r['permit_issuance_serialno'],
        ...
        echo json_encode(
            [
                ...
                "recordsTotal" => $this->permitvalidshins_model->recordsTotal($location)->recordstotal,
                "recordsFiltered" => $this->permitvalidshins_model->recordsTotal($location)->recordstotal,
                'data' => $data
            ]
        );
    }
...
;
/* End of file Permitvalidshins.php */
/* Location: ./application/controllers/Permitvalidshins.php */
