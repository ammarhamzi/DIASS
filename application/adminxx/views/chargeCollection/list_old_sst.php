...
<div class="container-fluid">
    ...
    <div class="panel panel-info">
        <div class="panel-heading">
            <h4><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span> <?php echo $this->lang->line('titless'); ?> </h4>
        </div>
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                <div class="radio ">
                                    <label><input type="radio" name="payment_method" value="4">Free of Charges</label>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <form class="form-horizontal" action="" method="GET">
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <a href="<?=site_url('PdfOutput/charge_collection?single_date='.$single_date_txt.'&shift='.$working_session.'&payment_method='.$payment_method_id)?>" target="_blank">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" width="100%">
                            <tr bgcolor="#C3C3C3">
                                ...
                                <td>UOM</td>
                                <td>Kadar % SST</td>
                                <td>Kadar Caj (Tanpa SST)</td>
                                <td>Kuantiti</td>
                                <td>Amaun (RM) Tanpa SST</td>
                                <td>SST Amaun</td>
                                <td>Amaun (RM) Dengan SST</td>
                            </tr>
                            <?php 
                            if(count($charge_type_output) > 0)
                            {
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="text-right"><?=number_format($sst,2)?></td>
                                        <td class="text-right"><?=number_format($price_with_sst,2)?></td>
                                    </tr>
                                <?php
                                }
                            }
