<div class="container-fluid">
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo site_url('examtopic');?>"><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span> <?php echo $this->lang->line('examtopic');?> <?php echo $this->lang->line('list');?></a></li>
    ...
    <div class="panel panel-info">
        <div class="panel-heading">
            <h4><span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
                <?php echo $this->lang->line('examtopic');?>
                <?php echo $button ?>
            </h4>
        </div>
        <div class="panel-body">
            ...
            <?php echo $this->lang->line('examtopic_title');?> <sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('examtopic_title') ?>
          </label>
                            <div class="col-md-9"><input type="text" class="form-control" name="examtopic_title" id="examtopic_title" placeholder="<?php echo $this->lang->line('examtopic_title');?>" value="<?php echo $examtopic_title; ?>" maxlength="255" />
                            </div>
                        </div>

                        <div class="row">
                            <label class="col-md-3 text-right">
            <?php echo $this->lang->line('examtopic_description');?> <?php echo form_error('examtopic_description') ?>
          </label>
                            <div class="col-md-9"><textarea class="form-control" name="examtopic_description" id="examtopic_description" placeholder="<?php echo $this->lang->line('examtopic_description');?>" rows="5" cols="50"><?php echo $examtopic_description; ?></textarea>
                            </div>
                        </div>

                        <div class="row">
                            <div class="col-md-offset-3 col-md-9">
                                <input type="hidden" name="examtopic_id" value="<?php echo (isset($id)?$id:" "); ?>" />
                                ...
                                <a href="<?php echo site_url('examtopic') ?>" class="btn btn-default"><span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span> <?php echo $this->lang->line('back');?></a>
                            </div>
                        </div>
                    </form>
                </div>
