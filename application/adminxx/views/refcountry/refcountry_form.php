...
<div class="container-fluid">
    ...
    <div class="panel panel-info">
        <div class="panel-heading">
            <h4><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> <?php echo $this->lang->line('refcountry'); ?> <?php echo $button; ?></h4>
        </div>
                    ...
                    <form action="<?php echo $action; ?>" method="post">
                        ...
                        <div class="row">
                            <label class="col-md-3 text-right">
                                <?php echo $this->lang->line('ref_country_iso'); ?> <sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('ref_country_iso'); ?>
                            </label>
                            <div class="col-md-9"><input type="text" class="form-control" name="ref_country_iso" id="ref_country_iso" placeholder="<?php echo $this->lang->line('ref_country_iso'); ?>" value="<?php echo $ref_country_iso; ?>" maxlength="2"/>
                                          </div></div>

                        <div class="row">
                            <label class="col-md-3 text-right">
                                <?php echo $this->lang->line('ref_country_name'); ?> <sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('ref_country_name'); ?>
                            </label>
                            <div class="col-md-9"><input type="text" class="form-control" name="ref_country_name" id="ref_country_name" placeholder="<?php echo $this->lang->line('ref_country_name'); ?>"value="<?php echo $ref_country_name; ?>" maxlength="80" />
                                         </div></div>

                        <div class="row">
                            <label class="col-md-3 text-right">
                                <?php echo $this->lang->line('ref_country_printable_name'); ?> <sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('ref_country_printable_name'); ?>
                            </label>
                            <div class="col-md-9"><input type="text" class="form-control" name="ref_country_printable_name" id="ref_country_printable_name" placeholder="<?php echo $this->lang->line('ref_country_printable_name'); ?>"value="<?php echo $ref_country_printable_name; ?>" maxlength="80" />
                                         </div></div>


                        <div class="row">
                            <label class="col-md-3 text-right">
                                <?php echo $this->lang->line('ref_country_iso3'); ?> <?php echo form_error('ref_country_iso3'); ?>
                            </label><div class="col-md-9"><input type="text" class="form-control" name="ref_country_iso3" id="ref_country_iso3" placeholder="<?php echo $this->lang->line('ref_country_iso3'); ?>" value="<?php echo $ref_country_iso3; ?>" maxlength="3"/>
                                          </div></div>


                        <div class="row">
                            <label class="col-md-3 text-right">
                                <?php echo $this->lang->line('ref_country_numcode'); ?> <?php echo form_error('ref_country_numcode'); ?>
                            </label><div class="col-md-9"><input type="text" class="form-control isInteger" name="ref_country_numcode" id="ref_country_numcode" placeholder="<?php echo $this->lang->line('ref_country_numcode'); ?>" value="<?php echo $ref_country_numcode; ?>" maxlength="6" />
                                         </div></div>

                        <div class="row">
                            <div class="col-md-offset-3 col-md-9">
                                <input type="hidden" name="ref_country_id" value="<?php echo (isset($id)
    ? $id : "");
?>" />
