...
<h4><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> <?php echo $this->lang->line('tepstakeholdermanagement');?> <?php echo $button ?></h4>
  </div>
...
<div class="row">
          <label class="col-md-3 text-right">
            <?php echo $this->lang->line('tepstakeholdermanagement_date');?> <sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('tepstakeholdermanagement_date') ?>
          </label>
<div class="col-md-9"><input type="text" class="form-control datepicker" name="tepstakeholdermanagement_date" id="tepstakeholdermanagement_date" placeholder="<?php echo $this->lang->line('tepstakeholdermanagement_date');?>" value="<?php echo $tepstakeholdermanagement_date; ?>" />
         </div></div>

<div class="row">
          <label class="col-md-3 text-right">
            <?php echo $this->lang->line('tepstakeholdermanagement_location');?> <sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('tepstakeholdermanagement_location') ?>
          </label>

<div class="col-md-9"><select class="form-control select2" name="tepstakeholdermanagement_location" id="tepstakeholdermanagement_location">
<option value="">-SELECT-</option>
<?php
foreach ($dropdown_tepstakeholdermanagement_location as $value) {

if($value->id===$tepstakeholdermanagement_location ){
?>
<option value="<?php echo $value->id;?>" <?php echo set_select('tepstakeholdermanagement_location', $value->id, TRUE); ?>><?php echo $value->value;?></option>
<?php
}else{
?>
<option value="<?php echo $value->id;?>" <?php echo set_select('tepstakeholdermanagement_location', $value->id); ?>><?php echo $value->value;?></option>
<?php
}
}
?>
...
<div class="row">
          <label class="col-md-3 text-right">
            <?php echo $this->lang->line('tepstakeholdermanagement_slot');?> <sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('tepstakeholdermanagement_slot') ?>
          </label>
<div class="col-md-9"><input type="text" class="form-control isInteger" name="tepstakeholdermanagement_slot" id="tepstakeholdermanagement_slot" placeholder="<?php echo $this->lang->line('tepstakeholdermanagement_slot');?>" value="<?php echo $tepstakeholdermanagement_slot; ?>" maxlength="10" />
         </div></div>


<div class="row">
          <label class="col-md-3 text-right">
            <?php echo $this->lang->line('tepstakeholdermanagement_remark');?> <?php echo form_error('tepstakeholdermanagement_remark') ?>
          </label><div class="col-md-9"><input type="text" class="form-control" name="tepstakeholdermanagement_remark" id="tepstakeholdermanagement_remark" placeholder="<?php echo $this->lang->line('tepstakeholdermanagement_remark');?>"value="<?php echo $tepstakeholdermanagement_remark; ?>" maxlength="500" />
         </div></div>
         
<div class="row">
<div class="col-md-offset-3 col-md-9">
         <input type="hidden" name="tepstakeholdermanagement_id" value="<?php echo (isset($id)?$id:""); ?>" />
         ...
         <a href="<?php echo site_url('tepstakeholdermanagement') ?>" class="btn btn-default"><span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span> <?php echo $this->lang->line('back');?></a>
    </div>
</div>
      </form>
      </div>
