...
<ol class="breadcrumb">
  ...
  <li class="active"><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span> <?php echo $this->lang->line('tepstakeholdermanagement');?> <?php echo $this->lang->line('list');?></li>
</ol>
...
<div class="panel panel-info">
  <div class="panel-heading">
         <h4><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span> <?php echo $this->lang->line('tepstakeholdermanagement');?> <?php echo $this->lang->line('list');?></h4>
  </div>
  <div class="panel-body">
            ...
            <table id="mytable" class="table" style="width: 100% !important">
               ...
               <thead>
                  <tr>
                     <th class="no-sort">#</th>
                     <th><?php echo $this->lang->line('tepstakeholdermanagement_date');?></th>
<th><?php echo $this->lang->line('tepstakeholdermanagement_location');?></th>
<th><?php echo $this->lang->line('tepstakeholdermanagement_slot');?></th>
...
<th><?php echo $this->lang->line('tepstakeholdermanagement_slot');?></th>
      ...
      <script type="text/javascript">
        ...
        "processing": true,
        "serverSide": true,
        "ajax": "<?php echo site_url() ?>/tepstakeholdermanagement/get_json",
               responsive: true,
         dom: 'lfrBtip',
         buttons: [
          <?php
         ...
         {                 text: '<span class="glyphicon glyphicon-plus" aria-hidden="true"></span> <?php echo $this->lang->line("add_new");?>',
             action: function ( e, dt, node, config ) {
                 redirect("<?php echo site_url('tepstakeholdermanagement/create');?>");
             } },
         <?php }?>
          <?php
