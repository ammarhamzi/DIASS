    ...
    ?>
                    <div class="box  box-primary">
                        <div class="box-header with-border">
                                    ...
                                    <h3 class="box-title">SHINS Inspection calendar</h3>
    ...
    $(document).ready(function() {
        $(function() {
            ...
            $('#calendar').fullCalendar({
                ...
                defaultView: 'month',
                events: {
                    url: '/admin/tepstakeholdermanagement/get_availableslot/',
                    type: 'POST',
                    data: {},
                    error: function() {
...
$(location).attr('href', "/admin/permitpendinginspection/list/shins/"+moment(calEvent.start).format('YYYY-MM-DD'));
                    }
                }
            })
        });
