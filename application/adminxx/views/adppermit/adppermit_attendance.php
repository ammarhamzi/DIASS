    ...
    ?>
                    <div class="box  box-primary">
                        <div class="box-header with-border">
                                    ...
                                    <h3 class="box-title">Briefing Attendance (ADP)</h3>
    ...
    $(document).ready(function() {
        $(function() {
            ...
            $('#calendar').fullCalendar({
                ...
                defaultView: 'month',
                events: {
                    url: '/admin/Adpbriefingmanagement/get_availableslot',
                    type: 'POST',
                    data: {},
                    error: function() {
                        alert('No data found!');
                ...
                eventClick: function(calEvent, jsEvent, view) {
                    ...
                    //} else {
//$(location).attr('href', "/admin/adppermit/briefingattend/"+moment(calEvent.start).format('YYYY-MM-DD'));
$(location).attr('href', "/admin/adppermit/briefingattend2/"+moment(calEvent.start).format('YYYY-MM-DD')+"/"+calEvent.location+"/"+calEvent.category);
                    //}
                }
            })
        });
