...
<ol class="breadcrumb">
  ...
  <li class="active"><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span> <?php echo $this->lang->line('ffpbbbriefingmanagement');?> <?php echo $this->lang->line('list');?></li>
</ol>
    ...
    ?>
                    <div class="box  box-primary">
                        <div class="box-header with-border">
                                    ...
                                    <h3 class="box-title"><?php echo $this->lang->line('ffpbbbriefingmanagement');?></h3>
            ...
            <table id="mytable" class="table" style="width: 100% !important">
               ...
               <thead>
                  <tr>
                     <th class="no-sort">#</th>
                     <th><?php echo $this->lang->line('ffpbb_briefingmanagement_date');?></th>
<th><?php echo $this->lang->line('ffpbb_briefingmanagement_category');?></th>
<th><?php echo $this->lang->line('ffpbb_briefingmanagement_location');?></th>
<th><?php echo $this->lang->line('ffpbb_briefingmanagement_slot');?></th>
<th>Remark</th>
                     <th class="no-sort">&nbsp;</th>
                  </tr>
               </thead>
...
<th>Remark</th>
      ...
      <script type="text/javascript">
        ...
        "processing": true,
        "serverSide": true,
        "ajax": "<?php echo site_url() ?>/ffpbbbriefingmanagement/get_json",
               responsive: true,
         dom: 'lfrBtip',
         buttons: [
          <?php
         ...
         {                 text: '<span class="glyphicon glyphicon-plus" aria-hidden="true"></span> <?php echo $this->lang->line("add_new");?>',
             action: function ( e, dt, node, config ) {
                 redirect("<?php echo site_url('ffpbbbriefingmanagement/create');?>");
             } },
         <?php }?>
          <?php
