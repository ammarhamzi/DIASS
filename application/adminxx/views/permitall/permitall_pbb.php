...
<?php
if(empty($pbbpermit_attendpbbbriefing)){
?>
    <div class="col-md-3">

    <p>Assessment Date: </p><input id="change_opdate" name="change_opdate" type="text" class="datepicker_local" value="<?php echo datelocal($pbbpermit_course_date);?>">
    <input id="current_opdate" type="hidden" name="current_opdate" value="<?php echo $pbbpermit_course_date;?>">
        <input id="change_opdate_button" name="change_opdate_button" type="button" value="Change"></div>
<?php
}else{
?>
        <div class="col-md-3"><p>Assessment Date: <b><?php echo datelocal($pbbpermit_course_date);?></b></p></div>
<?php
}
?>

    <div class="col-md-3"><p>Location: <b><?php echo ($pbbpermit_course_location?$pbbpermit_course_location:"KLIA");?></b></p></div>
    <div class="col-md-3"><p>Session: <b><?php echo ($pbbpermit_course_session?$pbbpermit_course_session:"All Day");?></b></p></div>
</div>
<br>
                <!-- Nav tabs -->
...
<!--                <br>
                <div class="panel panel-default">
                    <div class="panel-body">
                        <form id="submitform" name="submitform" action="/admin/permitall/pbb_submit/" method="POST">
                            <div class="row">
                                <h3>Your Action</h3>
...
$("#change_opdate_button").click(function () {
 $.ajax({
 	...
 	url: "<?php echo base_url() ?>permitall/change_opdate/pbb",
 	success: function(data) {
      alert(data);
 	},
