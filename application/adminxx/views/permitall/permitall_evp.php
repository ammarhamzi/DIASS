...
?>
<li><a href="<?php echo site_url('permitpendinginspection/list/evp/'.$evppermit_inspection_date); ?>"><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span> Inspection List</a></li>
        <li class="active"><span class="glyphicon glyphicon-file" aria-hidden="true"></span>
            Inspection Detail
        </li>
    <?php
...
<?php
if(empty($evppermit_result)){
?>
    <div class="col-md-3">

    <p>Inspection Date: </p><input id="change_opdate" name="change_opdate" type="text" class="datepicker_local" value="<?php echo datelocal($evppermit_inspection_date);?>">
    <input id="current_opdate" type="hidden" name="current_opdate" value="<?php echo $evppermit_inspection_date;?>">
        <input id="change_opdate_button" name="change_opdate_button" type="button" value="Change"></div>
<?php
}else{
?>
        <div class="col-md-3"><p>Inspection Date: <b><?php echo datelocal($evppermit_inspection_date);?></b></p></div>
<?php
}
?>

    <div class="col-md-3"><p>Location: <b><?php echo ($evppermit_inspection_location?$evppermit_inspection_location:"KLIA");?></b></p></div>
                            ...
                            <div class="col-md-4">
                                ...
                                <table class="table table-condensed table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-md-6">
                                            <?php echo $evppermit_policyexpirydate; ?>
                                        </td>
                                    </tr>
                    ...
                    <div role="tabpanel" class="tab-pane" id="inspectionresult">
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <p>Date: <b><?php echo datelocal($evppermit_inspection_date); ?></b> </p>
                                    </div>
                                    <div class="col-md-12">
                                        <p>Inspector: <b><?php echo $evppermit_result_inspector_id; ?></b> </p>
                                    </div>
                                    <div class="col-md-12">
...
<h4>Mechanical Engineer :</h4>
                                <div class="row">
                                    <div class="col-md-12">
                                        <p>Date: <b><?php echo datelocal($evppermit_managerverified_date); ?></b> </p>
                                    </div>
                                    <div class="col-md-12">
                  ...
                  <tr>
                     ...
                     <td><?php echo $mtwchecklist->mtwchecklist_name ?></td>
                                ...
                                <td style="text-align:center; white-space: nowrap;">
                                    ...
                                    <?php
                                        echo '<input type="checkbox" value="' .$mtwchecklist->mtwchecklist_id. '" ' .(in_array($mtwchecklist->mtwchecklist_id, $evp_selfchecked_selected)?"checked":""). ' disabled>';
                                    ?>
                                    </div>
                                </td>
                                <td style="text-align:left; white-space: nowrap;">
                                    ...
                                    <?php
                                        //echo '<input type="checkbox" value="' .$mtwchecklist->mtwchecklist_id. '" ' .(in_array($mtwchecklist->mtwchecklist_id, $evp_mtwchecked_selected)?"checked":""). ' disabled>';
                                    ?>
                                            <input type="radio" name="mtwinspect_<?php echo $mtwchecklist->mtwchecklist_id;?>"  value="y" <?php echo (in_array($mtwchecklist->mtwchecklist_id, $evp_mtwchecked_y_selected)?"checked":"");?> disabled
                                            /> <span style="color: #00CC00">PASS</span>
                                            <br>
                                            <input type="radio" name="mtwinspect_<?php echo $mtwchecklist->mtwchecklist_id;?>" value="n" <?php echo (in_array($mtwchecklist->mtwchecklist_id, $evp_mtwchecked_n_selected)?"checked":"");?> disabled
                                            /> <span style="color: #CC0000">FAIL</span>
                                            <br>
                                            <input type="radio" name="mtwinspect_<?php echo $mtwchecklist->mtwchecklist_id;?>" value="n/a" <?php echo (in_array($mtwchecklist->mtwchecklist_id, $evp_mtwchecked_na_selected)?"checked":"");?> disabled
...
$("#change_opdate_button").click(function () {
 $.ajax({
 	...
 	url: "<?php echo base_url() ?>permitall/change_opdate/evp",
 	success: function(data) {
      alert(data);
 	},
