...
<?php
/*echo $permit_status.'<----------------';*/
if($permit_status=='paymentpending' or $permit_officialstatus=='completed' or $permit_officialstatus=='paid' or $permit_status=='permitterminationpending' or $permit_status=='permitreplacementpending'){
?>
<?php
if($permit_status!='paymentpending'){
?>
...
else if($permit_status=='examfailed'){
    echo '<li role="presentation"><a href="#competencytest" aria-controls="competencytest" role="tab" data-toggle="tab">Competency Test</a></li>';
}
?>
                            ...
                            <div class="col-md-5">
                                <table class="table table-condensed table-responsive">
                                    <tr>
                                        ...
                                        <td class="col-md-9">
                                            <?php echo $driver_name; ?> (<a href="/admin/Enforcement/create_driver/?i=<?php echo $driver_id;?>" target="_blank">detail</a>)
                                        </td>
                                    </tr>
                                    <tr>
                                        <th class="col-md-3 text-right">
                            ...
                            <div class="col-md-4">
                                <table class="table">
                                    ...
                                    <tr>
                                        <th>Training Date:</th>
                                        <td>
                                            <?php echo ($adppermit_certbytrainer_date?datelocal($adppermit_certbytrainer_date):"<i>NA</i>");?>
                                        </td>
                                    </tr>
                                    <tr>
