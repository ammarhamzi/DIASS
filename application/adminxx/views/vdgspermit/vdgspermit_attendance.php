    ...
    ?>
                    <div class="box  box-primary">
                        <div class="box-header with-border">
                                    ...
                                    <h3 class="box-title">Briefing Attendance (Visual Docking Guidance System)</h3>
    ...
    $(document).ready(function() {
        $(function() {
            ...
            $('#calendar').fullCalendar({
                ...
                defaultView: 'month',
                events: {
                    url: '/admin/Ffvdgsbriefingmanagement/get_availableslot',
                    type: 'POST',
                    data: {},
                    error: function() {
                        alert('No data found!');
                ...
                eventClick: function(calEvent, jsEvent, view) {
                    ...
                    //} else {
//$(location).attr('href', "/admin/vdgspermit/briefingattend/"+moment(calEvent.start).format('YYYY-MM-DD'));
$(location).attr('href', "/admin/vdgspermit/briefingattend2/"+moment(calEvent.start).format('YYYY-MM-DD')+"/"+calEvent.location);
                    //}
                }
            })
        });
