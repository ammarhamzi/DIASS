    ...
    ?>
                    <div class="box  box-primary">
                        <div class="box-header with-border">
                                    ...
                                    <h3 class="box-title">Briefing Attendance (EVDP)</h3>
    ...
    $(document).ready(function() {
        $(function() {
            ...
            $('#calendar').fullCalendar({
                ...
                defaultView: 'month',
                events: {
                    url: '/admin/Evdpbriefingmanagement/get_availableslot',
                    type: 'POST',
                    data: {},
                    error: function() {
                ...
                eventClick: function(calEvent, jsEvent, view) {
                    ...
                    //} else {
$(location).attr('href', "/admin/evdppermit/briefingattend2/"+moment(calEvent.start).format('YYYY-MM-DD')+"/"+calEvent.location);
                    //}
                }
            })
        });
