...
<!--                                 <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                        ...
                        <form role="form" id="submitform" name="submitform" action="/admin/permitpendingdocscheckvehicle/avp_submit/" method="POST">
                                <div class="box-body">
...
<?php echo ($permit_apply_remark?$permit_apply_remark:"<i>- No Remark -</i>");?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="activitydate" name="activitydate" class="form-control datepicker_local_insurancedate" value="<?php echo datelocal($avppermit_inspection_date);?>">
                                </div>
...
<input type="hidden" id="current_activitydate" name="current_activitydate" value="<?php echo $avppermit_inspection_date;?>">
