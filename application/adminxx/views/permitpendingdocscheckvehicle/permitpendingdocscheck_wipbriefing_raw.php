...
<!--                                 <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                        ...
                        <form role="form" id="submitform" name="submitform" action="/admin/permitpendingdocscheckvehicle/wipbriefing_submit/" method="POST">
                                <div class="box-body">
...
?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="activitydate" name="activitydate" class="form-control datepicker_local_insurancedate" value="<?php echo datelocal($wipbriefingpermit_course_date);?>">
                                </div>
                                <div class="form-group">
...
<input type="hidden" name="needescort" id="needescort" value="<?php echo $wipbriefingpermit_needescort; ?>">
                    </div>
                    </form>
                </div>
</div>
