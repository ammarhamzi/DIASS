<div class="container-fluid">
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo site_url('examanswerlist');?>"><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span> <?php echo $this->lang->line('examanswerlist');?> <?php echo $this->lang->line('list');?></a></li>
    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            ...
            <?php echo $this->lang->line('examanswerlist_content');?> <sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('examanswerlist_content') ?>
          </label>
                            <div class="col-md-9"><input type="text" class="form-control" name="examanswerlist_content" id="examanswerlist_content" placeholder="<?php echo $this->lang->line('examanswerlist_content');?>" value="<?php echo $examanswerlist_content; ?>" maxlength="255"
                                />
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <label class="col-md-3 text-right">
            <?php echo $this->lang->line('examanswerlist_correctanswer');?> <sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('examanswerlist_correctanswer') ?>
          </label>

                            <div class="col-md-9"><select class="form-control select2" name="examanswerlist_correctanswer" id="examanswerlist_correctanswer">
<option value="">-SELECT-</option>
<?php
foreach ($dropdown_examanswerlist_correctanswer as $value) {

if($value->id===$examanswerlist_correctanswer ){
?>
<option value="<?php echo $value->id;?>" <?php echo set_select('examanswerlist_correctanswer', $value->id, TRUE); ?>><?php echo $value->value;?></option>
<?php
}else{
?>
<option value="<?php echo $value->id;?>" <?php echo set_select('examanswerlist_correctanswer', $value->id); ?>><?php echo $value->value;?></option>
<?php
}
}
?>
                        ...
                        <div class="row">
                            <div class="col-md-offset-3 col-md-9">
                                <input type="hidden" name="examanswerlist_id" value="<?php echo (isset($id)?$id:" "); ?>" />
                                <input type="hidden" name="examanswerlist_examquestion_id" value="<?php echo (isset($parent_id)?$parent_id:" "); ?>" />
                                ...
                                <a href="<?php echo site_url('examquestion/read/'.$parent_id) ?>" class="btn btn-default"><span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span> <?php echo $this->lang->line('back');?></a>
                            </div>
                        </div>
                    </form>
                </div>
