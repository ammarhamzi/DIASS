...
<div class="container-fluid">
  <ol class="breadcrumb">
    ...
    <li class="active"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> <?php echo $this->lang->line('wipinspection_verification_form');?></li>
  </ol>
  <div class="panel panel-info">
    <div class="panel-heading">
      <h4><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> <?php echo $this->lang->line('wipinspection_verification');?></h4>
    </div>
                  ...
                  <table class="table table-bordered table-condensed table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="text-center"><input data-chktype="chkmtwman" class="inspection" type="checkbox" value="<?php echo $requirement->wipchecklist_id ?>" id="<?php echo 'chkmtw' . $requirement->wipchecklist_id ?>" <?php if($requirement->wipchecklist_mtwmanagerchecked=='y') echo 'checked' ?>></td>
                      </tr>
                      <?php
                          }
                          else 
                  ...
                  <table class="table table-bordered table-condensed table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="text-center"><input data-chktype="chkmtwman" class="inspection" value="<?php echo $requirement->wipchecklist_id ?>" type="checkbox" id="<?php echo 'chkmtw' . $requirement->wipchecklist_id ?>" <?php if($requirement->wipchecklist_mtwmanagerchecked=='y') echo 'checked' ?>></td>
                      </tr>
                      <?php
                          }
                          else 
