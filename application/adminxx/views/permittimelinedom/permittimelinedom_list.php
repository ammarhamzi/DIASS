        ...
        <div class="panel-body">
            ...
            <table id="mytable" class="table" style="width: 100% !important">
                ...
                <tbody>
                    <?php
$start = 0;
if ($permittimelinedom_data) {

    foreach ($permittimelinedom_data as $permittimelinedom) {
        ?>
                        <tr>
                            <td>
                                <?php echo ++$start; ?>
                            ...
                            <td style="text-align:center; white-space: nowrap;">
                                <div class="btn-group" role="group" aria-label="...">
                                    ...
                                    <?php
$id = fixzy_encoder($permittimelinedom->permit_timeline_id);
        if ($permission->cp_read == true) {
            echo anchor(site_url('permittimelinedom/read/' . $id),
        ...
        if ($permission->cp_update == true) {
            ...
            echo anchor(site_url('permittimelinedom/update/' . $id),
        ...
        if ($permission->cp_delete == true) {
            ...
            echo anchor(site_url('permittimelinedom/delete/' . $id),
...
if ($permission->cp_create == true) {
    ?> {
                    ...
                    action: function(e, dt, node, config) {
                        redirect("<?php echo site_url('permittimelinedom/create'); ?>");
                    }
                },
                <?php }?>
                <?php
