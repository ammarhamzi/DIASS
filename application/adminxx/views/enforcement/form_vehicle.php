...
<div class="container-fluid">
    ...
    <form id="frm_add_main_offence" action="<?=site_url('Enforcement/create_vehicle_action')?>" method="POST">
                ...
                <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                ...
                                <div class="col-md-7">
                                    <strong>Type</strong>
                                    <p class="text-muted">
                                        <?=$vehicle_det->vehicle_type?>
                                    </p>

                                    <strong>Reg Number</strong>
                                    <p class="text-muted">
                                        <?=$vehicle_det->vehicle_registration_no?>
                                    </p>

                                    <strong>Manufacturing Year</strong>
                                    <p class="text-muted">
                                        <?=$vehicle_det->vehicle_year_manufacture?>
                                    </p>

                                    <!-- <strong>AVP Number</strong>
                                    <p class="text-muted">
                                        bss
                                    </p> -->
                                </div>
                        ...
                        <div class="">
                            <ul class="nav nav-pills nav-justified">
                                <li class="active"><a href="#tab_historyv" data-toggle="pill">History</a></li>
                                <li><a href="#tab_addoffencev" data-toggle="pill">Add Offence</a></li>
                            
                            </ul>
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab_historyv">
                                        ...
                                        <div class="box-body">
                                            <table id="mytable" class="table" style="width: 100% !important">
                                                <thead>
                                                    <tr>
                                                        <th>#</th>
                                                        <th width="20%"><?php echo 'Date Submit';//$this->lang->line('user_username'); ?></th>
                                                        <th><?php echo 'Submit By';//$this->lang->line('user_username'); ?></th>
                                                        <th><?php echo 'AVP No';//$this->lang->line('user_username'); ?></th>
                                                        ...
                                                        foreach ($history_list as $r) {
                                                          ...
                                                          <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                {
                                                                ?>
                                                                    <span class="<?=$status_label_color?>"><?php echo $r->enforcements_main_status; ?></span></td>
                                                                <?php 
                                                                }
                                                                ?>
                                ...
                                <div class="tab-pane " id="tab_addoffencev">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h4>Offence Details &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <label>AVP No</label>
                                                <input type="text" class="form-control" name="adpadv_no" id="adpadv_no">
                                            </div>
                                            <div class="form-group">
                                                <label>Remarks</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-3">
                                            <input type="hidden" name="vehicless" value="<?php echo (isset($ids) ? $ids : ""); ?>" />
                                            <input type="hidden" name="period_date_suspension" id="period_date_suspension" value="0">
                            ...
                            <select class="form-control select2" name="addOffence_type" id="addOffence_type" style="width: 100% !important;" >
                                ...
                                ?>
                                    <optgroup label="<?=$parent_arr['type']?>">
                                        ...
                                        {
                                        ?>
                                            <option value="<?=$roffence_type->offendlist_id?>" title="<?=htmlspecialchars($roffence_type->offendlist_natureViolation)?><br /><strong>Suspension Period : <?=$roffence_type->offendlist_period?> Days</strong>"><?=$roffence_type->offendlist_violationNo?> - <?=$roffence_type->offendlist_regNo?></option>
                                        <?php
                                        }
                                        ?>
                                    </optgroup>
    ...
    <div class="modal fade" id="modal_cancel_offence">
      <div class="modal-dialog">
        <div class="modal-content">
          <!-- <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
    ...
    <div class="modal fade" id="modal_cancel_reason_view">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
...
<script>
    ...
    $(document).ready(function ()
    {
            ...
            $.ajax({
                ...
                success : function(data)
                {
                    ...
                    setInterval(function(){
                        location.href="<?=site_url('Enforcement/create_vehicle/?i='.$ids)?>";
                    }, 1000);
                },
                complete : function()
                {
        ...
        $('#addOffence_type').on('change',function(){
            ...
            $('.span_description_offence').html(txt[0].title); 
        });
