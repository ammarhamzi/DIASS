...
<!--                                 <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                        ...
                        <form role="form" id="submitform" name="submitform" action="/admin/permitpendingdocscheck/vdgs_submit/" method="POST">
                                <div class="box-body">
...
<?php echo ($permit_apply_remark?$permit_apply_remark:"<i>- No Remark -</i>");?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="activitydate" name="activitydate" class="form-control datepicker_local_insurancedate"  value="<?php echo datelocal($vdgspermit_course_date);?>">
                                </div>
                                <div class="form-group">
...
<input type="hidden" id="current_activitydate" name="current_activitydate" value="<?php echo $vdgspermit_course_date;?>">
