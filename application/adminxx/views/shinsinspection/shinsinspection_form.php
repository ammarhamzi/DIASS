...
<div class="container-fluid">
  <ol class="breadcrumb">
    ...
    <li class="active"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> <?php echo $this->lang->line('shinsinspection_form');?></li>
  </ol>
  <div class="panel panel-info">
    <div class="panel-heading">
      <h4><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> <?php echo $this->lang->line('shinsinspection');?></h4>
    </div>
                  ...
                  <table class="table table-bordered table-condensed table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="text-center"><input data-chktype="chk" class="inspection" type="checkbox" value="<?php echo $requirement->shinschecklist_id ?>" id="<?php echo 'chk' . $requirement->shinschecklist_id ?>" <?php if($requirement->shinschecklist_checked=='y') echo 'checked' ?>></td>
                ...
                <div class="row col-md-12">
                  <table class="table table-bordered table-condensed table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td><?php echo $requirement->shinschecklist_name; ?></td>
                        <td class="text-center"><input data-chktype="chk" class="inspection" value="<?php echo $requirement->shinschecklist_id ?>" type="checkbox" id="<?php echo 'chk' . $requirement->shinschecklist_id ?>" <?php if($requirement->shinschecklist_checked=='y') echo 'checked' ?>></td>
