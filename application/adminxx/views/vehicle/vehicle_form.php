                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <div class="alert alert-warning alert-dismissible">
                                ...
                                if ($permitstatus == 'permitterminated' || $permitstatus == '') {
                                    $disabled = "";
                                    echo "No active permit found. Change company selection enabled.";
                                } else if ($permitstatus == 'completed' || $permitstatus == 'paid') {
                                    $disabled = "disabled";
                                    echo "A " . $permitstatus . " permit found (" . $activepermitno . "). Change company selection disabled.";
                                } else {
                                    $disabled = "disabled";
                                    echo ucfirst($permitstatusdesc) . ". Change company selection disabled.";
                                }
                                ?>
                            </div>
                            <label for="vehicle_company_id"><?php echo $this->lang->line('vehicle_company_id'); ?> <sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('vehicle_company_id') ?></label>
                                <?php
                                echo "<select class='form-control select2' name='vehicle_company_id_dummy' id='vehicle_company_id_dummy' $disabled>";
                                ?>
                            ...
                            <!--<option value="">-SELECT-</option>-->
                                ...
                                foreach ($company as $value) {
                                    ?>
                                <option value="<?php echo $value->company_id; ?>" <?php echo ($value->company_id == trim($vehicle_company_id) ? 'selected="selected"' : ""); ?>><?php echo $value->company_name; ?></option>
                                <?php
                            }
                            ?>
                            </select>
                        ...
                        <div class="row">
                            <div class="col-md-offset-3 col-md-9 text-right">
                                ...
                                <input type="hidden" name="vehicle_company_id_ori" id="vehicle_company_id_ori" value="<?php echo trim($vehicle_company_id); ?>">
                                <input type="hidden" name="vehicle_company_id" id="vehicle_company_id" value="<?php echo trim($vehicle_company_id); ?>">
