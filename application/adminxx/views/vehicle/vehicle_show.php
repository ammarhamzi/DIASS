...
<div class="container-fluid">
    ...
    <form autocomplete="off" id="frm_add_main_offence" action="<?php echo site_url('Enforcement/create_vehicle_action')?>" method="POST">
                ...
                <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-3 ">
                                <div class="small-box bg-red">
                                    <div class="inner">
                                        <h3><?php echo $merit_point_txt?></h3>
                                        <p>Merit Points</p>
                                    </div>
                                    <div class="icon">
                            ...
                            <div class="col-md-9">
                                ...
                                <div class="col-md-7">
                                    ...
                                    <p class="text-muted">
                                        <?php echo (trim($vehicle_det->vehicle_type)=="AV"?"Airside":"Terminal");?>
                                    </p>

                                    <strong>Reg Number</strong>
                                    <p class="text-muted">
                                        <?php echo $vehicle_det->vehicle_registration_no?>
                                    </p>

                                    <strong>Manufacturing Year</strong>
                                    <p class="text-muted">
                                        <?php echo $vehicle_det->vehicle_year_manufacture?>
                                    </p>
                        ...
                        <div class="">
                            <ul class="nav nav-tabs ">
                                <li role="presentation" class="active"><a href="#tab_historyv" aria-controls="tab_history" role="tab" data-toggle="tab">Enforcement History</a></li>
                                                  ...
                                                  <tr>
                                                    ...
                                                    <td style="text-align:center; white-space: nowrap;">
                                                        <div class="btn-group" role="group" aria-label="...">
                                                            <button type="button" class="btn btn-xs btn-default btn_history_offence_list" enc="<?php echo $r->enforcements_main_id?>" title="View Offence List"><i class="fa fa-list"></i></button>
                                                            <?php
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control select2" name="addOffence_type" id="addOffence_type" style="width: 100% !important;" >
                                ...
                                {
                                ?>
                                    <optgroup label="<?php echo $parent_arr['type']?>">
                                        <?php 
                                        foreach($parent_arr['child'] as $roffence_type)
                                        {
                                        ?>
                                            <option value="<?php echo $roffence_type->offendlist_id?>" title="<?php echo $roffence_type->offendlist_natureViolation?>"><?php echo $roffence_type->offendlist_violationNo?> - <?php echo $roffence_type->offendlist_regNo?></option>
                                        <?php
                                        }
                                        ?>
                                    </optgroup>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <input type="text" class="form-control" style="display: none" name="addOffence_time"  id="addOffence_time" placeholder="">
                        </div>
                    </div>
                    <div class="form-group">
