...
Update Attendance
    ...
    <div class="box  box-primary">
        <div class="box-header with-border">
            ...
            <h3 class="box-title">Check Attendance (Ground Power Unit) - <?php echo $course_date;?></h3>
...
if($gpubriefing){
$i=0;
foreach ($gpubriefing as $value) {
$trainer = $value->gpupermit_certbytrainer;
$briefingdate = $value->gpupermit_certbytrainer_date;
/*$permit_id = $value->gpupermit_permit_id;*/
/*print_r($value);*/
?>
                                    <tr>
                                        <td>
                                        ...
                                        <td><input type="checkbox" name="gpupermit_id[]" id="gpupermit_id" value="<?php echo $value->gpupermit_id;?>|<?php echo $value->gpupermit_permit_id;?>" <?php echo ($value->gpupermit_attendgpubriefing=="y"?"checked":"");?> <?php echo (empty($value->gpupermit_completed_docs)?"disabled":"");?>
                                            />
                                    ...
                                    <th>
                                        <?php echo (empty($value->gpupermit_completed_docs)?'<span style="color: #CC0000">Not Approved By MAHB</span>':'Approved');?>
                                    </th>
                                    </tr>
                                    <?php
}
...
<tr>
    ...
    <td><input type="text" name="gpupermit_certbytrainer" id="gpupermit_certbytrainer" value="<?php echo $trainer;?>"></td>
</tr>
<tr>
    <th width="20%">Briefing Date:</th>
    <td><input type="text" name="gpupermit_certbytrainer_date" id="gpupermit_certbytrainer_date" class="datepicker" value="<?php echo $briefingdate;?>"></td>
</tr>
</table>
                        <div class="row">
