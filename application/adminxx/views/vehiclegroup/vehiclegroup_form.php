...
<ol class="breadcrumb">
  ...
  <li><a href="<?php echo site_url('vehiclegroup');?>"><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span> <?php echo $this->lang->line('vehiclegroup');?> <?php echo $this->lang->line('list');?></a></li>
...
<h4><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> <?php echo $this->lang->line('vehiclegroup');?> <?php echo $button ?></h4>
  </div>
...
<div class="row">
          <label class="col-md-3 text-right">
            <?php echo $this->lang->line('vehiclegroup_name');?> <sup><span class="glyphicon glyphicon-star text-danger" aria-hidden="true"></span></sup> <?php echo form_error('vehiclegroup_name') ?>
          </label>
<div class="col-md-9"><input type="text" class="form-control" name="vehiclegroup_name" id="vehiclegroup_name" placeholder="<?php echo $this->lang->line('vehiclegroup_name');?>"value="<?php echo $vehiclegroup_name; ?>" maxlength="155" />
         </div></div>


<div class="row">
          <label class="col-md-3 text-right">
            <?php echo $this->lang->line('vehiclegroup_desc');?> <?php echo form_error('vehiclegroup_desc') ?>
          </label><div class="col-md-9"><input type="text" class="form-control" name="vehiclegroup_desc" id="vehiclegroup_desc" placeholder="<?php echo $this->lang->line('vehiclegroup_desc');?>"value="<?php echo $vehiclegroup_desc; ?>" maxlength="255" />
         </div></div>
         
<div class="row">
<div class="col-md-offset-3 col-md-9">
         <input type="hidden" name="vehiclegroup_id" value="<?php echo (isset($id)?$id:""); ?>" />
         ...
         <a href="<?php echo site_url('vehiclegroup') ?>" class="btn btn-default"><span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span> <?php echo $this->lang->line('back');?></a>
    </div>
</div>
      </form>
      </div>
