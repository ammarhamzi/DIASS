...
Update Attendance
    ...
    <div class="box  box-primary">
        <div class="box-header with-border">
            ...
            <h3 class="box-title">Check Attendance (Preconditioned Air Unit) - <?php echo datelocal($course_date);?></h3>
...
if($pcabriefing){
$i=0;
foreach ($pcabriefing as $value) {
$trainer = $value->pcapermit_certbytrainer;
$briefingdate = $value->pcapermit_certbytrainer_date;
/*$permit_id = $value->pcapermit_permit_id;*/
/*print_r($value);*/
?>
                                    <tr>
                                        <td>
                                        ...
                                        <td><input type="checkbox" name="pcapermit_id[]" id="pcapermit_id" value="<?php echo $value->pcapermit_id;?>|<?php echo $value->pcapermit_permit_id;?>" <?php echo ($value->pcapermit_attendpcabriefing=="y"?"checked":"");?> <?php echo (empty($value->pcapermit_completed_docs)?"disabled":"");?>
                                            />
                                    ...
                                    <th>
                                        <?php echo (empty($value->pcapermit_completed_docs)?'<span style="color: #CC0000">Not Approved By MAHB</span>':'Approved');?>
                                    </th>
                                    </tr>
                                    <?php
}
...
<tr>
    ...
    <td><input type="text" name="pcapermit_certbytrainer" id="pcapermit_certbytrainer" value="<?php echo $trainer;?>"></td>
</tr>
<tr>
    <th width="20%">Briefing Date:</th>
    <td><input type="text" name="pcapermit_certbytrainer_date" id="pcapermit_certbytrainer_date" class="datepicker" value="<?php echo $briefingdate;?>"></td>
</tr>
</table>
                        <div class="row">
