    ...
    ?>
                    <div class="box  box-primary">
                        <div class="box-header with-border">
                                    ...
                                    <h3 class="box-title">Briefing Attendance (Preconditioned Air Unit)</h3>
...
$(location).attr('href', "/admin/pcapermit/briefingattend/"+moment(calEvent.start).format('YYYY-MM-DD'));
                    }
                }
            })
        });
