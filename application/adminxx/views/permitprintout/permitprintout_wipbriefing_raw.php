...
<table width="100%" cellpadding="0" cellspacing="0" style="">
	...
	<tr><td valign="top" colspan="2">
		<table width="100%">
			...
			<p>Pintu Masuk / Keluar: <br><strong><?php echo $wipbriefingpermit_entrypost;?></strong></p>
...
?>
			<p>Nama Steerman <strong><?php echo $wipbriefingpermit_steerman_name;?></strong></p>
            <p>IC Steerman <strong><?php echo $wipbriefingpermit_steerman_icno;?></strong></p>
            <p>Tarikh Tamat ADP <strong><?php echo $wipbriefingpermit_steerman_adpexpirydate;?></strong></p>
<?php
            }
			?>
