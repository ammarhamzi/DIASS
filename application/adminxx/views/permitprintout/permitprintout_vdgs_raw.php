...
<table width="100%" cellpadding="0" cellspacing="0">
    <tr><td><img src="<?php echo base_url('../resources/shared_img/print_permit/logo.png');?>" width="50" style="padding:8px;"></td><td align="right" style="font-size: 10px; font-weight: 800; padding-right: 8px;">FF<font color="red"><?php echo str_replace("FF","",$permit_issuance_serialno);?></font></td></tr>
    ...
    <tr><td align="center" width="40%" valign="bottom"><img src="<?php echo base_url('../uploads/files/'. ($driver_photo->uploadfiles_filename?$driver_photo->uploadfiles_filename:'no-image-single.png'));?>" style="border:1px solid #000;" width="70" height="110"></td>
        <td valign="top">
            <table width="100%"  cellpadding="0" cellspacing="0"  >
                <tr>
				<td width="5"><img src="<?php echo base_url('../resources/shared_img/print_permit/spacer.jpg');?>" width="5"></td>
