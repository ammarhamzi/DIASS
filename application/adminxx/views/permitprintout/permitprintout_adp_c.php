...
<table width="100%" cellpadding="0" cellspacing="0">
    <tr><td><img src="<?php echo base_url('../resources/shared_img/print_permit/logo.png');?>" width="50" style="padding:4px; padding-bottom:1px;"></td><td align="right" style="font-size: 10px; font-weight: 800; padding-right: 10px;">ADP<font color="red"><?php echo str_replace("ADP","",$permit_issuance_serialno);?></font></td></tr>
	...
	<img src="<?php echo base_url('../uploads/files/'. ($driver_photo->uploadfiles_filename?$driver_photo->uploadfiles_filename:'no-image-single.png'));?>" style="border:1px solid #000;" width="70" height="110"></td>
        <td valign="bottom">
            <table width="100%"  cellpadding="0" cellspacing="0"  >
				...
				<td  align="center"  valign="bottom" style="padding:0"><font style="padding:0; font-size:70px; font-weight: bold; color:#ffcc01; font-family:'Arial Black'">C </font>
    ...
    <tr><td colspan="2" align="center"><img src="<?php echo base_url('../resources/shared_img/print_permit/signature.jpg');?>"  width="80"></td></tr>
    <tr><td colspan="2"><img src="<?php echo base_url('../resources/shared_img/print_permit/footer_c_new.jpg');?>" width="100%"></td></tr>
</table>
    </body>
</html>