...
<body>
    ...
    <tr><td align="center" style="font-size: 18px; font-weight: 800; padding-top: 2px; padding-bottom: 2px;"><?php echo $permit_companyid; ?></td></tr>
    <tr><td align="center" style="font-size: 10px; font-weight: 400; ">AVP NO.</font></td></tr>
    <tr><td align="center" style="font-size: 18px; font-weight: 800; padding-top: 2px; padding-bottom: 2px;">TEP<font color="red"><?php echo str_replace("TEP","",$permit_issuance_serialno); ?></font></td></tr>
</table>
</body>
</html>