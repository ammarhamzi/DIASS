...
<table width="100%" cellpadding="0" cellspacing="0" >
	...
	<img src="<?php echo base_url('../uploads/files/'. ($driver_photo->uploadfiles_filename?$driver_photo->uploadfiles_filename:'no-image-single.png'));?>" style="border:1px solid #000;" width="70" height="110"></td>
        <td valign="bottom">
            <table width="100%"  cellpadding="0" cellspacing="0"  >
				...
				<td  align="center"  valign="bottom" style="padding:0"><font style="padding:0;font-size:70px; font-weight: bold; color:#395723; font-family:'Arial Black'">A </font>
    ...
    <tr><td colspan="2" ><img src="<?php echo base_url('../resources/shared_img/print_permit/footer_a_new.jpg');?>" width="100%"></td></tr>
</table>
    </body>
</html>