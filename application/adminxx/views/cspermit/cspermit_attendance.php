    ...
    ?>
                    <div class="box  box-primary">
                        <div class="box-header with-border">
                                    ...
                                    <h3 class="box-title">Briefing Attendance (Commercial Supplier)</h3>
    ...
    $(document).ready(function() {
        $(function() {
            ...
            $('#calendar').fullCalendar({
                ...
                defaultView: 'month',
                events: {
                    url: '/Csbriefingmanagement/get_availableslot',
                    type: 'POST',
                    data: {},
                    error: function() {
...
$(location).attr('href', "/admin/cspermit/briefingattend/"+moment(calEvent.start).format('YYYY-MM-DD'));
                    }
                }
            })
        });
...
$(location).attr('href', "/admin/cspermit/briefingattend/"+date.format());
                    }
    },
            })
        });
