...
<ol class="breadcrumb">
  ...
  <li class="active"><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span> <?php echo $this->lang->line('mtwchecklist');?> <?php echo $this->lang->line('list');?></li>
</ol>
...
<div class="panel panel-info">
  <div class="panel-heading">
         <h4><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span> <?php echo $this->lang->line('mtwchecklist');?> <?php echo $this->lang->line('list');?></h4>
  </div>
...
<td><?php echo $mtwchecklist->mtwchecklist_desc ?></td>
                                ...
                                <td style="text-align:center; white-space: nowrap;">
                                    ...
                                    <?php
                                    $id = fixzy_encoder($mtwchecklist->mtwchecklist_id);
                                    if ($permission->cp_read == true) {
                                        echo anchor(site_url('mtwchecklist/read/'.$id),
                                    ...
                                    if ($permission->cp_update == true) {
                                        ...
                                        echo anchor(site_url('mtwchecklist/update/'.$id),
                                    ...
                                    if ($permission->cp_delete == true) {
                                        ...
                                        echo anchor(site_url('mtwchecklist/delete/'.$id),
      ...
      <script type="text/javascript">
         ...
         {                 text: '<span class="glyphicon glyphicon-plus" aria-hidden="true"></span> <?php echo $this->lang->line("add_new");?>',
             action: function ( e, dt, node, config ) {
                 redirect("<?php echo site_url('mtwchecklist/create');?>");
             } },
         <?php }?>
          <?php
