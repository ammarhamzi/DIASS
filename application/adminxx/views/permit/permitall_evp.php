...
<div class="container-fluid">
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo site_url('permitall'); ?>"><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span> <?php echo $this->lang->line('permitall'); ?> <?php echo $this->lang->line('list'); ?></a></li>
