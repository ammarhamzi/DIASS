...
<div class="container-fluid">
    ...
    <div class="panel panel-info">
        <div class="panel-heading">
            <h4><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> Profile <?php echo $button; ?></h4>
        ...
        <div class="panel-body">
            ...
            <form action="<?php echo $action; ?>" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-md-11"><input type="text" class="form-control" name="user_username" id="user_username" placeholder="<?php echo $this->lang->line('user_username'); ?>"value="<?php echo $user_username; ?>" maxlength="50" />
                                 </div></div>

                <div class="row">
                    <label class="col-md-1" style=" white-space: nowrap;">
                    ...
                    <div class="col-md-11"><input type="text" class="form-control" name="user_name" id="user_name" placeholder="<?php echo $this->lang->line('user_name'); ?>"value="<?php echo $user_name; ?>" maxlength="150" />
                                 </div></div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-11"><input type="text" class="form-control" name="user_email" id="user_email" placeholder="<?php echo $this->lang->line('user_email'); ?>"value="<?php echo $user_email; ?>" maxlength="100" />
                                 </div></div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-11"><div class = "upload-image-messages"><?php
if ($user_photo) {
    ?>
