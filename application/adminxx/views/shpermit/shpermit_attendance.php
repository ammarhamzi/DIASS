    ...
    ?>
                    <div class="box  box-primary">
                        <div class="box-header with-border">
                                    ...
                                    <h3 class="box-title">Briefing Attendance (Stakeholder)</h3>
    ...
    $(document).ready(function() {
        $(function() {
            ...
            $('#calendar').fullCalendar({
                ...
                defaultView: 'month',
                events: {
                    url: '/Shbriefingmanagement/get_availableslot',
                    type: 'POST',
                    data: {},
                    error: function() {
...
$(location).attr('href', "/admin/shpermit/briefingattend/"+moment(calEvent.start).format('YYYY-MM-DD'));
                    }
                }
            })
        });
...
$(location).attr('href', "/admin/shpermit/briefingattend/"+date.format());
                                        }
        },
                        })
                });
