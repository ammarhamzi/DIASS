...
<!--                                 <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                        ...
                        <form id="submitform" name="submitform" action="/admin/permitpendinginspection/shins_submit/" method="POST">
                            <div class="box-body">
...
<th>MTW Inspected</th>
  ...
  <div class="form-group">
    <h3>Upload Reference Files </h3>
                                ...
                                <iframe frameBorder="0" width="100%" height="250px" src="/admin/Uploadfiles/shins_inspectordoc/<?php echo $vehicle_id;?>/<?php echo $raw_permit_id;?>"></iframe>
  </div>
...
<h3>Check submitted information & documents. </h3>
    <div class="form-group">
        ...
        <input id="activitydate" name="activitydate" class="form-control datepicker" value="<?php echo $shinspermit_inspection_date;?>">
    </div>
