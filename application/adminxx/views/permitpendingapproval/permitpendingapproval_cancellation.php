        ...
        <div class="panel-body">
            <div>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <form id="submitform" name="submitform" action="/permitpendingapproval/cancellation_action/" method="POST">
                            <div class="row">
                                ...
                                <table class="table">
                                    ...
                                    <tr>
                                        <td><input id="agree" name="agree" type="checkbox" value="y"> I hereby ....<?php echo form_error('agree') ?><br><input id="submit" name="submit" type="submit" value="Submit" class="btn btn-primary"></td>
                                    </tr>
