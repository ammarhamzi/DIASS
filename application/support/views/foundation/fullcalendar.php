<link rel="stylesheet" type="text/css" href="<?php echo base_url('../resources/shared_js/fullcalendar/3.0.1/fullcalendar.min.css'); ?>">
<!--<link rel="stylesheet" type="text/css" href="<?php echo base_url('../resources/shared_js/fullcalendar/3.0.1/fullcalendar.print.css'); ?>">-->

<script src="<?php echo base_url('../resources/shared_js/moment/2.15.2/min/moment.min.js'); ?>"></script>
<!-- <script src="//cdnjs.cloudflare.com/ajax/libs/moment.js/2.15.2/locale/ms.js"></script> -->
<script src="<?php echo base_url('../resources/shared_js/fullcalendar/3.0.1/fullcalendar.min.js'); ?>"></script>
