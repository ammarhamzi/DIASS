    ...
    <body class="hold-transition login-page bg">
        <div class="login-box">
            ...
            <div class="login-box-body">
                ...
                <p class="login-box-msg"><b>PIC SUPPORT</b></p>
                <?php
                ...
                <form action="<?php echo site_url('authentication/login'); ?>" method="post">
                    <div class="form-group has-feedback">
                        <label>PIC Username (Email)</label>
                        <input type="text" class="form-control" name="username" id="username" placeholder="PIC Username" value="">
                        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
                    </div>
                    <div class="form-group has-feedback">
                        <label>Support Password</label>
                        <input type="password" type="password" class="form-control" name="password" id="password" placeholder="Support Password" value="">
