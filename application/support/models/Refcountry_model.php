...
class Refcountry_model extends CI_Model
{
...
// get all
    public function get_all()
    {
        ...
        $this->db->where('ref_country_deleted_at');
        $this->db->order_by('ref_country_id', 'DESC');
...
// get data by id
    ...
    {
        $this->db->select('*');
        $this->db->where('ref_country_id', $id);
        $this->db->where('ref_country_deleted_at');
        $this->db->from('ref_country');
...
// insert data
    ...
    {
        $this->db->insert('ref_country', $data);
    }
...
// update data
    ...
    {
        $this->db->where('ref_country_id', $id);
        $this->db->update('ref_country', $data);
    }
