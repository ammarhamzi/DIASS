...
// get data by id
  function get_by_id($id) {
    ...
    {
        $this->db->select('examonlymanagement_id, examonlymanagement_slottaken');
        $this->db->where('examonlymanagement.examonlymanagement_date', $date);
        $this->db->where('examonlymanagement.examonlymanagement_session', $session);
        $this->db->where('examonlymanagement_deleted_at');
        $this->db->from('examonlymanagement');
...
// delete data
  ...
  function recordsFiltered($columns, $filter=""){
    ...
    public function get_slot($classtype)
    {
        $this->db->select('*');
        $this->db->where('examonlymanagement_deleted_at');
        $this->db->where('examonlymanagement_classtype', $classtype);
        $this->db->from('examonlymanagement');
