...
class Examtopic_model extends CI_Model
{
...
// get all
    public function get_all()
    {
        ...
        $this->db->where('examtopic_deleted_at');
        $this->db->order_by('examtopic_id', 'DESC');
