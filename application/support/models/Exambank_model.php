...
class Exambank_model extends CI_Model
{
...
// get all
    public function get_all()
    {
        ...
        $this->db->where('exambank_deleted_at');
        $this->db->order_by('exambank_id', 'DESC');
        $this->db->from('exambank');
