...
class Enginetype_model extends CI_Model {
...
// get all
  function get_all() {
	...
	$this->db->where('enginetype_deleted_at');
	$this->db->order_by('enginetype_id', 'DESC');
...
// get data by id
  function get_by_id($id) {
    $this->db->select('*');
	$this->db->where('enginetype_id', $id);
	$this->db->where('enginetype_deleted_at');
	$this->db->from('enginetype');
...
// insert data
  function insert($data) {
    $this->db->insert('enginetype', $data);
  }

// update data
  function update($id, $data) {
    $this->db->where('enginetype_id', $id);
    $this->db->update('enginetype', $data);
  }

// delete data
  function delete($id) {
    $this->db->where('enginetype_id', $id);
    $this->db->delete('enginetype');
  }
